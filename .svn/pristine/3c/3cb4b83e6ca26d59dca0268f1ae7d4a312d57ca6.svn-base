...
$(function () {
    ...
    //加载统计列表
    $("#statlist").flexigrid({
        url: 'index.php?m=stat_member&a=get_arealist_xml&t=<?php echo $output['searchtime'];?>',
        colModel : [
...
function fg_operation(name, bDiv){
    var stat_url = 'index.php?m=stat_member&a=area_list&exporttype=excel&t=<?php echo $output['searchtime'];?>';
    get_excel(stat_url,bDiv);
}
//加载统计地图
function getStatMap(type){
	$('#'+type+'_div').load('index.php?m=stat_member&a=area_map&type='+type+'&t=<?php echo $output['searchtime'];?>');
}
</script>