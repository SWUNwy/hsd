...
<div id="favoritesGoods" class="double">
  <div class="outline">
    ...
    <div class="ncm-favorites-goods">
      ...
      <div class="more"><a target="_blank" href="index.php?m=m_favorite_goods&a=fglist">查看收藏的所有商品</a></div>
    </div>
    <?php } else { ?>
    <dl class="null-tip">
      <dt></dt>
...
<div id="favoritesStore" class="normal">
  <div class="outline">
    ...
    <div class="ncm-favorites-store">
      ...
      <div class="more"><a target="_blank" href="index.php?m=m_favorite_store&a=fslist">查看收藏的所有店铺</a></div>
    </div>
    <?php } else { ?>
    <dl class="null-tip">
      <dt></dt>
