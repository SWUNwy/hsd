...
class store_groupbuyControl extends BaseSellerControl {
    ...
    public function __construct() {
        ...
        if (intval(C('groupbuy_allow')) !== 1){
            showMessage(Language::get('groupbuy_unavailable'),'index.php?m=s_center','','error');
        }
    }
    /**
     * 默认显示团购列表
    ...
    public function groupbuy_saveOp() {
        ...
        if($result) {
            ...
            showDialog(Language::get('groupbuy_add_success'),'index.php?m=store_groupbuy','succ');
        }else {
            showDialog(Language::get('groupbuy_add_fail'),'index.php?m=store_groupbuy');
        }
    }
    ...
    private function profile_menu($menu_key='') {
        ...
        switch ($menu_key){
        case 'groupbuy_add':
            $menu_array[] = array('menu_key'=>'groupbuy_add','menu_name'=>L('nc_member_path_new_group'),'menu_url'=>'index.php?m=store_groupbuy&a=groupbuy_add');
            break;
        case 'groupbuy_add_vr':
            $menu_array[] = array('menu_key'=>'groupbuy_add_vr','menu_name'=>'新增虚拟团购','menu_url'=>'index.php?m=store_groupbuy&a=groupbuy_add_vr');
            break;
        case 'groupbuy_quota_add':
            ...
            break;
        case 'groupbuy_edit':
            $menu_array[] = array('menu_key'=>'groupbuy_edit','menu_name'=>L('nc_member_path_edit_group'),'menu_url'=>'index.php?m=store_groupbuy');
            break;
        case 'cancel':
