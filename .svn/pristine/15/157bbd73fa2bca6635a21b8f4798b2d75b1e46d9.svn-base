   ...
   <!-- 焦点图 -->
    ...
    <div class="ncs-goods-summary">
      ...
      <div class="ncs-meta">
        ...
        <dl>
          <dt>可抵金币<?php echo $lang['nc_colon'];?></dt>
          <dd class="price">            
            <?php echo $output['goods']['goods_points'];?>      
          </dd>
        </dl>
        <dl class="rate">
          <dt>商品评分：</dt>
...
$shownLevelSkus[$sku] = true; ?>
      ...
      <div class="ncs-logistics"><!-- S 物流与运费新布局展示 ByShopKJYP网店运维 -->
...
<!--youce-->
  ...
  <div class="ncs-sidebar">
    <?php if ($output['left_bar_type_mall_related']) {
        include template('Shop/left_mall_related');
    } else {
        include template('Shop/left');
    } ?>
    ...
    <div class="ncs-sidebar-container ncs-top-bar">
      ...
      <div class="content">
        ...
        <p><a href="<?php echo SHOP_SITE_URL;?>/index.php?m=m_goodsbrowse&a=list" class="nch-sidebar-all-viewed">全部浏览历史</a></p> </div>
    </div>
    <?php } ?>
  </div>
</div>
...
<form id="buynow_form" method="post" action="<?php echo SHOP_SITE_URL;?>/index.php">
  <input id="m" name="m" type="hidden" value="buy" />
...
function checkSpec() {
    var spec_param = <?php echo str_replace("goods_itemIndex","goods",$output['spec_list']);?>;
    var spec = new Array();
