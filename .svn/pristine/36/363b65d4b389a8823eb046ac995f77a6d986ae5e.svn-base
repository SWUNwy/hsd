    ...
    <div class="head-search-layout">
      <div class="head-search-bar" id="head-search-bar">
        <div class="hd_serach_tab" id="hdSearchTab">
          <ul>
            <li m="search" class="current"><span>商品</span><i class="arrow"></i></li>
            <li m="store_list"><span>店铺</span></li>
          </ul>
          <i></i> </div>
...
?>
    ...
    <div class="mod_minicart" style=""> <a id="nofollow" target="_self" href="<?php echo SHOP_SITE_URL;?>/index.php?m=cart" class="mini_cart_btn"> <i class="cart_icon"></i> <em class="cart_num"><?php echo $output['cart_goods_num'];?></em> <span>购物车</span> </a>
      <div id="minicart_list" class="minicart_list">
        ...
        <div class="list_detail"> 
          ...
          <div class="checkout_box">
            ...
            <a rel="nofollow" class="checkout_btn" href="<?php echo SHOP_SITE_URL;?>/index.php?m=cart" target="_self"> 去结算 </a> </div>
          <div style="" class="none_tips"> <i> </i>
            <p>购物车中没有商品，赶紧去选购！</p>
          </div>
        </div>
      </div>
...
<?php include template('Layouts/cur_local');?>
