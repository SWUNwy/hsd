...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?m=sns_malbum&a=class_list" title="返回<?php echo $lang['snsalbum_class_list'];?>"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
  ...
  <form method='post' id="form_pic">
    ...
    <ul class="ncap-thumb-list">
      ...
      <li class="picture">
        ...
        <a href="javascript:void(0);" onclick="if(confirm('<?php echo $lang['nc_ensure_del'];?>')){location.href='index.php?m=sns_malbum&a=del_pic&id=<?php echo $val['ap_id'];?>';}else{return false;}" class="del" title="<?php echo $lang['nc_del'];?>">X</a> </li>
      <?php } ?>
    </ul>
    <?php }else { ?>
