...
class statistics_saleControl extends BaseSellerControl {
    ...
    public function salelistOp(){
        ...
        Tpl::output('show_page',$model->showpage(2));
        Tpl::output('actionurl',"index.php?m={$this->search_arr['act']}&a={$this->search_arr['op']}&order_type={$this->search_arr['order_type']}&t={$this->search_arr['t']}");
    ...
    private function profile_menu($menu_key='') {
        $menu_array = array(
            1=>array('menu_key'=>'sale','menu_name'=>'销售统计','menu_url'=>'index.php?m=statistics_sale&a=sale'),
            2=>array('menu_key'=>'area','menu_name'=>'区域分布','menu_url'=>'index.php?m=statistics_sale&a=area'),
            3=>array('menu_key'=>'buying','menu_name'=>'购买分析','menu_url'=>'index.php?m=statistics_sale&a=buying'),
        );
