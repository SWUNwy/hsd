...
<table class="ncsc-default-table" id="my_category" server="index.php?m=store_goods_class&a=goods_class_ajax" >
  <thead>
    ...
    <tr>
      ...
      <td colspan="20"><label for="all"><?php echo $lang['nc_select_all'];?></label>
        <a href="javascript:void(0)" class="ncbtn-mini" nc_type="batchbutton" uri="index.php?m=store_goods_class&a=drop_goods_class" name="class_id" confirm="<?php echo $lang['store_goods_class_ensure_del'];?>?"><i class="icon-trash"></i><?php echo $lang['nc_del'];?></a></td>
    </tr>
    <?php } ?>
  </thead>
  <tbody id="treet1">
    ...
    <tr class="bd-line" nc_type="table_item" idvalue="<?php echo $val['stc_id']; ?>" >
      ...
      <td class="tl"><span class="ml5" nc_type="editobj" ><?php echo $val['stc_name']; ?></span>
        ...
        <span class="add_ico_a"> <a href="javascript:void(0)" class="ncbtn" nc_type="dialog" dialog_width="480" dialog_title="<?php echo $lang['store_goods_class_add_sub'];?>" dialog_id="my_category_add" uri="index.php?m=store_goods_class&top_class_id=<?php echo $val['stc_id']; ?>&type=ok" ><?php echo $lang['store_goods_class_add_sub'];?></a></span>
        <?php } ?></td>
      ...
      <td><?php if ($val['stc_state'] == 1) { ?>
        ...
        <?php } ?></td>
      <td class="nscs-table-handle"><span><a href="javascript:void(0)" nc_type="dialog" dialog_width="480" dialog_title="<?php echo $lang['store_goods_class_edit_class'];?>" dialog_id="my_category_edit" uri="index.php?m=store_goods_class&class_id=<?php echo $val['stc_id']; ?>&type=ok" class="btn-bluejeans"><i class="icon-edit"></i>
        <p><?php echo $lang['nc_edit'];?></p>
        </a></span> <span><a href="javascript:void(0)" onclick="ajax_get_confirm('<?php echo $lang['store_goods_class_ensure_del'];?>?', 'index.php?m=store_goods_class&a=drop_goods_class&class_id=<?php echo $val['stc_id']; ?>');" class="btn-grapefruit"><i class="icon-trash"></i>
  ...
  <tfoot>
    <tr>
      ...
      <th colspan="15"><label for="all2"><?php echo $lang['nc_select_all'];?></label>
        <a href="javascript:void(0)" class="ncbtn-mini" nc_type="batchbutton" uri="index.php?m=store_goods_class&a=drop_goods_class" name="class_id" confirm="<?php echo $lang['store_goods_class_ensure_del'];?>?"><i class="icon-trash"></i><?php echo $lang['nc_del'];?></a></th>
    </tr>
  </tfoot>
  <?php } ?>
</table>
