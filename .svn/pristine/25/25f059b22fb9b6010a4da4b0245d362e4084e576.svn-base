...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?m=web_config&a=web_config" title="返回<?php echo '板块区';?>列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
  ...
  <div class="ncap-form-all">
    <div class="title">
      ...
      <a href="index.php?m=web_config&a=web_edit&web_id=<?php echo $output['web_array']['web_id'];?>">设置该板块色彩</a> </div>
    <dl class="row">
      <dt class="tit">
              ...
              <dl recommend_id="<?php echo $key;?>">
                ...
                <dd>
                  ...
                  <ul class="goods-list">
                   ...
                   <li><span><a href="javascript:void(0);"> <img title="<?php echo $v['goods_name'];?>" src="<?php echo strpos($v['goods_pic'],'x2_')>0 ? $v['goods_pic']:UPLOAD_SITE_URL."/".$v['goods_pic'];?>"/></a></span> </li>
                    <?php } ?>
                  </ul>
...
<div class="wwi-btbrand"><dl>
  ...
  <div class="bot"><a href="index.php?m=web_config&a=web_html&web_id=<?php echo $_GET['web_id'];?>" class="ncap-btn-big ncap-btn-green" id="submitBtn"><?php echo $lang['web_config_web_html'];?></a> </div>
</div>
...
<div id="upload_tit_dialog" style="display:none;">
  ...
  <form id="upload_tit_form" name="upload_tit_form" enctype="multipart/form-data" method="post" action="index.php?m=web_config&a=upload_pic" target="upload_pic">
...
<div id="upload_act_dialog" class="upload_act_dialog" style="display:none;">
  ...
  <form id="upload_act_form" name="upload_act_form" enctype="multipart/form-data" method="post" action="index.php?m=web_config&a=upload_pic" target="upload_pic">
    <input type="hidden" name="form_submit" value="ok" />
        ...
        <dd class="opt">
          <ul class="dialog-goodslist-s1 goods-list">
            ...
            <li id="select_recommend_<?php echo $key;?>_goods_<?php echo $k;?>">
              ...
              <div class="goods-name"><a href="<?php echo SHOP_SITE_URL."/index.php?m=goods&goods_id=".$v['goods_id'];?>" target="_blank"><?php echo $v['goods_name'];?></a></div>
...
<div id="recommend_pic_dialog" style="display:none;">
  ...
  <form id="recommend_pic_form" name="recommend_pic_form" enctype="multipart/form-data" method="post" action="index.php?m=web_config&a=recommend_pic" target="upload_pic">
    <input type="hidden" name="form_submit" value="ok" />
    <input type="hidden" name="web_id" value="<?php echo $output['code_recommend_list']['web_id'];?>">
    <input type="hidden" name="code_id" value="<?php echo $output['code_recommend_list']['code_id'];?>">
...
<div id="upload_adv_dialog" class="upload_adv_dialog" style="display:none;">
  ...
  <form id="upload_adv_form" name="upload_adv_form" enctype="multipart/form-data" method="post" action="index.php?m=web_config&a=slide_adv" target="upload_pic">
