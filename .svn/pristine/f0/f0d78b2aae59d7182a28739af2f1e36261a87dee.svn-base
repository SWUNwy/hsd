...
<div class="ncm-flow-item">
  ...
  <div class="item-order">
    ...
    <dl class="line">
      ...
      <dd> <a href="<?php echo SHOP_SITE_URL;?>/index.php?m=m_order&a=show_order&order_id=<?php echo $output['order']['order_id'];?>"  target="_blank"> <?php echo $output['order']['order_sn'];?> </a> <a href="javascript:void(0);" class="a">更多<i class="icon-angle-down"></i>
      ...
      <dl>
        <dt>物流单号：</dt>
        <dd><a target="_blank" href="index.php?m=m_order&a=search_deliver&order_id=<?php echo $output['order']['order_id']; ?>"><?php echo $output['order']['shipping_code'];?></a>
