...
<div class="wrapper pr">
  ...
  <div class="ncc-main">
    ...
    <form method="post" id="porder_form" name="porder_form" action="index.php?m=pointcart&a=step2">
      <div class="ncc-receipt-info">
        <div class="ncc-receipt-info-title">
          <h3><?php echo $lang['pointcart_step1_receiver_address'];?><a href="<?php echo urlMember('m_address', 'address');?>" target="_blank">[管理]</a></h3>
        </div>
        <!-- 已经存在的收获地址start -->
      ...
      <div class="ncc-receipt-info">
        ...
        <table class="ncc-table-style">
          ...
          <tfoot>
            <tr>
              <td colspan="20"><a href="index.php?m=pointcart" class="ncc-prev-btn"><i class="icon-angle-left"></i><?php echo $lang['pointcart_step1_return_list'];?></a>
