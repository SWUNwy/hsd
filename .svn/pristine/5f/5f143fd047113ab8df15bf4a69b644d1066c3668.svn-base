...
<div class="wrap">
  <div class="tabmenu">
    ...
    <a class="ncbtn ncbtn-bittersweet" title="在线充值" href="index.php?m=predeposit&a=recharge_add"> <i class="icon-shield"></i> 在线充值 </a> </div>
  ...
  <form method="get" action="index.php">
    <table class="ncm-search-table">
      <input type="hidden" name="m" value="predeposit" />
    ...
    <tbody>
      ...
      <tr class="bd-line">
        ...
        <td class="ncm-table-handle"><?php if (!intval($val['pdr_payment_state'])){?>
          ...
          <p>支付</p>
          </a></span> <span><a class="btn-grapefruit" href="javascript:void(0)" onclick="ajax_get_confirm('<?php echo $lang['nc_ensure_del'];?>', '<?php echo MEMBER_SITE_URL;?>/index.php?m=predeposit&a=recharge_del&id=<?php echo $val['pdr_id']; ?>');"><i class="icon-trash"></i>
          <p><?php echo $lang['nc_del'];?></p>
          </a></span>
          <?php }else{?>
          <span><a href="index.php?m=predeposit&a=recharge_show&id=<?php echo $val['pdr_id']; ?>" class="btn-bluejeans"><i class="icon-eye-open"></i>
