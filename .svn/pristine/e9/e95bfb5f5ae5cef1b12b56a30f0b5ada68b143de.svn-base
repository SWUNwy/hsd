...
<table class="ncsc-default-table">
  ...
  <tbody>
    ...
    <tr>
      <td></td>
      <td class="tl"><a target="_blank" href="index.php?m=activity&activity_id=<?php echo $v['activity_id'];?>"><?php echo $v['activity_title']; ?></a></td>
      ...
      <td class="nscs-table-handle"><span><a id="a_<?php echo $v['activity_id'];?>" href="index.php?m=store_activity&a=activity_apply&activity_id=<?php echo $v['activity_id'];?>"  class="btn-mint"><i class="icon-edit"></i>
