<div class="eject_con">
  ...
  <form method="post" target="_parent" action="index.php?m=store_brand&a=<?php if ($output['brand_array']['brand_id']!='') echo 'brand_edit'; else echo 'brand_save'; ?>"enctype="multipart/form-data" id="brand_apply_form">
