...
class waybillControl extends SystemControl{
    ...
    public function get_xmlOp() {
        ...
        foreach ($waybill_list as $value) {
            ...
            $operation .= "<li><a href='index.php?m=waybill&a=waybill_design&waybill_id=".$value['waybill_id']."'>设计运单模板</a></li>";
            $operation .= "<li><a href='index.php?m=waybill&a=waybill_test&waybill_id=".$value['waybill_id']."' target=\"_blank\">测试运单模板</a></li>";
            $operation .= "<li><a href='index.php?m=waybill&a=waybill_edit&waybill_id=".$value['waybill_id']."'>编辑运单模板</a></li>";
            $operation .= "</ul></span>";
