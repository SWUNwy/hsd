...
<div class="ncm-flow-layout">
  <div class="ncm-flow-container">
    ...
    <form id="evalform" method="post" action="index.php?m=m_evaluate&a=<?php echo $_GET['op'];?>&order_id=<?php echo $_GET['order_id'];?>">
      ...
      <table class="ncm-default-table mb30">
        <tbody>
          ...
          <tr class="bd-line">
            <td class="w20"></td>
            <td class="pic-mode w200"><div class="pic-thumb"><a href="index.php?m=goods&goods_id=<?php echo $goods['goods_id']; ?>" target="_blank"><img src="<?php echo $goods['goods_image_url']; ?>"/></a></div>
              <dl class="goods-name">
                <dt><a href="index.php?m=goods&goods_id=<?php echo $goods['goods_id'];?>" target="_blank" title="<?php echo $goods['goods_name'];?>"><?php echo $goods['goods_name'];?></a></dt>
