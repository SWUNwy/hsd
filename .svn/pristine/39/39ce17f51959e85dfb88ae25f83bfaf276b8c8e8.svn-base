...
class rec_positionControl extends SystemControl{
    ...
    public function get_xmlOp(){
        ...
        foreach ($list as $k => $info) {
            ...
            $operation_detail = "<li><a href='index.php?m=rec_position&a=rec_edit&rec_id={$info['rec_id']}'>编辑内容</a></li>";
            $operation_detail .= "<li><a href=\"javascript:void(0);\" rec_id=\"{$info['rec_id']}\" nctype=\"jscode\"></i>调用代码</a></li>";
            $operation_detail .= "<li><a href=\"index.php?m=rec_position&a=rec_view&rec_id={$info['rec_id']}\" target=\"_blank\">预览效果</a></li>";
            if ($operation_detail) {
    ...
    public function rec_saveOp(){
        ...
        showMessage(Language::get('nc_common_save_succ'),'index.php?m=rec_position&a=rec_list');
    }
    ...
    public function rec_edit_saveOp(){
        ...
        if ($result){
            ...
            showMessage(Language::get('nc_common_save_fail'),'index.php?m=rec_position&a=rec_list');
        }
    }
