...
<div class="wrap">
  <div class="tabmenu">
    ...
    <a class="ncbtn ncbtn-bittersweet" title="在线充值" href="index.php?m=predeposit&a=recharge_add" style="right: 207px;"><i class="icon-shield"></i>在线充值</a> <a class="ncbtn ncbtn-mint" href="index.php?m=m_security&a=auth&type=pd_cash" style="right: 107px;"><i class="icon-money"></i>申请提现</a> <a class="ncbtn ncbtn-bluejeansjeans" href="index.php?m=predeposit&a=rechargecard_add"><i class="icon-shield"></i>充值卡充值</a> </div>
