<?php defined('ByShopKJYP') or exit('Access Invalid!');?>
  <form method="get" id="formSearch">
    <table class="search-form">
      <input type="hidden" id='m' name='m' value='store_vr_bill' />
...
<table class="ncsc-default-table">
    ...
    <tbody>
      ...
      <tr class="bd-line">
        ...
        <td>
       	<a target="_blank" href="index.php?m=store_vr_order&a=show_order&order_id=<?php echo $code_info['order_id'];?>"><?php echo $lang['nc_view'];?></a>
        </td>
      </tr>
      <?php } ?>
      <?php } else { ?>
