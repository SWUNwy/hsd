...
class store_cartControl extends BaseSellerControl {
    ...
    public function __construct() {
        ...
        if (!in_array($op,$op_arr) && !$_SESSION['store_id'] ){
            //redirect(urlLogin('login', 'index', array('ref_url' => request_uri())));161229 by wangchao
    ...
    public function indexOp() {
        ...
        Tpl::showpage(empty($cart_list) ? 'store_cart_empty' : 'store_cart','sell_layout');
    }
    ...
    public function addOp() {
        ...
        if (is_numeric($_GET['goods_id'])) {
            ...
            $goods_info['store_id'] = $_SESSION['store_id'];
            $goods_info['store_name'] = $_SESSION['store_name'];
