...
<div class="ncsc-form-default">
    ...
    <form id="add_form" action="index.php?m=store_promotion_xianshi&a=xianshi_save" method="post">
    <?php } else { ?>
    <form id="add_form" action="index.php?m=store_promotion_xianshi&a=xianshi_edit_save" method="post">
