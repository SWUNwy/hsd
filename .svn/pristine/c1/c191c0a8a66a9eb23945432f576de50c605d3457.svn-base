    ...
    public function activity_xmlOp()
    {
        ...
        foreach ($list as $val) {
            ...
            if ($val['activity_state'] == 0 || $val['activity_end_date'] < time()) {
                $o .= '<a class="btn red confirm-del-on-click" href="javascript:;" data-href="index.php?m=activity&a=del&activity_id=' .
                    $val['activity_id'] .
            ...
            $o .= '<li><a href="index.php?m=activity&a=edit&activity_id=' .
                    $val['activity_id'] .
                    '">编辑活动</a></li>';

            $o .= '<li><a href="index.php?m=activity&a=detail&id=' .
                $val['activity_id'] .
                '">处理申请</a></li>';
...
EOB;
    ...
    public function newOp(){
        ...
        if($result){
            ...
            showMessage(Language::get('nc_common_op_succ'),'index.php?m=activity&a=activity');
        }else{
    ...
    public function editOp(){
        ...
        if($result){
            ...
            showMessage(Language::get('nc_common_save_succ'),'index.php?m=activity&a=activity');
        }else{
            if($_FILES['activity_banner']['name']!=''){
                @unlink(BASE_UPLOAD_PATH.DS.ATTACH_ACTIVITY.DS.$upload->file_name);
            }
    ...
    public function detail_xmlOp()
    {
        ...
        foreach ($list as $val) {
            ...
            if ($val['activity_detail_state'] != 1) {
                $o .= '<li><a class="confirm-on-click" href="javascript:;" data-href="index.php?m=activity&a=deal&state=1&activity_detail_id=' .
                    $val['activity_detail_id'] .
                    '">通过</a></li>';
            }

            if ($val['activity_detail_state'] != 2) {
                $o .= '<li><a class="confirm-on-click" href="javascript:;" data-href="index.php?m=activity&a=deal&state=2&activity_detail_id=' .
                    $val['activity_detail_id'] .
                    '">拒绝</a></li>';
            }
            ...
            if ($val['activity_detail_state'] != 1) {
                $o .= '<li><a class="confirm-on-click" href="javascript:;" data-href="' .
                    'index.php?m=activity&a=del_detail&activity_detail_id=' .
                    $val['activity_detail_id'] .
                    '">删除</a></li>';
            }
