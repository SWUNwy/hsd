...
class stat_generalControl extends SystemControl{
    private $links = array(
        array('url'=>'m=stat_general&a=general','lang'=>'stat_generalindex'),
        array('url'=>'m=stat_general&a=setting','lang'=>'stat_goodspricerange'),
        array('url'=>'m=stat_general&a=orderprange','lang'=>'stat_orderpricerange')
    );
