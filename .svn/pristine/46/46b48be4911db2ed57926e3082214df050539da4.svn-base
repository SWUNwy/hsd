...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?m=document&a=document" title="返回列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
...
$(document).ready(function(){
    ...
    $('#fileupload').each(function(){
        $(this).fileupload({
            dataType: 'json',
            url: 'index.php?m=document&a=document_pic_upload&item_id=<?php echo $output['doc']['doc_id'];?>',
...
function del_file_upload(file_id)
{
    ...
    $.getJSON('index.php?m=document&a=ajax&branch=del_file_upload&file_id=' + file_id, function(result){
        if(result){
            $('#' + file_id).remove();
        }else{
