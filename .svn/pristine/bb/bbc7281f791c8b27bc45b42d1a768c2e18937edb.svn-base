        ...
        <div id="default" class="tabs-content">
          <form class="nc-login-form" action="<?php echo urlLogin('login', 'find_password');?>" method="POST" id="find_password_form">
            ...
            <div class="code-div mt15">
              ...
              <span><img src="index.php?m=seccode&a=makecode&type=50,120&nchash=<?php echo getNchash();?>" title="<?php echo $lang['login_index_change_checkcode'];?>" name="codeimage" id="codeimage"> <a class="makecode" href="javascript:void(0);" class="ml5" onclick="javascript:document.getElementById('codeimage').src='index.php?m=seccode&a=makecode&type=50,120&nchash=<?php echo getNchash();?>&t=' + Math.random();"><?php echo $lang['login_password_change_code']; ?></a></span></div>
