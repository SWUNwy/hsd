...
<?php if ($output['store_info']) { ?>
      <a class="back" href="index.php?m=promotion_sole&a=sole_quota_list" title="返回套餐列表">
...
$(function(){
    $("#flexigrid").flexigrid({
        url: 'index.php?m=promotion_sole&a=goods_list_xml&store_id=<?php echo $output['store_id']; ?>',
        colModel: [
