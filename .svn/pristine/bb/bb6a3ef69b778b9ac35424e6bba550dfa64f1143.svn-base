...
<div class="eject_con">
  <div id="warning"></div>
  <form method="post" id="order_cancel_form" onsubmit="ajaxpost('order_cancel_form', '', '', 'onerror');return false;" action="index.php?m=store_vr_order&a=change_state&state_type=order_cancel&order_id=<?php echo $output['order_id']; ?>">
