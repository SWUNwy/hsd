...
class accountControl extends SystemControl{
    private $links = array(
        array('url'=>'m=account&a=qq','lang'=>'qqSettings'),
        array('url'=>'m=account&a=sina','lang'=>'sinaSettings'),
        array('url'=>'m=account&a=sms','text'=>'手机短信'),
        array('url'=>'m=account&a=wx','text'=>'微信登录'),
		array('url'=>'m=account&a=uc','text'=>'UC互联')
    );
