<div class="goods-gallery add-step2"> <a class="sample_demo" id="select_s" href="index.php?m=store_album&a=pic_list&item=des" style="display:none;"><?php echo $lang['nc_submit'];?></a>
