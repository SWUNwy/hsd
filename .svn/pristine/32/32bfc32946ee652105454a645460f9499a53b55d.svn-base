...
class web_configControl extends SystemControl{
    ...
    public function web_editOp(){
        ...
        if (chksubmit()){
            ...
            showMessage(Language::get('nc_common_save_succ'),'index.php?m=web_config&a=web_config');
        }
    ...
    public function web_htmlOp(){
        ...
        if(!empty($web_array) && is_array($web_array)) {
            ...
            showMessage(Language::get('nc_common_op_succ'),'index.php?m=web_config&a=web_config');
        } else {
