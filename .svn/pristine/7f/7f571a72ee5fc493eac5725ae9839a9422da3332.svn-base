...
class navigationControl extends SystemControl{
        ...
        if (chksubmit()){
            ...
            if ($error != ''){
                ...
                if ($result){
                    ...
                    $url = array(
                        array(
                            'url'=>'index.php?m=navigation&a=navigation_add',
                            'msg'=>$lang['navigation_add_again'],
                        ),
                        array(
                            'url'=>'index.php?m=navigation&a=navigation',
        ...
        if (chksubmit()){
            ...
            if ($error != ''){
                ...
                if ($result){
                    ...
                    $url = array(
                        array(
                            'url'=>'index.php?m=navigation&a=navigation_edit&nav_id='.intval($_POST['nav_id']),
    ...
    public function navigation_delOp(){
        ...
        if (preg_match('/^[\d,]+$/', $_GET['nav_id'])) {
            ...
            showMessage($lang['navigation_index_del_succ'],'index.php?m=navigation&a=navigation');
        }else {
            showMessage($lang['navigation_index_choose_del'],'index.php?m=navigation&a=navigation');
        }
    }
