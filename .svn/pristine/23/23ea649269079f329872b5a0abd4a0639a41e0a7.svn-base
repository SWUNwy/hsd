...
<div class="page">
  ...
  <!--S 分类选择区域-->
  <div class="wrapper_search main_content">
    <div class="wp_sort">
    ...
    <div class="wp_confirm">
      <form method="get">
        ...
        <input type="hidden" name="m" value="goods_online" />
        <input type="hidden" name="a" value="edit_goods" />
        <input type="hidden" name="commonid" value="<?php echo $output['commonid'];?>" />
        <input type="hidden" name="ref_url" value="<?php echo $_GET['ref_url'];?>" />
        <?php } else {?>
        <input type="hidden" name="m" value="goods_add" />
        <input type="hidden" name="a" value="add_step_two" />
        <?php }?>
