  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base nc-row">
        ...
        <li><a href="index.php?m=pointprod&a=pointorder_list" ><?php echo $lang['admin_pointorder_list_title'];?></a></li>
      </ul>
    </div>
  </div>
  <!-- 操作说明 -->
...
<script>
$(function(){
    var flexUrl = 'index.php?m=pointprod&a=pointprod_xml';
        ...
        buttons: [
            {
                ...
                title: '新增积分兑换礼品',
                onpress: function() {
                    location.href = 'index.php?m=pointprod&a=prod_add';
                }
            },
            {
