...
function getClassSpec($this) {
    ...
    $.getJSON('index.php?m=store_spec&a=ajax_class&id=' + id + '&deep=' + deep, function(data){
...
function editSpecValue(o) {
    ...
    $_iframe = $('<iframe id="iframepage" name="iframepage" frameBorder=0 scrolling=no width="100%" height="630px" src="<?php echo SHOP_SITE_URL;?>/index.php?m=store_spec&a=add_spec&spid=' + data_str.spid + '&gcid=' + data_str.gcid + '" ></iframe>');
