...
<div class="wrap">
  ...
  <div class="ncm-bind">
    ...
    <div class="relieve">
      <form method="post" id="editbind_form" name="editbind_form" action="index.php?m=m_bind&a=qqunbind">
    ...
    <div class="revise ncm-default-form ">
      <form method="post" id="editpw_form" name="editpw_form" action="index.php?m=m_bind&a=qqunbind">
    ...
    <div class="relieve pt50">
      <p class="ico"><a href="<?php echo MEMBER_SITE_URL;?>/api.php?m=toqq"><img src="<?php echo MEMBER_TEMPLATES_URL;?>/images/qq_bind_small.gif"></a>
