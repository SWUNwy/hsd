...
{
    const LINK_COU_LIST = 'index.php?m=store_promotion_cou&a=cou_list';
    ...
    public function cou_add_saveOp()
    {
        ...
        if ($result) {
            ...
            $editUrl = 'index.php?m=store_promotion_cou&a=cou_edit&cou_id=' . $result;
    ...
    private function profile_menu($menu_key='')
    {
        $menu_array = array(
            1 => array(
                'menu_key' => 'cou_list',
                'menu_name' => '活动列表',
                'menu_url' => 'index.php?m=store_promotion_cou&a=cou_list',
            ),
        );
        switch ($menu_key) {
            case 'cou_quota_add':
                $menu_array[] = array(
                    ...
                    'menu_name' => '购买套餐',
                    'menu_url' => 'index.php?m=store_promotion_cou&a=cou_add',
                );
                break;
            case 'cou_add':
                $menu_array[] = array(
