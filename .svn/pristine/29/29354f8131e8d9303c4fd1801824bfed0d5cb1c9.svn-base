...
class m_vr_orderControl extends BaseMemberControl {
    ...
    private function profile_menu($menu_key='') {
        ...
        $menu_array = array(
            array('menu_key'=>'member_order','menu_name'=>Language::get('nc_member_path_order_list'), 'menu_url'=>'index.php?m=m_vr_order'),
        );
