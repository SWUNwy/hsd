  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base nc-row">
        ...
        <li><a href="index.php?m=brand&a=brand_apply"><?php echo $lang['brand_index_to_audit'];?></a></li>
      </ul>
    </div>
  </div>
...
$(function(){
    $("#flexigrid").flexigrid({
        url: 'index.php?m=brand&a=get_xml',
        colModel : [
...
function fg_operation(name, bDiv) {
    if (name == 'add') {
        window.location.href = 'index.php?m=brand&a=brand_add';
    }
    if (name == 'csv') {
...
function fg_del(id) {
    ...
    $.getJSON('index.php?m=brand&a=brand_del', {id:id}, function(data){
        if (data.state) {
