...
<div class="wrap">
  ...
  <div class="ncsc-form-default"> 
    ...
    <form id="add_form" method="post" action="index.php?m=store_promotion_bundling&a=bundling_add">
      ...
      <dl>
        ...
        <dd>
          ...
          <a id="bundling_add_goods" href="index.php?m=store_promotion_bundling&a=bundling_add_goods" class="ncbtn ncbtn-aqua"><?php echo $lang['bundling_goods_add'];?></a>
