...
class statistics_generalControl extends BaseSellerControl {
    ...
    /*private function profile_menu($menu_key='') {
        $menu_array = array(
            1=>array('menu_key'=>'stat_general','menu_name'=>'店铺概况',    'menu_url'=>'index.php?m=statistics_general&a=general')
        );
    ...
    private function profile_menu($menu_type,$menu_key='') {
        ...
        switch ($menu_type) {
            case 'setting':
                $menu_array = array(
                    1=>array('menu_key'=>'pricesetting','menu_name'=>'商品价格区间',    'menu_url'=>'index.php?m=statistics_general&a=pricesetting'),
                    2=>array('menu_key'=>'orderprange','menu_name'=>'订单金额区间', 'menu_url'=>'index.php?m=statistics_general&a=orderprange'));
                break;
        }
        Tpl::output('member_menu',$menu_array);
        Tpl::output('menu_key',$menu_key);
