...
<div class="ncsc-form-default">
  <form method="post" action="index.php?m=store_navigation&a=navigation_save" target="_parent" name="store_navigation_form" id="store_navigation_form" enctype="multipart/form-data">
