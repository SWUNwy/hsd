...
<div class="wrap">
  ...
  <table class="ncm-default-table order">
    ...
    <tbody>
      ...
      <tr>
        <th colspan="20"><span class="ml10"><a href="index.php?m=goods&goods_id=<?php echo $consult['goods_id']; ?>" target="_blank"><?php echo $consult['goods_name'];?></a></span><span class="ml20"><?php echo $lang['store_consult_list_consult_time'].$lang['nc_colon'];?><em class="goods-time"><?php echo date("Y-m-d H:i:s",$consult['consult_addtime']);?></em></span></th>
      </tr>
      <tr>
        <td class="tl bdl"></td>
