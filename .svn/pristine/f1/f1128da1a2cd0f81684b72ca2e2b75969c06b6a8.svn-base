...
class statistics_goodsControl extends BaseSellerControl {
    ...
    private function profile_menu($menu_key='') {
        $menu_array = array(
            1=>array('menu_key'=>'goodslist','menu_name'=>'商品详情',   'menu_url'=>'index.php?m=statistics_goods&a=goodslist'),
            2=>array('menu_key'=>'price','menu_name'=>'价格销量',   'menu_url'=>'index.php?m=statistics_goods&a=price'),
            3=>array('menu_key'=>'hotgoods','menu_name'=>'热卖商品',    'menu_url'=>'index.php?m=statistics_goods&a=hotgoods'),
        );
