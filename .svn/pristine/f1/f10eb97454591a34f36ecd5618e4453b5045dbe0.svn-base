<div class="eject_con">
  ...
  <form method="post" action="<?php echo urlAdminShop('goods_online', 'edit_jingle');?>" id="jingle_form">
    <input type="hidden" name="form_submit" value="ok" />
    <input type="hidden" name="commonid" value="<?php echo $_GET['id']; ?>" />
    <dl>
      <dt>商品广告词：</dt>
      <dd>
        <input type="text" class="text w300" name="g_jingle" id="g_jingle" value="" />
        <p class="hint">如不填，所有广告词将置空，请谨慎操作</p>
      </dd>
    </dl>
    <div class="bottom">
