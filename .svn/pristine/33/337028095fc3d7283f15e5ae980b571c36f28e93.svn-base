...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?m=predeposit&a=predeposit" title="返回充值管理列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
  ...
  <form method="post" name="form1" id="form1" action="index.php?m=predeposit&a=recharge_edit&id=<?php echo intval($_GET['id']);?>">
