...
<form method="GET">
  ...
  <input type="hidden" name="a" value="activity_apply"/>
  ...
  <table class="ncsc-default-table" >
    ...
    <tbody>
      ...
      <tr class="bd-line">
        <td><div class="pic-thumb"><a href="index.php?m=goods&goods_id=<?php echo $v['goods_id']; ?>" target="_blank"><img src="<?php echo cthumb($v['goods_image'], 60,$_SESSION['store_id']);?>"></a></div></td>
  ...
  <div class="div-goods-select">
    <form method="GET">
      <input type="hidden" name="m" value="store_activity"/>
      <input type="hidden" name="a" value="activity_apply"/>
    ...
    <form method="POST" id="apply_form" onsubmit="ajaxpost('apply_form','','','onerror');" action="index.php?m=store_activity&a=activity_apply_save">
      <input type="hidden" name="activity_id" value="<?php echo $_GET['activity_id'];?>"/>
