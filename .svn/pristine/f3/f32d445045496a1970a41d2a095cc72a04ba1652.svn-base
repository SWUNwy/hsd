    ...
    private function _getMenuList() {
        $menu_list = array(
            'info' => array('name' => '会员资料', 'child' => array(
                ...
                'member_security'   => array('name' => '账户安全', 'url'=>urlMember('m_security', 'index')),
                'member_address'    => array('name' => '收货地址', 'url'=>urlMember('m_address', 'address')),
                'member_message'    => array('name' => '我的消息', 'url'=>urlMember('m_message', 'message')),
                'member_snsfriend'  => array('name' => '我的好友', 'url'=>urlMember('m_snsfriend', 'find')),
                'member_bind'       => array('name' => '第三方账号登录', 'url'=>urlMember('m_bind', 'qqbind')),
                'member_sharemanage'=> array('name' => '分享绑定', 'url'=>urlMember('m_sharemanage', 'index'))
            )),
            'property' => array('name' => '财产中心', 'child' => array(
                ...
                'member_points'     => array('name' => '我的积分', 'url'=>urlMember('m_points', 'index')),
