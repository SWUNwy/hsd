...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?m=sns_member" title="返回会员标签列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
...
$(function(){
    $("#flexigrid").flexigrid({
        url: 'index.php?m=sns_member&a=get_tm_xml&id=<?php echo $output['mt_info']['mtag_id'];?>',
        colModel : [
