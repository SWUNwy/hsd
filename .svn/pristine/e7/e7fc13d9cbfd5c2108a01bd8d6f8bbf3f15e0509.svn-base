      ...
      <tbody id="treet1">
        ...
        <tr>
          ...
          <td><?php echo $value['special_id'];?></td>
           ...
           <td class="name"><span nc_type="edit_special_sort" column_id="<?php echo $value['special_id'];?>" title="<?php echo $lang['nc_editable'];?>" class="editable tooltip w50"><?php echo $value['special_sort'];?></span></td>
...
$(function(){
	$('.flex-table').flexigrid({
	  height:'auto',// 高度自动
        ...
        $('#add_form').validate({
            ...
            messages : {
				...
				$(".btn").on('click',function(){
					 var keyword = $(".qsbox").val();
					 window.location.href="index.php?m=mb_special&a=special_list&keyword="+keyword;
				})
        ...
        //编辑专题描述
        $('span[nc_type="edit_special_desc"]').inline_edit({m: 'mb_special',a: 'update_special_desc'});
        
        //编辑专题排序
        $('span[nc_type="edit_special_sort"]').inline_edit({m: 'mb_special',a: 'update_special_sort'});
