...
<div class="ncsc-flow-item">
  ...
  <div class="item-order">
    ...
    <dl class="line">
      ...
      <dd><a href="<?php echo SHOP_SITE_URL;?>/index.php?m=store_order&a=show_order&order_id=<?php echo $output['order']['order_id'];?>" target="_blank"> <?php echo $output['order']['order_sn'];?> </a><a href="javascript:void(0);" class="a">更多<i class="icon-angle-down"></i>
