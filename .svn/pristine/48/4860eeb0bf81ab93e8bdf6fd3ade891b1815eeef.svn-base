...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?m=contract&a=applylist" title="返回列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
    ...
    <div class="ncap-form-default">
      ...
      <div class="bot"><a id="submitBtn" class="ncap-btn-big ncap-btn-green" href="index.php?m=contract&a=applylist">返回列表</a></div>
    </div>
</div>