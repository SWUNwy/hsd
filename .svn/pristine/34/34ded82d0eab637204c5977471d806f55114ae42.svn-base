...
<div class="left-content">
  ...
  <?php if(!empty($output['theme_list'])){?>
    ...
    <?php foreach ($output['theme_list'] as $val){?>
      <li>
        <dl class="theme-info">
          <dt class="theme-title"><?php echo $val['member_name'].$lang['nc_colon'];?><a href="<?php echo CIRCLE_SITE_URL;?>/index.php?m=theme&a=theme_detail&c_id=<?php echo $val['circle_id'];?>&t_id=<?php echo $val['theme_id'];?>"><?php echo $val['theme_name'];?></a><span>(<?php echo @date('Y-m-d', $val['theme_addtime']);?>)</span></dt>
          <dd class="theme-file">
          ...
          <dd class="theme-txt"><p><?php echo removeUBBTag($val['theme_content']);?></p><a href="<?php echo CIRCLE_SITE_URL;?>/index.php?m=theme&a=theme_detail&c_id=<?php echo $val['circle_id'];?>&t_id=<?php echo $val['theme_id'];?>">[<?php echo $lang['sns_look_at_original'];?>]</a></dd>
          <dd class="theme-date"><?php if($val['lastspeak_name']){?><?php echo $lang['sns_lastspeak_time'].$lang['nc_colon'];?><em><?php echo @date('Y-m-d', $val['lastspeak_time'])?></em><?php }else{echo $lang['sns_reply_null'];}?><span><?php echo $lang['sns_come_from'].$lang['nc_colon'];?><a href="<?php echo CIRCLE_SITE_URL;?>/index.php?m=group&c_id=<?php echo $val['circle_id'];?>"><?php echo $val['circle_name'];?></a></span></dd>
        </dl>
      </li>
    <?php }?>
    </ul>
