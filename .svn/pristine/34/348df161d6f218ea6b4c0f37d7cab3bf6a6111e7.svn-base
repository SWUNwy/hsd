...
<div class="index_block home2">
  ...
  <div class="title">
    ...
    <?php } ?>
    	 <h5>间距：</h5>
    <input id="home1_title" type="text" class="txt w200" name="item_data[jj]" value="<?php echo $item_data['jj'];?>">
    	 <h5>背景色：</h5>
    <input id="home1_title" type="text" class="txt w200" name="item_data[bgcolor]" value="<?php echo $item_data['bgcolor'];?>">
  </div>
  <div class="content">
    <?php if($item_edit_flag) { ?>
    <h5>内容：</h5>
    <?php } ?>
    <div class="home2_1" style="max-width:166px;height: 170px;">
      <div nctype="item_image" class="item" style="max-width:166px;height:160px;"> <img nctype="image" src="<?php echo getMbSpecialImageUrl($item_data['square_image']);?>" alt="" style="max-width:160px;">
        <?php if($item_edit_flag) { ?>
    ...
    <div class="home2_1" style="max-width:166px;height: 170px;">
        ...
        <div nctype="item_image" class="item" style="max-width:166px;height:160px;"> <img nctype="image" src="<?php echo getMbSpecialImageUrl($item_data['rectangle1_image']);?>" alt="" style="max-width:160px;">
          <?php if($item_edit_flag) { ?>
  ...
  <div class="home2_1" style="max-width:166px;height: 170px;">
        <div nctype="item_image" class="item" style="max-width:166px;height:160px;"> <img nctype="image" src="<?php echo getMbSpecialImageUrl($item_data['rectangle2_image']);?>" alt="" style="max-width:160px;">
          <?php if($item_edit_flag) { ?>
