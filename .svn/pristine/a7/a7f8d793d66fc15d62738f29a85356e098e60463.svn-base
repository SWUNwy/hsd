...
<div class="add-order-wrap" style="magin-top:50px;" id="mainWrap">
   <div class="m-20 b-1">
     <h4 class="bg-fa pt-10 pb-10 bb-1 fw-b pl-20 bt-1">账号列表</h4>
     <div class="ta-r mt-10 mb-10 mr-5">		
	  <a href="index.php?m=store_account&a=account_add"><span class="btn" id="exportExcel">新增账号</span></a>
	</div>
  ...
  <tbody>
    ...
    <td></td>
      ...
      <td class="nscs-table-handle">
          <span><a href="<?php echo urlShop('store_account', 'account_edit', array('seller_id' => $value['seller_id']));?>" class="btn-blue">
        <p><?php echo $lang['nc_edit'];?></p></a>
          </span><span><a nctype="btn_del_account" data-seller-id="<?php echo $value['seller_id'];?>" href="javascript:;" class="btn-red">
