...
<div class="wrap">
  ...
  <form method="get" action="index.php">
    <table class="ncm-search-table">
      <input type="hidden" name="m" value="member_return" />
    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="tl"><dl class="goods-name">
            ...
            <dd><?php echo $lang['refund_order_ordersn'].$lang['nc_colon'];?><a href="index.php?m=m_order&a=show_order&order_id=<?php echo $val['order_id']; ?>" target="_blank"><?php echo $val['order_sn'];?></a></dd>
          </dl></td>
        ...
        <td class="bdr"><?php if($val['seller_state'] == 2 && $val['return_type'] == 2 && $val['goods_state'] == 1) { ?>
          <p><a href="index.php?m=m_return&a=ship&return_id=<?php echo $val['refund_id']; ?>" class="ncbtn">退货</a></p>
          <?php } else { ?>
          <a href="index.php?m=m_return&a=view&return_id=<?php echo $val['refund_id']; ?>" class="ncbtn">查看</a>
          <?php } ?>
          ...
          <p><a href="javascript:void(0)" class="ncbtn ncbtn-bittersweet" nc_type="dialog" dialog_title="延迟时间" dialog_id="return_delay" dialog_width="480"
        	    uri="index.php?m=m_return&a=delay&return_id=<?php echo $val['refund_id']; ?>"> 延时 </a></p>
          <?php } ?></td>
      </tr>
      <?php } ?>
      <?php } else { ?>
