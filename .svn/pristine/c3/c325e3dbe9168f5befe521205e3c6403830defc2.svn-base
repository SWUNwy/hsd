<div class="groupbuy-gallery"> <a class='sample_demo' id="select_s" href="index.php?m=store_album&a=pic_list&item=groupbuy" style="display:none;"><?php echo $lang['store_goods_batch_edit_submit'];?></a>
