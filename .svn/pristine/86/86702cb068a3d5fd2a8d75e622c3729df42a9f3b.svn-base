...
class messageControl extends SystemControl{
    private $links = array(
        array('url'=>'m=message&a=seller_tpl', 'lang'=>'seller_tpl'),
        array('url'=>'m=message&a=member_tpl', 'lang'=>'member_tpl'),
    );
    ...
    public function seller_tpl_editOp() {
        ...
        $this->links[] = array('url'=>'m=message&a=seller_tpl_edit','lang'=>'seller_tpl_edit');
    ...
    public function member_tpl_editOp() {
        ...
        $this->links[] = array('url'=>'m=message&a=member_tpl_edit','lang'=>'member_tpl_edit');
