    ...
    <div class="tabs-panels">
      <div class="misc-info">
        <dl>
          ...
          <dd><a href="index.php?m=order&a=show_order&order_id=<?php echo $output['order_info']['order_id'];?>"> <?php echo $output['order_info']['order_sn'];?></a></dd>
      ...
      <dd class="opt">
        <?php
                        if(empty($output['complain_info']['complain_pic1'])&&empty($output['complain_info']['complain_pic2'])&&empty($output['complain_info']['complain_pic3'])) {
                            ...
                            $pic_link = 'index.php?m=show_pics&type=complain&pics=';
...
function get_complain_talk() {
    ...
    $.ajax({
        type:'POST',
        url:'index.php?m=complain&a=get_complain_talk',
        cache:false,
...
function publish_complain_talk() {
        $.ajax({
            type:'POST',
                url:'index.php?m=complain&a=publish_complain_talk',
                cache:false,
...
function forbit_talk(talk_id) {
        $.ajax({
            type:'POST',
                url:'index.php?m=complain&a=forbit_talk',
                cache:false,
  ...
  <div class="ncap-form-default">
    ...
    <dl class="row" id="close_complain">
      ...
      <form method='post' id="verify_form" action="index.php?m=complain&a=complain_verify">
    ...
    <form method='post' id="close_form" action="index.php?m=complain&a=complain_close">
