...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?m=snstrace&a=tracelist" title="返回动态列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
...
$(function(){
    $("#flexigrid").flexigrid({
        url: 'index.php?m=snstrace&a=get_comment_xml&id=<?php echo $_GET['tid'];?>',
        colModel : [
...
function fg_del(id) {
    if(confirm('删除后将不能恢复，确认删除这项吗？')){
        $.getJSON('index.php?m=snstrace&a=commentdel', {id:id}, function(data){
            if (data.state) {
