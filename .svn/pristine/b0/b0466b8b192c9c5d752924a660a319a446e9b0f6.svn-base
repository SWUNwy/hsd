...
<div class="wrap">
  ...
  <form action="<?php echo MEMBER_SITE_URL;?>/index.php?m=m_information&a=upload" enctype="multipart/form-data" id="form_avaster" method="post">
  ...
  <?php }else{?>
  <form action="<?php echo MEMBER_SITE_URL;?>/index.php?m=m_information&a=cut" id="form_cut" method="post">
    <input type="hidden" name="form_submit" value="ok" />
