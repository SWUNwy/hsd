...
<div class="page">
  ...
  <form id="post_form" method="post">
    ...
    <div class="ncap-form-default">
      ...
      <div class="bot"> <a href="JavaScript:void(0);" class="ncap-btn-big ncap-btn-green" id="submitBtn"><?php echo $lang['nc_submit'];?></a><a href="index.php?m=mb_app&a=mb_qr"  class="ncap-btn-big ncap-btn-orange ml10">生成二维码</a> </div>
    </div>
  </form>
</div>
<script>
