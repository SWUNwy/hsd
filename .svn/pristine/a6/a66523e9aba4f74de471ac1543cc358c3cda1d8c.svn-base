...
<div class="ncap-form-default">
  ...
  <div class="bot"><a  class="ncap-btn-big ncap-btn-green" href="index.php?m=predeposit&a=recharge_edit&id=<?php echo $output['info']['pdr_id']; ?>"><span><?php echo  $lang['admin_predeposit_payed'];?></span></a></div>
  <?php } ?>
</div>
