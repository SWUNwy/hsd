...
$(function(){
    ...
    $('#fileupload').fileupload({
        dataType: 'json',
        url: '<?php echo SHOP_SITE_URL;?>/index.php?m=sns_album&a=swfupload',
        add: function (e,data) {
  ...
  <div id="pictureIndex" class="picture-index">
    ...
    <div class="album-info">
      <div class="build-album">
        <div class="button"><a uri="index.php?m=sns_album&a=album_add" nc_type="dialog" dialog_title="<?php echo $lang['album_new_class_add'];?>" class="btn" ><i></i><?php echo $lang['album_new_class_add'];?></a></div>
      </div>
    ...
    <div class="album-cover">
      <div class="cover"> <span class="thumb size190"><i></i><a href="index.php?m=sns_album&a=album_pic_list&id=<?php echo $v['ac_id']?>&mid=<?php echo $output['master_id'];?>">
        <?php if($v['ac_cover'] != ''){ ?>
      ...
      <?php if($output['relation'] == '3'){?>
      <div class="handle"><a href="JavaScript:void(0);" class="edit" nc_type="dialog" dialog_title="<?php echo $lang['album_class_deit'];?>" dialog_id='album_<?php echo $v['ac_id'];?>' dialog_width="480" uri="index.php?m=sns_album&a=album_edit&id=<?php echo $v['ac_id'];?>"><i></i><?php echo $lang['album_class_edit'];?></a>
        <?php if($v['is_default'] != '1'){?>
        <a href="javascript:void(0)" onclick="ajax_get_confirm('<?php echo $lang['album_class_delete_confirm_message'];?>', 'index.php?m=sns_album&a=album_del&id=<?php echo $v['ac_id'];?>');" class="del"><i></i><?php echo $lang['album_class_delete'];?></a>
        <?php }?>
      </div>
      <?php }?>
    </div>
