...
$(function(){
    $("#flexigrid").flexigrid({
        url: 'index.php?m=groupbuy&a=price_list_xml',
        colModel: [
        ...
        buttons: [
            {
                ...
                title: '添加一条新数据到列表',
                onpress: function() {
                    location.href = 'index.php?m=groupbuy&a=price_add';
                }
            },
            {
                ...
                onpress: function() {
                    ...
                    location.href = 'index.php?m=groupbuy&a=price_drop&range_id=' + ids.join(',');
                }
            }
        ],
        usepager: false,
