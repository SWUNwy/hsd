    ...
    <div class="basic-info">
      <dl class="ncsc-seller-info">
        <dt class="seller-name">
		 ...
		 <?php }else{
				echo '<a href="index.php?m=s_center&a=distribution" style=" background:#48CFAE;padding:5px; color:#fff;">申请开通分销</a>';
				}
		 }else{
        ...
        <dd class="store-validity"><?php echo $lang['store_validity'].$lang['nc_colon'];?><strong><?php echo $output['store_info']['store_end_time_text'];?>
          ...
          <a href="index.php?m=store_info&a=reopen">马上续签</a>
          <?php } ?>
          </strong> </dd>
      </dl>
  ...
  <div class="seller-cont">
    <div class="container type-a">
      ...
      <div class="content">
        ...
        <ul>
          <li><a href="index.php?m=store_goods_online&a=index"><?php echo $lang['store_goods_selling'];?> <strong id="nc_online"></strong></a></li>
          <?php if (C('goods_verify')) {?>
          <li><a href="index.php?m=store_goods_offline&a=index&type=wait_verify&verify=10" title="<?php echo $lang['store_inform30'];?>">发布待平台审核 <strong id="nc_waitverify"></strong></a></li>
          <li><a href="index.php?m=store_goods_offline&a=index&type=wait_verify&verify=0" title="<?php echo $lang['store_inform30'];?>">平台审核失败 <strong id="nc_verifyfail"></strong></a></li>
          <?php }?>
          <li><a href="index.php?m=store_goods_offline&a=index"><?php echo $lang['store_goods_storage'];?> <strong id="nc_offline"></strong></a></li>
          <li><a href="index.php?m=store_goods_offline&a=index&type=lock_up"><?php echo $lang['store_goods_show0'];?> <strong id="nc_lockup"></strong></a></li>
          <li><a href="index.php?m=store_consult&a=consult_list&type=to_reply"><?php echo $lang['store_to_consult'];?> <strong id="nc_consult"></strong></a></li>
        </ul>
      </div>
    </div>
    ...
    <div class="container type-a">
      ...
      <div class="content">
        <dl class="focus">
          ...
          <dd><a href="index.php?m=store_order"><?php echo $lang['store_order_progressing'];?> <strong id="nc_progressing"></strong></a></dd>
          <dt><?php echo $lang['store_complain_info'].$lang['nc_colon'];?></dt>
          <dd><a href="index.php?m=store_complain&select_complain_state=1"><?php echo $lang['store_complain'];?> <strong id="nc_complain"></strong></a></dd>
        </dl>
        <ul>
          <li><a href="index.php?m=store_order&a=index&state_type=state_new"><?php echo $lang['store_order_pay'];?> <strong id="nc_payment"></strong></a></li>
          <li><a href="index.php?m=store_order&a=index&state_type=state_pay"><?php echo $lang['store_shipped'];?> <strong id="nc_delivery"></strong></a></li>
          <li><a href="index.php?m=store_refund&lock=2"> <?php echo '售前退款';?> <strong id="nc_refund_lock"></strong></a></li>
          <li><a href="index.php?m=store_refund&lock=1"> <?php echo '售后退款';?> <strong id="nc_refund"></strong></a></li>
          <li><a href="index.php?m=store_return&lock=2"> <?php echo '售前退货';?> <strong id="nc_return_lock"></strong></a></li>
          <li><a href="index.php?m=store_return&lock=1"> <?php echo '售后退货';?> <strong id="nc_return"></strong></a></li>
          <li><a href="index.php?m=store_bill&a=index&bill_state=1"> <?php echo '待确认账单';?> <strong id="nc_bill_confirm"></strong></a></li>
        </ul>
      </div>
    </div>
    ...
    <div class="container type-d h500">
      ...
      <div class="content">
        ...
        <dl class="tghd">
          <dt class="p-name"> <a href="index.php?m=store_groupbuy"><?php echo $lang['store_groupbuy'];?></a></dt>
          <dd class="p-ico"></dd>
          <dd class="p-hint">
        ...
        <dl class="xszk">
          <dt class="p-name"><a href="index.php?m=store_promotion_xianshi&a=xianshi_list"><?php echo $lang['store_xianshi'];?></a></dt>
          <dd class="p-ico"></dd>
        ...
        <dl class="mjs">
          <dt class="p-name"><a href="index.php?m=store_promotion_mansong&a=mansong_list"><?php echo $lang['store_mansong'];?></a></dt>
          <dd class="p-ico"></dd>
          <dd class="p-hint"><span>
        ...
        <dl class="zhxs">
          <dt class="p-name"><a href="index.php?m=store_promotion_bundling&a=bundling_list"><?php echo $lang['store_bundling'];?></a></dt>
          <dd class="p-ico"></dd>
          <dd class="p-hint"><span>
        ...
        <dl class="tjzw">
          <dt class="p-name"><a href="index.php?m=store_promotion_booth&a=booth_list">推荐展位</a></dt>
          <dd class="p-ico"></dd>
          <dd class="p-hint"><span>
        ...
        <dl class="djq">
          <dt class="p-name"><a href="index.php?m=store_voucher"><?php echo $lang['store_voucher'];?></a></span></dt>
          <dd class="p-ico"></dd>
          <dd class="p-hint"><span>
...
$(function(){
    ...
    $.getJSON('index.php?m=s_center&a=statistics&rand='+timestamp, null, function(data){
