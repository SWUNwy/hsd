...
<div class="page"> 
  <!-- 页面导航 -->
  <div class="fixed-bar">
    <div class="item-title"><?php if ($output['special_id'] > 0) {?><a class="back" href="index.php?m=mb_special&a=special_list" title="返回列表"><i class="fa fa-arrow-circle-o-left"></i></a><?php }?>
      <div class="subject">
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        var update_item_sort = function() {
            ...
            $.post("index.php?m=mb_special&a=update_item_sort", {special_id: special_id, item_id_string: item_id_string}, function(data) {
                if(typeof data.error != 'undefined') {
        ...
        $('#item_list').on('click', '[nctype="btn_usable"]', function() {
            ...
            $.post("index.php?m=mb_special&a=update_item_usable", {item_id: item_id, usable: usable, special_id: special_id}, function(data) {
                if(typeof data.error != 'undefined') {
                    showError(data.message);
                }
            }, 'json');
