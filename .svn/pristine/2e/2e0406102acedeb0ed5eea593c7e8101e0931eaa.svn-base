...
<div class="wwi-container wrapper" >
    ...
    <div class="shop_con_list" id="main-nav-holder">
      <nav class="sort-bar" id="main-nav">
        ...
        <div class="sortbar-location">商品所在地：
          <div class="select-layer">
            ...
            <i class="direction"></i>
            <ul class="options">
              <?php require(BASE_TPL_PATH.'/Index/goods_class_area.php');?>
            </ul>
          </div>
        </div>
      </nav>
      <!-- 商品列表循环  -->
      <div>
      <?php require_once (BASE_TPL_PATH.'/Index/goods.squares.php');?>
      </div>
