...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?m=article_class&a=article_class" title="返回列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
	...
	$('#article_class_form').validate({
        ...
        rules : {
            ac_name : {
                required : true,
                remote   : {
                url :'index.php?m=article_class&a=ajax&branch=check_class_name',
                type:'get',
                data:{
                    ac_name : function(){
                        return $('#ac_name').val();
