...
class m_redpacketControl extends BaseMemberControl{
    ...
    public function rp_bindingOp(){
        if(chksubmit(false,true)){
            ...
            if($result){
                ...
                showDialog('红包领取成功', 'index.php?m=m_redpacket&a=rp_list','succ');
            } else {
                showDialog('红包领取失败');
            }
        }
    ...
    private function profile_menu($menu_key='') {
        $menu_array = array(
            1=>array('menu_key'=>'rp_list','menu_name'=>'我的红包','menu_url'=>'index.php?m=m_redpacket&a=rp_list'),
            2=>array('menu_key'=>'rp_binding','menu_name'=>'领取红包','menu_url'=>'index.php?m=m_redpacket&a=rp_binding'),
        );
