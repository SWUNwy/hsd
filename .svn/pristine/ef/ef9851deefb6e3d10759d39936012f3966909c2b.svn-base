...
<div class="tabmenu">
  ...
  <a uri="index.php?m=store_album&a=album_add" nc_type="dialog" dialog_title="<?php echo $lang['album_class_add'];?>" class="ncbtn ncbtn-mint" style="right: 100px;"><i class="icon-folder-open "></i><?php echo $lang['album_class_add'];?></a>
    ...
    <tbody>
      <tr>
        ...
        <td class="w100"><form name="select_sort" id="select_sort" class="sortord">
            ...
            <input type="hidden" name="a" value="album_cate" />
  ...
  <div class="ncsc-album">
    <ul>
      ...
      <li class="hidden">
        <dl>
          <dt>
            <div class="covers"><a href="index.php?m=store_album&a=album_pic_list&id=<?php echo $v['aclass_id']?>">
            ...
            <h3 class="title"><a href="index.php?m=store_album&a=album_pic_list&id=<?php echo $v['aclass_id']?>"><?php echo $v['aclass_name'];?></a></h3>
          </dt>
          <dd class="date"><?php echo $lang['album_class_pic_altogether'];?><?php echo $v['count']?><?php echo $lang['album_class_pic_folio'];?></dd>
          <dd class="buttons"><span nc_type="dialog" dialog_title="<?php echo $lang['album_class_deit'];?>" dialog_id='album_<?php echo $v['aclass_id'];?>' dialog_width="480" uri="index.php?m=store_album&a=album_edit&id=<?php echo $v['aclass_id'];?>"><a href="JavaScript:void(0);"><i class="icon-pencil"></i><?php echo $lang['album_class_edit'];?></a></span>
            <?php if($v['is_default'] != '1'){?>
            <a href="javascript:void(0)" onclick="ajax_get_confirm('<?php echo $lang['album_class_delete_confirm_message'];?>', 'index.php?m=store_album&a=album_del&id=<?php echo $v['aclass_id'];?>');"><i class="icon-remove-sign"></i><?php echo $lang['album_class_delete'];?></a>
            <?php }?>
          </dd>
        </dl>
      </li>
