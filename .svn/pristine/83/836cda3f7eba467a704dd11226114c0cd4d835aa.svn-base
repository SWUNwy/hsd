...
<div class="page">
  ...
  <form id="post_form" method="post" action="index.php?m=vr_refund&a=edit&refund_id=<?php echo $output['refund']['refund_id']; ?>">
      ...
      <dl class="row">
        ...
        <dd class="opt"><?php echo ncPriceFormat($output['order']['pay_amount']);?></dd>
          ...
          <dl class="row">
            <dt class="tit"></dt>
            <dd class="opt">
                <a href="<?php echo ADMIN_SITE_URL;?>/index.php?m=vr_refund&a=alipay&refund_id=<?php echo $output['refund']['refund_id']; ?>" target="_blank">支付宝退款</a>  
...
$(function(){
	...
	$("#wxpayBtn").click(function(){
	    var ajaxurl = '<?php echo ADMIN_SITE_URL;?>/index.php?m=vr_refund&a=wxpay&refund_id=<?php echo $output['refund']['refund_id']; ?>';
		show_msg(ajaxurl);
	});
	$("#alipayBtn").click(function(){
	    var ajaxurl = '<?php echo ADMIN_SITE_URL;?>/index.php?m=vr_refund&a=get_detail&refund_id=<?php echo $output['refund']['refund_id']; ?>';
		show_msg(ajaxurl);
	});
    $('#post_form').validate({
