...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base nc-row">
        <li><a href="index.php?m=vr_groupbuy&a=class_list">分类管理</a></li>
  ...
  <form id="list_form" method="post" action="index.php?m=vr_groupbuy&a=area_drop">
...
$(function(){
    $("#flexigrid").flexigrid({
        url: 'index.php?m=vr_groupbuy&a=area_list_xml',
        colModel: [
