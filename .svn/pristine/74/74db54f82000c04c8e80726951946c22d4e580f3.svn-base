...
<div class="ncc-main">
  ...
  <form action="index.php?m=payment&a=pd_order" method="POST" id="buy_form">
        ...
        <li payment_code="<?php echo $val['payment_code']; ?>">
          ...
          <div class="predeposit" nc_type="predeposit" style="display:none">
            <?php if ($val['payment_code'] == 'predeposit') {?>
                ...
                <p>当前预存款余额<br/>￥<?php echo $output['available_predeposit'];?><br/>不足以支付该订单<br/><a href="<?php echo MEMBER_SITE_URL.'/index.php?m=predeposit';?>" class="predeposit">马上充值</a></p>
                <?php } else {?>
