...
$(function(){
	...
	check_tuwen(1);
	//var url = "/biz.php?ctl=wechat&m=showmess";
	var url = "index.php?m=seller_wechat&a=showmess";
...
function btnsave(num,count){
	...
	if(ktype==1){
		...
		//var url = "/biz.php?ctl=wechat&m=addmess";
		var url = "index.php?m=seller_wechat&a=addmess";
