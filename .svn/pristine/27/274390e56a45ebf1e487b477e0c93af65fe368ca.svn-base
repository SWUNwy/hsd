...
<div class="index_block goods-list">
  ...
  <div nctype="item_content" class="content">
    ...
    <div nctype="item_image" class="item" style="width: 440px">
      <div class="goods-pic" style="float:left"><img nctype="goods_image" src="<?php echo cthumb($item_value['goods_image']);?>" alt=""></div>
      <div class="goods-name" style="float: right;width:200px" nctype="goods_name"><?php echo $item_value['goods_name'];?></div>
      ...
      <a nctype="btn_del_item_image" style="top:30px" href="javascript:;">删除</a>
...
<h3>选择商品添加</h3>
  ...
  <a id="btn_mb_special_goods_search" class="ncap-btn" href="javascript:;" style="vertical-align: top; margin-left: 5px;" title="搜索">搜索</a>
...
<script type="text/javascript">
    $(document).ready(function(){
        <?php if($_GET['a']=="special_item_edit") {?>
		...
		<?php }?>
    	 ...
    	 $('.class-select').live('change', function() {
    		 var url = '<?php echo urlAdminMobile('mb_special', 'goods_list_select');?>';
    		 var gc_id_2 = $(this).children(':selected').val();
    		 $('#mb_special_goods_list').load(url, {gc_id_2: gc_id_2});
 	 	 });
