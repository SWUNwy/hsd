...
<div id="lazymodule">
  ...
  <ul class="fd-list">
    ...
    <li nc_type="tracerow_<?php echo $v['trace_id']; ?>">
      <div class="fd-aside"><span class="thumb size60"><i></i> <a href="index.php?m=m_snshome&mid=<?php echo $v['trace_memberid'];?>" target="_blank"> <img src="<?php if ($v['trace_memberavatar']!='') { echo UPLOAD_SITE_URL.'/'.ATTACH_AVATAR.DS.$v['trace_memberavatar']; } else {  echo UPLOAD_SITE_URL.'/'.ATTACH_COMMON.DS.C('default_user_portrait'); } ?>" data-param="{'id':<?php echo $v['trace_memberid'];?>}" nctype="mcard" onload="javascript:DrawImage(this,60,60);"> </a> </span> 
        <!--<p class="arrow"></p>--> 
      </div>
      <dl class="fd-wrap">
        <dt>
          <h3><a href="index.php?m=m_snshome&mid=<?php echo $v['trace_memberid'];?>" target="_blank" data-param="{'id':<?php echo $v['trace_memberid'];?>}" nctype="mcard"><?php echo $v['trace_membername'];?></a><?php echo $lang['nc_colon'];?></h3>
  ...
  <div class="sns-norecord"><?php echo $lang['sns_trace_nohave_1'];?><br>
    <a href="<?php echo MEMBER_SITE_URL;?>/index.php?m=m_snsfriend&a=follow"><?php echo $lang['sns_trace_nohave_2'];?></a></div>
  <?php }?>
  <?php }?>
</div>