  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base nc-row">
        ...
        <li><a href="index.php?m=vr_groupbuy&a=area_list">区域管理</a></li>
      </ul>
    </div>
  </div>
      ...
      <tbody>
        ...
        <tr class="hover edit" data-id="<?php echo $val['class_id']; ?>">
          ...
          <td class="handle"><a href="javascript:;" onclick="submit_delete(<?php echo $val['class_id']; ?>)" class="btn red"><i class="fa fa-trash-o"></i>删除</a> <span class="btn"> <em><i class="fa fa-cog"></i>设置<i class="arrow"></i></em>
            <ul>
              <li><a href="index.php?m=vr_groupbuy&a=class_edit&class_id=<?php echo $val['class_id']; ?>">编辑分类</a></li>
              <li><a href="index.php?m=vr_groupbuy&a=class_add&parent_class_id=<?php echo $val['class_id']; ?>">新增下级</a></li>
            </ul>
            </span></td>
        ...
        <tr class="<?php echo 'class_id'.$val['class_id'];?>" style="display:none;" data-id="<?php echo $val1['class_id']; ?>">
          <td></td>
          <td class="handle"><a href="javascript:;" onclick="submit_delete(<?php echo $val1['class_id']; ?>)" class="btn red"><i class="fa fa-trash-o"></i>删除</a> <a href="index.php?m=vr_groupbuy&a=class_edit&class_id=<?php echo $val1['class_id']; ?>" class="btn blue"><i class="fa fa-pencil-square-o"></i>编辑</a></td>
...
function submit_delete(id) {
    if (confirm('<?php echo $lang['nc_ensure_del']; ?>')) {
        ...
        $('#list_form').attr('action','index.php?m=vr_groupbuy&a=class_del');
        $('#class_id').val(id);
        $('#list_form').submit();
    }
}
