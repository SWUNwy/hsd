...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?m=ownshop&a=list" title="返回列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
    ...
    $('#store_form').validate({
        ...
        rules : {
            ...
            member_name: {
                ...
                maxlength : 15,
                remote   : {
                    url : 'index.php?m=ownshop&a=check_member_name',
                    type: 'get',
                    data:{
            ...
            seller_name: {
                ...
                maxlength : 15,
                remote   : {
                    url : 'index.php?m=ownshop&a=check_seller_name',
                    type: 'get',
                    data:{
