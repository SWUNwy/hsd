...
<meta name="description" content="海拍客致力于服务中小母婴实体店，是实体店提供0库存、0资金占用的母婴供应平台，国外优质商品进入中国市场的新通道。">
<title></title>
...
<body class="has-goods-header" data-page-rp="132">
<input type="hidden" id="basePath" value="" />

<div class="content cf" id="con-container">
  <link href="<?php echo SHOP_TEMPLATES_URL?>/seller_css/itemDetail.css?v=20161216164243" rel="stylesheet" type="text/css"/>
</div>
<div class="pageMain bg-e">
  ...
  <div class="inner-header pt-30 bg-w clearfix bb-1" id="navBox">
    <div class="fixed-container">
      <div class="clearfix" id="searchInputHeader">
        <div class="f-l"> <img src="<?php echo SHOP_TEMPLATES_URL?>/images/seller/shouyetoubu.png?v=20161216164243"> </div>
        <div class="f-r clearfix searchBox">
          <div class="clearfix">
            ...
            <a class="searchBtn f-l" id="headerSearchBtn" data-rpno="20.1" data-rpgo="true">搜索</a> <a class="cart-head-btn f-l ml-10" target="_blank" href="index.php?m=store_cart" data-rpno="20.2"><i class="iconfont mr-10" style="font-size: 16px">&#xe643;</i>购物车
            <p class="pos-r ml-5 d-ib fs-12 num-pop" id="cart_num"><?php echo $output['cart_goods_num'];?></p>
            </a> </div>
      ...
      <ul class="w-100 mt-35 clearfix navBox pos-r" id="channelWrap">
        ...
        <li class="navItem pos-r"><a href="/index.php?m=itemIndex" data-rpno="20.3">首页</a></li>
  ...
  <ul class="about-us-wrap" id="aboutUsWrap">
  	<li class="cur-p w-100 contact-item pos-r" id="cartIcon"> 
    	<a href="index.php?m=store_cart" data-rpno="20.8">
...
<div class="nch-breadcrumb-layout">
	<div class="nch-breadcrumb wrapper">
    	...
    	<i class="icon-home"></i>
        <span><a href="<?php echo $output['nav_link_list'][2]['link']?>"><?php echo $output['nav_link_list'][2]['title']?></a></span>
        <span class="arrow">&gt;</span>
        <span><?php echo $output['nav_link_list'][1]['title']?></span>
        <span class="arrow">&gt;</span>
        <span><?php echo $output['nav_link_list'][0]['title']?></span>
        <span class="arrow">&gt;</span>
        <span><?php echo $output['nav_link_list'][3]['title']?></span>
        <?php } ?>
    </div>
</div>
    ...
    <div class="ncs-goods-summary">
      ...
      <div class="ncs-meta">
        ...
        <dl>
          ...
          <dd class="price">
            ...
            <strong><?php echo $lang['currency'].ncPriceFormat($output['goods']['goods_price']);?></strong>
             <strong style="font-size:15px;">(单件:<?php echo $lang['currency'].ncPriceFormat($output['goods_unit_price']);?>)</strong> 
            <?php }?>
          </dd>
        </dl>
        <?php }else{ ?>
        ...
        <dl>
          ...
          <dd class="price">
            <?php if (isset($output['goods']['promotion_price']) && !empty($output['goods']['promotion_price'])) {?>
            <strong><i><?php echo $lang['currency'];?></i>???</strong><em>(原售价<?php echo $lang['nc_colon'];?><?php echo $lang['currency'].'???';?>)</em>
            <?php } else {?>
            <strong>???</strong>
            <?php }?>
          </dd>
        ...
        <dl style="display:none">
          <dt>税金<?php echo $lang['nc_colon'];?></dt>
          <dd class="price">            
            <?php echo $lang['currency'].ncPriceFormat($output['goods']['goods_tax']);?>      
          </dd>
        </dl>
        <dl class="rate">
          <dt>发货仓库：</dt>
          ...
          <span style="color:#F00"><?php echo $ci_storage['id']==$output['goods']['goods_storage_id']?$ci_storage['name']:"" ?></span>
          <?php }?>
	      <?php }?>
          </dd>
          <!-- E 发货仓库 -->
        ...
        <dl class="rate1">
          <dt>保质日期：</dt>
          <!-- S 有效日期 -->
          <?php if($output['goods']['expiry_date']<=0){ ?>
          <dd><span></span></dd>
          <?php }else{ ?>
          <dd><span style="color:#F00"><?php echo date('Y-m',$output['goods']['expiry_date']);?></span></dd>
          <?php } ?>
          <!-- E 有效日期 -->
        </dl>       
      </div>
...
$shownLevelSkus[$sku] = true; ?>
      ...
      <div class="ncs-buy" >
        ...
        <div class="ncs-figure-input" style="<?php echo $output['goods']['gc_id_1']==1?"display:none":""?>">
        ...
        <div class="ncs-btn">
          ...
          <div class="ncs-cart-popup">
            <dl>
              ...
              <dd class="btns"><a href="javascript:void(0);" class="ncbtn-mini ncbtn-mint" onClick="location.href='<?php echo SHOP_SITE_URL.DS?>index.php?m=store_cart'"><?php echo $lang['goods_index_view_cart'];?></a> <a href="javascript:void(0);" class="ncbtn-mini" value="" onClick="$('.ncs-cart-popup').css({'display':'none'});"><?php echo $lang['goods_index_continue_shopping'];?></a></dd>
            </dl>
          </div>
          <!-- E 加入购物车弹出提示框 --> 
        </div>
    ...
    <div class="ncs-recommend">
      ...
      <div class="content">
        <ul>
          ...
          <li>
            <dl>
              <dt class="goods-name"><a href="<?php echo urlShop('goods_itemIndex','index',array('goods_id'=>$goods_commend['goods_id']));?>" target="_blank" title="<?php echo $goods_commend['goods_jingle'];?>"><?php echo $goods_commend['goods_name'];?><em><?php echo $goods_commend['goods_jingle'];?></em></a></dt>
              <dd class="goods-pic"><a href="<?php echo urlShop('goods_itemIndex','index',array('goods_id'=>$goods_commend['goods_id']));?>" target="_blank" title="<?php echo $goods_commend['goods_jingle'];?>"><img src="<?php echo thumb($goods_commend, 240);?>" alt="<?php echo $goods_commend['goods_name'];?>"/></a></dd>
              <?php if($_SESSION['store_id']>0){ ?>
              <dd class="goods-price" title="商城价"><?php echo $lang['currency'];?><?php echo $goods_commend['goods_promotion_price'];?></dd>
              <?php }else{ ?>
              <dd class="goods-price" title="市场价" style="text-decoration: line-through;"><?php echo $lang['currency'];?><?php echo ncPriceFormat($goods_commend['goods_marketprice']);?></dd>
              <?php } ?>
            </dl>
          </li>
          <?php }?>
      ...
      <div class="ncs-goods-info-content bd" id="ncGoodsRate">
        <div class="top">
          ...
          <div class="btns"><span>您可对已购商品进行评价</span>
            <p><a href="<?php if ($output['goods']['is_virtual']) { echo urlShop('m_vr_order', 'index');} else { echo urlShop('m_order', 'index');}?>" class="ncbtn ncbtn-grapefruit" target="_blank"><i class="icon-comment-alt"></i>评价商品</a></p>
          </div>
        </div>
        <div class="ncs-goods-title-nav">
          <ul id="comment_tab">
    ...
    <div class="ncg-salelog" style="display:none">
      ...
      <div class="ncs-goods-info-content bd" id="ncGoodsTraded">
        <div class="top">
          ...
          <?php }else{ ?>
          <div class="price"><?php echo $lang['goods_index_goods_price'];?><strong>???</strong><?php echo $lang['goods_index_yuan'];?><span><?php echo $lang['goods_index_price_note'];?></span></div>
          <?php } ?>
        </div>
        <!-- 成交记录内容部分 -->
...
<!--youce-->
  ...
  <div class="ncs-sidebar">
    <?php include template('Shop/left_mall_related');?>
    ...
    <div class="ncs-sidebar-container ncs-top-bar">
      ...
      <div class="content">
            ...
            <li>
              <dl>
                ...
                <dd class="goods-pic"><a href="<?php echo urlShop('goods_itemIndex', 'index', array('goods_id' => $g['goods_id'])); ?>"><span class="thumb size60"><i></i><img src="<?php echo thumb($g, 60); ?>"  onload="javascript:DrawImage(this,60,60);"></span></a>
                  <p><span class="thumb size100"><i></i><img src="<?php echo thumb($g['goods_image'], 240); ?>" onload="javascript:DrawImage(this,100,100);" title="<?php echo $g['goods_name']; ?>"><big></big><small></small></span></p>
                </dd>
                <?php if($_SESSION['store_id']>0){ ?>
                <dd class="price pngFix" title="商城价"><?php echo ncPriceFormat($g['goods_promotion_price']); ?></dd>
                <?php }else{ ?>
                <dd class="price pngFix" title="市场价" style="text-decoration: line-through;"><?php echo ncPriceFormat($g['goods_marketprice']); ?></dd>
                <?php } ?>
              </dl>
            </li>
            <?php } ?>
        ...
        <!--<p><a href="<?php echo SHOP_SITE_URL;?>/index.php?m=m_goodsbrowse&a=list" class="nch-sidebar-all-viewed">全部浏览历史</a></p>--> 
      </div>
    </div>
    <?php } ?>
  </div>
...
<?php if ($_SESSION['is_login'] !== '1'){?>
	window.location.href = "/index.php?m=s_login&a=show_login&ref_url=http://<?php echo urlencode($_SERVER['SERVER_NAME'].$_SERVER["REQUEST_URI"])?>";
<?php }else{?>
    if (!quantity) {
        return;
    }
...
$(function(){
    ...
    $('#transport_pannel>a').click(function(){
	    ...
	    var url = 'index.php?m=goods&a=calc&rand='+Math.random();
    ...
    $("#nc-bundling").load('index.php?m=goods&a=get_bundling&goods_id=<?php echo $output['goods']['goods_id'];?>', function(){
        if($(this).html() != '') {
            $(this).show();
        }
    });
    <?php if ($output['goods']['is_virtual'] == 1) {?>
    $("#ncStoreMap").load('index.php?m=show_map&a=index&w=420&h=400&store_id=<?php echo $output['goods']['store_id'];?>', function(){
        if($(this).html() != '') {
            $(this).show();
        }
    });
    <?php } ?>
   /* $("#salelog_demo").load('index.php?m=goods&a=salelog&goods_id=<?php echo $output['goods']['goods_id'];?>&store_id=<?php echo $output['goods']['store_id'];?>&vr=<?php echo $output['goods']['is_virtual'];?>', function(){
        // Membership card
        $(this).find('[nctype="mcard"]').membershipCard({type:'shop'});
    });
	$("#consulting_demo").load('index.php?m=goods&a=consulting&goods_id=<?php echo $output['goods']['goods_id'];?>&store_id=<?php echo $output['goods']['store_id'];?>', function(){
		// Membership card
		$(this).find('[nctype="mcard"]').membershipCard({type:'shop'});
	});*/
...
//触及显示缩略图
    ...
    //记录浏览历史
	$.get("index.php?m=goods&a=addbrowse",{gid:<?php echo $output['goods']['goods_id'];?>});
	//初始化对比按钮
	//initCompare();

    $('[nctype="show_chain"]').click(function(){
        _goods_id = $(this).attr('data-goodsid');
        ajax_form('show_chain', '查看门店', 'index.php?m=goods&a=show_chain&goods_id=' + _goods_id, 640);
    });
...
$(document).ready(function(){
	$("#ncs-freight-selector").hover(function() {
		...
		if (typeof nc_a === "undefined") {
	 		$.getJSON(SITEURL + "/index.php?m=index&a=json_area&callback=?", function(data) {
	 			nc_a = data;
	...
	function _calc() {
		...
		if (_args != '') {
			...
			if (typeof calced_area[calc_area_id] == 'undefined') {
				//需要请求配送区域设置
				$.getJSON(SITEURL + "/index.php?m=goods&a=calc&" + _args + "&myf=<?php echo $output['store_info']['store_free_price']?>&callback=?", function(data){
