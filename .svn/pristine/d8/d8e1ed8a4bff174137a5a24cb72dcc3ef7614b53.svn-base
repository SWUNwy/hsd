    ...
    <div class="cms-sns-right-container">
      ...
      <div class="cms-favorites-user">
        <ul>
          ...
          <li><a target="_blank" href="<?php echo urlShop('m_snshome', 'index', array('mid'=>$val['member_id']));?>"><img alt="<?php echo $val['member_name'];?>" title="<?php echo $val['member_name'];?>" src="<?php echo getMemberAvatarForID($val['member_id']);?>" /></a></li>
          <?php }?>
        </ul>
      </div>
    </div>
