  ...
  <table class="ncm-default-table order">
    ...
    <tbody>
      <tr>
        ...
        <td class="ncm-table-handle"><span><a class="btn-grapefruit" onclick="ajax_get_confirm('您确定要取消预约/到货通知吗？', 'index.php?m=m_appoint&a=del_appoint&id=<?php echo $val['an_id'];?>');" href="javascript:void(0);"><i class="icon-trash"></i><p>删&nbsp;除</p></a></span></td>
      </tr>
    </tbody>
    <?php }?>
    <?php } else { ?>
