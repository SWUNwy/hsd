...
<div class="ncsc-form-default">
  <form id="add_form" action="index.php?m=store_promotion_cou&a=cou_edit_save" method="post">
...
<?php } ?>
        ...
        <a id="cou-sku-choose-btn" href="index.php?m=store_promotion_cou&a=cou_sku&cou_id=<?php echo $info['id']; ?>" class="ncbtn ncbtn-aqua">选择活动商品</a>
...
$(function() {
    ...
    var couLevelSkuChooseTriggered = function(id, url) {
        $("[data-cou-level-sku-choose-container='"+id+"']").load(
            url || 'index.php?m=store_promotion_cou&a=cou_level_sku&level='+id,
            function() {
