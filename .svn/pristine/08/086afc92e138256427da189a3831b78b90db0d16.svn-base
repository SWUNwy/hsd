...
<?php if ($output['isOwnShop']) { ?>
  <a href="<?php echo urlShop('store_groupbuy', 'groupbuy_add_vr'); ?>" style="right:100px" class="ncbtn ncbtn-mint" title="新增虚拟商品团购"><i class="icon-plus-sign"></i>新增虚拟团购</a>
...
<?php } else { ?>
  ...
  <a href="<?php echo urlShop('store_groupbuy', 'groupbuy_add_vr'); ?>" style="right:200px" class="ncbtn ncbtn-mint" title="新增虚拟商品团购"><i class="icon-plus-sign"></i>新增虚拟团购</a>
...
<table class="search-form">
  <form method="get">
    <input type="hidden" name="m" value="store_groupbuy" />
    <tr>
      <td>&nbsp;</td>
      <th>团购类型</th>
      <td class="w100">
