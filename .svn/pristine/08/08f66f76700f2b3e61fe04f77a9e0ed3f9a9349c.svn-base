...
;(function($) { 
    ...
    $.Zebra_Dialog = function() {
        ...
        var defaults = {
            ...
            max_height:                 400,              //  The maximum height, in pixels, before the content in the
            ...
            if (plugin.settings.show_close_button) {
                ...
                if ($title)
                    ...
                    $close.css({
                        ...
                        'top':      (parseInt($title.css('height'), 10) + parseInt($title.css('paddingTop'), 4) + parseInt($title.css('paddingBottom'), 10) - $close.height()) / 2
                    });
