...
$(function(){
    $("#flexigrid").flexigrid({
        url: 'index.php?m=stat_store&a=get_store_xml&provid=<?php echo $_GET['provid'];?>&scid=<?php echo $_GET['scid'];?>&t=<?php echo $_GET['t'];?>',
        colModel : [
...
function fg_operation(name, bDiv){
    var stat_url = 'index.php?m=stat_store&a=showstore&exporttype=excel&provid=<?php echo $_GET['provid'];?>&scid=<?php echo $_GET['scid'];?>&t=<?php echo $_GET['t'];?>';
