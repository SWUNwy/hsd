...
<div class="ncsc-flow-item">
  ...
  <div class="item-order">
    ...
    <dl class="line">
      <dt>订单编号：</dt>
      <dd><a target="_blank" href="index.php?m=store_order&a=show_order&order_id=<?php echo $output['order']['order_id']; ?>"><?php echo $output['order']['order_sn'];?></a> <a href="javascript:void(0);" class="a">更多<i class="icon-angle-down"></i>
