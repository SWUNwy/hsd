...
$(function(){
    $("#flexigrid").flexigrid({
        url: 'index.php?m=adv&a=get_ap_xml',
        colModel : [
...
function fg_operation(name, bDiv) {
    if (name == 'add') {
        window.location.href = 'index.php?m=adv&a=ap_add';
    }else if (name == 'delete') { 
...
{
   ajax_form('copy_adv', '<?php echo $lang['ap_get_js'];?>', 'index.php?m=adv&a=ap_copy&id='+id);
}
</script> 
