...
class store_classControl extends SystemControl{
        ...
        if (chksubmit()){
            ...
            if ($error != ''){
                ...
                if ($result){
                    $url = array(
                    array(
                    'url'=>'index.php?m=store_class&a=store_class_add',
                    'msg'=>$lang['continue_add_store_class'],
                    ),
                    array(
                    'url'=>'index.php?m=store_class&a=store_class',
        ...
        if (chksubmit()){
            ...
            if ($error != ''){
                ...
                if ($result){
                    ...
                    showMessage($lang['nc_common_save_succ'],'index.php?m=store_class&a=store_class');
                }else {
                    showMessage($lang['nc_common_save_fail']);
                }
            }
    ...
    public function store_class_delOp(){
        ...
        showMessage($lang['nc_common_del_fail'],'index.php?m=store_class&a=store_class');
    }
