  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base nc-row">
        <li><a href="index.php?m=brand&a=brand"><?php echo $lang['nc_manage'];?></a></li>
...
$(function(){
    $("#flexigrid").flexigrid({
        url: 'index.php?m=brand&a=get_xml&type=apply',
        colModel : [
...
function fg_apply(id) {
    ...
    $.getJSON('index.php?m=brand&a=brand_apply_set', {id:id}, function(data){
        if (data.state) {
