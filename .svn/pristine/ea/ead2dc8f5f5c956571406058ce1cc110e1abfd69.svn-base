...
<meta charset="utf-8">
<title><?php echo $output['goods']['goods_name']!=""?$output['goods']['goods_name']."-":""; ?>商家中心</title>
<!--
...
<link href="<?php echo SHOP_TEMPLATES_URL?>/seller_css/global.css?t=201612051122" rel="stylesheet" type="text/css">
<link href="<?php echo SHOP_TEMPLATES_URL?>/seller_css/common.css?t=201612051122" rel="stylesheet" type="text/css">
<script>
...
-->
<?php require_once template('Layouts/layout_top_item1');?>

<?php require_once($tpl_file); ?>
<?php require_once template('footer1');?>
