...
<dd>JavaScript:</dd>
  <dd >
    <input type="text" style=" width:400px;" value='<script type="text/javascript" src="<?php echo SHOP_SITE_URL;?>/index.php?m=adv&a=advshow&ap_id=<?php echo $_GET['id'];?>"></script>' />
  </dd>
  <dd>PHP:</dd>
