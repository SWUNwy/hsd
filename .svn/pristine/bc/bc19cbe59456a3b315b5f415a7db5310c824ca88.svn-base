...
class orderModel extends Model {
     ...
     */
    public function getStoreOrderList($store_id, $order_sn, $external_order,$buyer_name, $state_type, $query_start_date, $query_end_date, $skip_off, $fields = '*', $extend = array(),$chain_id = null) {
        $condition = array();
        ...
        if ($external_order != '') {
            $condition['external_order'] = $external_order;
        }
        ...
        $order_list = $this->getOrderList($condition, 10, $fields, 'order_id desc','', $extend);
