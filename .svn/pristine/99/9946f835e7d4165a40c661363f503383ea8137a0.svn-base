$(function(){
	...
	TransTpl += "运费：\n";
	TransTpl += "<input class=\"w30 mr5 text\" type=\"text\" aria-label=\"默认运费件\" maxlength=\"4\" autocomplete=\"off\" data-field=\"start\" value=\"1\" name=\"default[TRANSTYPE][start]\">\n";
	TransTpl += "件内，\n";
	...
	RuleHead += "<tr>\n";
	RuleHead += "<th>运送到<\/th>\n";
	RuleHead += "<th class=\"w60\">首件<\/th>\n";
	RuleHead += "<th class=\"w110\">首费(元)<\/th>\n";
	RuleHead += "<th class=\"w60\">续件<\/th>\n";
