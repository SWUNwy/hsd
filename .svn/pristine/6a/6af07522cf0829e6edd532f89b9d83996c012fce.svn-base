...
class sns_circleControl extends BaseSNSControl {
    ...
    private function profile_menu($menu_key=''){
        ...
        $menu_array = array(
            1=>array('menu_key'=>'theme','menu_name'=>$theme_menuname,'menu_url'=>'index.php?m=sns_circle&a=theme&mid='.$this->master_id),
            2=>array('menu_key'=>'circle','menu_name'=>$circle_menuname,'menu_url'=>'index.php?m=sns_circle&a=circle&mid='.$this->master_id),
        );
