...
class store_joininControl extends SystemControl{
    ...
    public function edit_infoOp() {
        ...
        if (chksubmit()) {
            ...
            showMessage(Language::get('nc_common_save_succ'),'index.php?m=store_joinin&a=edit_info');
        }
    ...
    public function edit_helpOp() {
        ...
        if (chksubmit()) {
            ...
            if ($state) {
                ...
                showMessage(Language::get('nc_common_save_succ'),'index.php?m=store_joinin&a=help_list');
            } else {
