  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base nc-row">
        ...
        <li><a href="index.php?m=promotion_bundling&a=bundling_setting"><?php echo $lang['bundling_setting'];?></a></li>
      </ul>
    </div>
  </div>
  <!-- 操作说明 -->
...
<script>
$(function(){
    var flexUrl = 'index.php?m=promotion_bundling&a=bundling_list_xml';
