...
<div class="wrap">
  ...
  <form method="get" action="index.php">
    <table class="ncm-search-table">
      <input type="hidden" name='m' value='member_complain' />
      <tr>
        <td>&nbsp;</td>
    ...
    <tbody>
      ...
      <tr class="bd-line">
        ...
        <td><?php
				...
				?></td>
        <td class="ncm-table-handle"><span><a href="index.php?m=m_complain&a=complain_show&complain_id=<?php echo $val['complain_id'];?>" class="btn-bluejeans"><i class="icon-eye-open"></i>
          <p><?php echo $lang['complain_text_detail'];?></p></a></span>
            <?php if(intval($val['complain_state'])==10) { ?>
          <span><a href="javascript:void(0)" onclick="ajax_get_confirm('<?php echo $lang['complain_cancel_confirm'];?>','index.php?m=m_complain&a=complain_cancel&complain_id=<?php echo $val['complain_id']; ?>')" class="btn-bittersweet"><i class="icon-ban-circle"></i>
