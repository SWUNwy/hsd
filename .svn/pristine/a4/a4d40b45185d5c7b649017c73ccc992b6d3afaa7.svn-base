  ...
  <table class="flex-table">
    ...
    <tbody>
      ...
      <tr class="hover">
        ...
        <td class="handle-s"><a class="btn red" href="index.php?m=inform&a=inform_subject_drop&inform_subject_id=<?php echo $v['inform_subject_id'];?>" onclick="if(confirm('删除后将不能恢复，确认删除这  1 项吗？')){return true;} else {return false;}"><i class="fa fa-trash-o"></i>删除</a></td>
...
<script>
    ...
    function fg_operation(name, grid) {
        if (name == 'add') {
            window.location.href = 'index.php?m=inform&a=inform_subject_add';
        }
    }
</script> 
