...
<div class="page">
  ...
  <div class="ncap-stat-chart">
    <div class="title">
      <h3>价格销量分布图</h3>
      <h5><a href="index.php?m=stat_general&a=setting" class="ncap-btn">设置价格区间</a></h5>
    </div>
    <?php if ($output['pricerange_statjson']){ ?>
    <div id="container_pricerange" style="height:400px"></div>
    <?php } else { ?>
    <div class="no-date"><i class="fa fa-exclamation-triangle"></i>查看分布情况前，请先设置价格区间。<a href="index.php?m=stat_general&a=setting" class="ncap-btn ncap-btn-orange">马上设置</a></div>
    <?php }?>
  </div>
  ...
  <div class="ncap-search-bar">
    ...
    <form method="get" action="index.php" name="formSearch" id="formSearch">
      <input type="hidden" name="m" value="stat_goods" />
      <input type="hidden" name="a" value="pricerange" />
