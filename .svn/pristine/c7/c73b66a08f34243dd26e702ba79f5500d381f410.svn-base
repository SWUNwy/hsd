...
<div class="wrap">
  ...
  <form method="get" action="index.php">
    <input type="hidden" name="m" value="member_refund" />
  ...
  <table class="ncm-default-table order">
    ...
    <tbody>
      ...
      <tr class="bd-line" >
        ...
        <td class="bdr"><a href="index.php?m=m_refund&a=view&refund_id=<?php echo $val['refund_id']; ?>" class="ncbtn"><?php echo $lang['nc_view'];?> </a></td>
      </tr>
      <?php } ?>
    </tbody>
    <tfoot>
