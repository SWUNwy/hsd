...
<div class="btn-box">
  ...
  <span style="background-color: #F32613; color: #FFFFFF; cursor: pointer; padding: 5px 10px;" onclick="javascript:window.open('index.php?m=compare&gids=<?php echo $output['goodsid_str'];?>');">对比</span>
