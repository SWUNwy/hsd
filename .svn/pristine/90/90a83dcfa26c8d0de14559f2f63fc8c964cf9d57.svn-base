...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base nc-row">
        ...
        <li><a href="index.php?m=web_config&a=focus_edit"><?php echo '焦点区';?></a></li>
  ...
  <form id="sale_list_form" method="post" name="form1">
    ...
    <div class="ncap-form-default">
      ...
      <div class="bot"><a href="index.php?m=web_config&a=html_update&web_id=<?php echo $output['code_sale_list']['web_id'];?>" class="ncap-btn-big ncap-btn-green"><?php echo $lang['web_config_web_html'];?></a></div>
    </div>
  </form>
</div>
