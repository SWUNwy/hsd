...
<form method="get" action="index.php" target="_self">
  <table class="search-form">
    ...
    <input type="hidden" name="a" value="sale" />
    <tr>
    	<td class="tr">
    		<div class="fr">
...
$(function(){
	...
	$('#statlist').load('index.php?m=statistics_sale&a=salelist&t=<?php echo $output['searchtime'];?>&order_type=<?php echo $_REQUEST['order_type'];?>');
});
</script>