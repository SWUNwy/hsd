...
<div class="page">
  ...
  <div class="ncap-stat-chart">
    <div class="title">
      <h3>客单价分布图</h3>
      <h5><a href="index.php?m=stat_general&a=orderprange"  class="ncap-btn">设置价格区间</a></h5>
    </div>
    <?php if ($output['guestprice_statjson']){ ?>
    <div id="container_guestprice" style="height:400px"></div>
    <?php } else { ?>
    <div class="no-date">查看客单价分布情况前，请先设置价格区间。<a href="index.php?m=stat_general&a=orderprange" class="ncap-btn ncap-btn-orange">马上设置</a></div>
    <?php }?>
  </div>
