...
<div class="ncsc-form-default" nctype="normal" style=" display: none;">
  <form method="post" action="index.php?m=store_sns&a=store_sns_save" id="normal_form">
      ...
      <dd>
        ...
        <div class="handle">
          <div class="ncsc-upload-btn"> <a href="javascript:void(0);"><span>
            ...
            <a class="ncbtn mt5" nctype="get_img" href="index.php?m=store_album&a=pic_list&item=store_sns_normal"><i class="icon-picture"></i>从图片空间选择</a> <a href="javascript:void(0);" nctype="del_img" class="ncbtn ml5 mt5" style="display: none;"><i class="icon-circle-arrow-up"></i>关闭相册</a></div>
...
<div class="ncsc-form-default" nctype="recommend" style="display: none;">
  ...
  <form method="post" action="index.php?m=store_sns&a=store_sns_save" id="recommend_form">
...
<div class="ncsc-form-default" nctype="hotsell" style="display: none;" >
  <form method="post" action="index.php?m=store_sns&a=store_sns_save" id="hotsell_form">
...
<div class="ncsc-form-default" nctype="new" style="display: none;" >
  <form method="post" action="index.php?m=store_sns&a=store_sns_save" id="new_form">
...
$(function(){
	...
	$('#normal_file').unbind().live('change', function(){
		...
		(
			{
				url:'index.php?m=store_sns&a=image_upload',
				secureuri:false,
