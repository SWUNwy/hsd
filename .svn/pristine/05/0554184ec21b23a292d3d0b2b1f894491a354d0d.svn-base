...
<div class="wrap">
  ...
  <div class="ncm-friend-find"> 
    <!-- 搜索好友start -->
    <form method="post" id="search_form" action="index.php?m=m_snsfriend&a=findlist">
    ...
    <div>
      ...
      <ul class="ncm-friend-list">
        ...
        <li id="recordone_<?php echo $v['member_id']; ?>">
          <div class="avatar"><a href="<?php echo urlShop('m_snshome', 'index', array('mid' => $v['member_id']));?>" target="_blank"><img src="<?php echo getMemberAvatar($v['member_avatar']);?>" alt="<?php echo $v['member_name']; ?>" data-param="{'id':<?php echo $v['member_id'];?>}" nctype="mcard" /></a></div>
          <dl class="info">
            <dt><a href="<?php echo urlShop('m_snshome', 'index', array('mid' => $v['member_id']));?>" title="<?php echo $v['friend_tomname']; ?>" target="_blank" data-param="{'id':<?php echo $v['member_id'];?>}" nctype="mcard"><?php echo $v['member_name']; ?></a><i class="<?php echo $v['sex_class']; ?>"></i></dt>
            <dd class="area"><?php echo $v['member_areainfo'];?></dd>
            <dd><a href="<?php echo urlMember('m_message', 'index', array('member_id' => $v['member_id']));?>;" target="_blank"><i class="icon-envelope"></i><?php echo $lang['nc_message'] ;?></a></dd>
          </dl>
