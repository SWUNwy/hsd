...
<div class="ncm-flow-layout">
  ...
  <div class="ncm-flow-item">
    ...
    <div class="item-goods">
      ...
      <dl>
        <dt>
          <div class="ncm-goods-thumb-mini"><a href="index.php?m=goods&goods_id=<?php echo $val['goods_id']; ?>" target="_blank"><img src="<?php echo thumb($val,'60'); ?>" onMouseOver="toolTip('<img src=<?php echo thumb($val,'240'); ?>>')" onMouseOut="toolTip()"/></a></div>
        </dt>
        <dd><a href="index.php?m=goods&goods_id=<?php echo $val['goods_id']; ?>" target="_blank"><?php echo $val['goods_name']; ?></a> <span class="rmb-price"><?php echo ncPriceFormat($val['goods_price']); ?>&nbsp;*&nbsp;<?php echo $val['goods_num']; ?>
...
$(function(){
	...
	$.getJSON('index.php?m=m_order&a=get_express&e_code=<?php echo $output['e_code']?>&shipping_code=<?php echo $output['order_info']['shipping_code']?>&t=<?php echo random(7);?>',function(data){
		if(data){
