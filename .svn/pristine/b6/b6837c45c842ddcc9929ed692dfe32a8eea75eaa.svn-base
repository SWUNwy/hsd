...
<div class="groupbuy-gallery" nctype="store_sns_album"> <a class="sample_demo" id="select_s" href="index.php?m=store_album&a=pic_list&item=store_sns_normal" style="display:none;"><?php echo $lang['nc_submit'];?></a>
