...
<div class="page">
  ...
  <div class="ncap-search-bar">
    ...
    <form method="get" action="index.php" name="formSearch" id="formSearch">
      <input type="hidden" name="m" value="stat_marketing" />
...
function getLineLabels(stattype){
	...
	if(!$("#"+stattype+'_div').html()){
		$("#"+stattype+'_div').load('index.php?m=stat_marketing&a=promotiontrend&search_type='+search_type+'&stattype='+stattype+'&t=<?php echo $output['searchtime'];?>');
	}
}
</script>