...
<form method="get">
  <table class="search-form">
    <input type="hidden" name="m" value="store_promotion_mansong" />
...
<table class="ncsc-default-table">
  ...
  <tbody>
    ...
    <tr class="bd-line">
      ...
      <td class="nscs-table-handle"><span><a href="index.php?m=store_promotion_mansong&a=mansong_detail&mansong_id=<?php echo $val['mansong_id'];?>" class="btn-bluejeans"><i class="icon-th-list"></i>
