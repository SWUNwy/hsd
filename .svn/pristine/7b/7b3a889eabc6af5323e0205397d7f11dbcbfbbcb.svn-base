...
function add_to_cart()
{
	...
	if(checkresult == false){
		...
		$.getJSON('<?php echo SHOP_SITE_URL; ?>/index.php?m=pointcart&a=add&pgid=<?php echo $output['prodinfo']['pgoods_id']; ?>&quantity='+quantity, function(result){
	        if(result.done){
	        	window.location.href = '<?php echo SHOP_SITE_URL; ?>/index.php?m=pointcart';
	        } else {
		        if(result.url){
