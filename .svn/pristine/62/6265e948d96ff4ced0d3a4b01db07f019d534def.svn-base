...
function zsc_show(id){
	...
	if(zsc_class!='add'){
		...
		var url = "index.php?m=seller_wechat&a=addkeyword_ajax&kid="+zsc_id;
		//var url = "/biz.php?ctl=wechat&m=addkeyword_ajax&kid="+zsc_id;
...
function btnsave(num,count){
	...
	if(ktype==1){
		...
		if(count==0){
			//var url = "/biz.php?ctl=wechat&m=keyword_index&a=add";
			var url = "index.php?m=seller_wechat&a=keyword_index&opt=add";
			...
			//var url = "/biz.php?ctl=wechat&m=keyword_index&a=update";
			var url = "index.php?m=seller_wechat&a=keyword_index&opt=update";
			var kid = $('#zsc_iid').val();
...
function zscdel(num){
	...
	var url = "index.php?m=seller_wechat&a=keyword_index&opt=del";
	//var url = "/biz.php?ctl=wechat&m=keyword_index&a=del";
	...
	$("input[name='"+file_id+"']").bind("change",function(){			
		...
		$(obj).parent().find(".fileuploading").addClass("show");
		  $.ajaxFileUpload
		   (
			   {
				    //url:APP_ROOT+'/index.php?ctl=avatar&m=upload&uid='+uid,
					url:"index.php?m=seller_wechat&a=upload_fm",
					//url:APP_ROOT+'/biz.php?ctl=wechat&m=upload_fm',
				    secureuri:false,
