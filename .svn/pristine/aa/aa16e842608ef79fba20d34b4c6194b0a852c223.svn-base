  ...
  <li nc_type="stracerow_<?php echo $output['strace_info']['strace_id']; ?>">
  	<div class="fd-aside">
		<span class="thumb size60"><i></i>
			<a href="index.php?m=store_snshome&sid=<?php echo $output['strace_info']['strace_storeid'];?>" target="_blank">
    ...
    <dl class="fd-wrap">
      <dt>
        <h3><a href="index.php?m=store_snshome&sid=<?php echo $output['strace_info']['strace_storeid'];?>" target="_blank"><?php echo $output['strace_info']['strace_storename'];?></a><?php echo $lang['nc_colon'];?></h3>
		...
		<div id="forward_<?php echo $output['strace_info']['strace_id'];?>" style="display:none;">
			<div class="forward-widget">
				<div class="forward-edit">
					<form id="forwardform_<?php echo $output['strace_info']['strace_id'];?>" method="post" action="index.php?m=store_snshome&a=addforward">
...
$(function(){
    $("#tracereply_<?php echo $output['strace_info']['strace_id'];?>").load('index.php?m=store_snshome&a=commentlist&id=<?php echo $output['strace_info']['strace_id'];?>').show();
    $('.demo').ajaxContent({
