...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?m=brand&a=brand" title="返回品牌列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
...
$(function(){
  ...
  function ajaxFileUpload()
  {
    ...
    (
      {
        url : '<?php echo ADMIN_SITE_URL?>/index.php?m=common&a=pic_upload&form_submit=ok&uploadpath=<?php echo ATTACH_BRAND;?>',
        secureuri:false,
        fileElementId:'_pic',
        dataType: 'json',
        ...
        {
          if (data.status == 1){
            ajax_form('cutpic','<?php echo $lang['nc_cut'];?>','<?php echo ADMIN_SITE_URL?>/index.php?m=common&a=pic_cut&type=brand&x=150&y=50&resize=1&ratio=3&url='+data.url,690);
          }else{
            alert(data.msg);
      ...
      var error_td = element.parent('dd').children('span.err');
        ...
        rules : {
            brand_name : {
                required : true,
                remote   : {
                    url :'index.php?m=brand&a=ajax&branch=check_brand_name',
                    type:'get',
                    data:{
                        brand_name : function(){
