...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?m=rec_position&a=rec_list" title="返回列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
  ...
  <form id="rec_form" enctype="multipart/form-data" method="post" action="index.php?m=rec_position&a=rec_edit_save">
