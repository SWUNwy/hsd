...
<div class="comment-widget">
  <div class="comment-edit">
    <form id="commentform_<?php echo $output['stid'];?>" method="post" action="index.php?m=store_snshome&a=addcomment">
  ...
  <ul class="comment-list">
    ...
    <li nc_type="commentrow_<?php echo $v['scomm_id']; ?>"> <a target="_blank" href="index.php?m=m_snshome&mid=<?php echo $v['scomm_memberid'];?>"><img width="30" height="30" class="clogo" src="<?php if ($v['scomm_memberavatar']!='') { echo UPLOAD_SITE_URL.'/'.ATTACH_AVATAR.DS.$v['scomm_memberavatar']; } else {  echo UPLOAD_SITE_URL.'/'.ATTACH_COMMON.DS.C('default_user_portrait'); } ?>" onload="javascript:DrawImage(this,30,30);"></a>
      <div class="detail">
        <p class="words"><a target="_blank" href="index.php?m=m_snshome&mid=<?php echo $v['scomm_memberid'];?>" class="name"><?php echo $v['scomm_membername'];?></a><?php echo $lang['nc_colon']; ?><?php echo parsesmiles($v['scomm_content']);?></p>
        <p class="other">
  ...
  <div class="more"><a target="_blank" href="index.php?m=store_snshome&a=straceinfo&st_id=<?php echo $output['stid'];?>"><?php echo $lang['sns_comment_more'];?></a></div>
