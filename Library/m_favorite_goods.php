...
class m_favorite_goodsControl extends BaseMemberControl{
        ...
        if (!empty($fav_arr) && is_array($fav_arr)){
            ...
            if (!empty($favorites_list) && is_array($favorites_list)){
                ...
                if (!empty($fav_arr) && $result){
                    ...
                    showDialog(Language::get('favorite_del_success'),'index.php?m=m_favorite_goods&a=fglist&show='.$_GET['show'],'succ');
                }
            }else {
    ...
    private function profile_menu($menu_type,$menu_key='') {
        $menu_array = array(
            array('menu_key'=>'fav_goods','menu_name'=>Language::get('nc_member_path_collect_list'), 'menu_url'=>'index.php?m=m_favorite_goods&a=fglist'),
            array('menu_key'=>'fav_goodsstore','menu_name'=>'同店商品', 'menu_url'=>'index.php?m=m_favorite_goods&a=fglist&show=store'),
        );
