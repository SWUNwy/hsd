...
class statistics_flowControl extends BaseSellerControl{
    ...
    private function profile_menu($menu_key='') {
        $menu_array = array(
            1=>array('menu_key'=>'storeflow','menu_name'=>'店铺总流量','menu_url'=>'index.php?m=statistics_flow&a=storeflow'),
            2=>array('menu_key'=>'goodsflow','menu_name'=>'商品流量排名','menu_url'=>'index.php?m=statistics_flow&a=goodsflow')
        );
