...
class store_snsControl extends BaseSellerControl{
    ...
    public function store_sns_saveOp(){
        ...
        if($rs){
            showDialog(Language::get('nc_common_op_succ'), 'index.php?m=store_sns', 'succ');
        }else{
    ...
    private function profile_menu($menu_key) {
        $menu_array = array(
                1=>array('menu_key'=>'store_sns_add', 'menu_name'=>Language::get('store_sns_add'), 'menu_url'=>'index.php?m=store_sns&a=add'),
                2=>array('menu_key'=>'store_sns_setting', 'menu_name'=>Language::get('store_sns_setting'), 'menu_url'=>'index.php?m=store_sns&a=setting'),
