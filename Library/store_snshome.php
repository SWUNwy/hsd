...
//      //查询会员信息
        ...
        if ($result){
            ...
            if ($_POST['showtype'] == 1){
                $js .="$('#tracereply_".$stid."').load('index.php?m=store_snshome&a=commenttop&id=".$stid."');";
            }else {
                $js .="$('#tracereply_".$stid."').load('index.php?m=store_snshome&a=commentlist&id=".$stid."');";
            }
    ...
    public function addforwardOp(){
        ...
        $insert_arr['trace_content']            = "<dl class=\"fd-wrap\">
                                                        <dt>
                                                            <h3><a href=\"index.php?m=store_snshome&sid=".$stracelog_info['strace_storeid']."\" target=\"_blank\">".$stracelog_info['strace_storename']."</a>".Language::get('nc_colon')."
    ...
    private function checkLoginStatus(){
        if ($_SESSION['is_login'] != 1){
            @header("location: ". urlLogin('login', 'index', array('ref_url' => urlShop('m_snsnome'))));
        }
