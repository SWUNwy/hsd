...
class store_settingControl extends BaseSellerControl {
    ...
    public function store_settingOp(){
        ...
        if (chksubmit()){
            ...
            $model_class->editStore($param, array('store_id' => $store_id));
            showDialog(Language::get('nc_common_save_succ'),'index.php?m=store_setting&a=store_setting','succ');
        }
        /**
         * 实例化店铺等级模型
         */
    ...
    public function store_slideOp() {
        ...
        if ($_POST['form_submit'] == 'ok'){
            ...
            showDialog(Language::get('nc_common_save_succ'),'index.php?m=store_setting&a=store_slide','succ');
        }
    ...
    public function store_mobileOp()
    {
        ...
        if (chksubmit()) {
            ...
            showDialog('保存成功', 'index.php?m=store_setting&a=store_mobile', 'succ');
        }
    ...
    private function profile_menu($menu_key='') {
        ...
        $menu_array = array(
            1=>array('menu_key'=>'store_setting','menu_name'=>Language::get('nc_member_path_store_config'),'menu_url'=>'index.php?m=store_setting&a=store_setting'),
            4=>array('menu_key'=>'store_slide','menu_name'=>Language::get('nc_member_path_store_slide'),'menu_url'=>'index.php?m=store_setting&a=store_slide'),
            5=>array('menu_key'=>'store_theme','menu_name'=>'店铺主题','menu_url'=>'index.php?m=store_setting&a=theme'),

            7 => array(
                'menu_key' => 'store_mobile',
                'menu_name' => '手机店铺设置',
                'menu_url' => 'index.php?m=store_setting&a=store_mobile',
            ),
        );
