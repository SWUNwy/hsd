...
<div class="wrap">
  ...
  <div class="ncm-friend-find"> 
    <!-- 搜索好友start -->
    <form id="search_form" method="post" action="index.php?m=m_snsfriend&a=findlist">
        ...
        <dd>
          ...
          <div class="content" nctype="content<?php echo $val['mtag_id'];?>">
            ...
            <div class="friends">
              ...
              <?php }else{?>
              <?php echo $lang['snsfriend_null_members_tips1']?><a href="<?php echo urlMember('m_information', 'more');?>"><?php echo $lang['snsfriend_null_members_tips2'];?></a>
              <?php }?>
            </div>
          </div>
        </dd>
