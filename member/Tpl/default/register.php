            ...
            <div id="default" class="tabs-content">
			  ...
			  <input type="hidden" id="rec_id" name="rec_id" class="text" value="<?php echo $_GET['rec'];?>"/>
                ...
                <div class="code-div mt15">
                  ...
                  <span><img src="index.php?m=seccode&a=makecode&type=50,120&nchash=<?php echo getNchash();?>" name="codeimage" id="codeimage"/> <a class="makecode" href="javascript:void(0)" onclick="javascript:document.getElementById('codeimage').src='index.php?m=seccode&a=makecode&type=50,120&nchash=<?php echo getNchash();?>&t=' + Math.random();"><?php echo $lang['login_password_change_code']; ?></a></span></div>
                <?php } ?>
                <dl class="clause-div">
                  <dd>
    ...
    $("#register_form").validate({
        ...
        rules : {
            user_name : {
                ...
                letters_name : true,
                remote   : {
                    url :'index.php?m=login&a=check_member&column=ok',
                    type:'get',
                    data:{
                        user_name : function(){
            ...
            email : {
                ...
                email    : true,
                remote   : {
                    url : 'index.php?m=login&a=check_email',
                    type: 'get',
                    data:{
                        email : function(){
                            return $('#email').val();
