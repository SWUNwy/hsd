...
<div class="nc-login-layout">
  ...
  <div class="arrow"></div>
        ...
        <div id="default" class="tabs-content">
          <form id="login_form" class="nc-login-form" method="post" action="<?php echo urlLogin('login', 'login');?>">
            ...
            <div class="code-div mt15">
              ...
              <span><img src="index.php?m=seccode&a=makecode&type=50,120&nchash=<?php echo getNchash();?>" name="codeimage" id="codeimage"> <a class="makecode" href="javascript:void(0)" onclick="javascript:document.getElementById('codeimage').src='index.php?m=seccode&a=makecode&type=50,120&nchash=<?php echo getNchash();?>&t=' + Math.random();"><?php echo $lang['login_index_change_checkcode'];?></a></span></div>
            <?php } ?>
            ...
            <a class="forget" href="<?php echo urlLogin('login', 'forget_password');?>"><?php echo $lang['login_index_forget_password'];?></a>
            <a class="forget" href="<?php echo urlLogin('login', 'register');?>">用户注册&nbsp;&nbsp;</a>&nbsp;&nbsp;
            </div>
        ...
        <div id="mobile" class="tabs-content">
          <form id="post_form" method="post" class="nc-login-form" action="<?php echo urlLogin('connect_sms', 'login');?>">
            ...
            <div class="code-div">
              ...
              <span><img src="index.php?m=seccode&a=makecode&type=50,120&nchash=<?php echo getNchash();?>" title="<?php echo $lang['login_index_change_checkcode'];?>" name="codeimage" id="sms_codeimage"> <a class="makecode" href="javascript:void(0);" onclick="javascript:document.getElementById('sms_codeimage').src='index.php?m=seccode&a=makecode&type=50,120&nchash=<?php echo getNchash();?>&t=' + Math.random();"><?php echo $lang['login_password_change_code']; ?></a></span> </div>
    ...
    <div class="nc-login-api" id="demo-form-site">
      ...
      <?php if (C('qq_isuse') == 1){?>
      <a href="<?php echo MEMBER_SITE_URL;?>/api.php?m=toqq" title="QQ账号登录" class="qq"><i></i>QQ</a>
      <?php } ?>
      <?php if (C('sina_isuse') == 1){?>
      <a href="<?php echo MEMBER_SITE_URL;?>/api.php?m=tosina" title="新浪微博账号登录" class="sina"><i></i>新浪微博</a>
      <?php } ?>
	...
	$("#login_form").validate({
		...
		rules: {
            ...
            ,captcha : {
                required : true,
                remote   : {
                    url : 'index.php?m=seccode&a=check&nchash=<?php echo getNchash();?>',
                    type: 'get',
                    data:{
                        captcha : function(){
                            return $('#captcha').val();
                    ...
                    complete: function(data) {
                        if(data.responseText == 'false') {
                        	document.getElementById('codeimage').src='index.php?m=seccode&a=makecode&type=50,120&nchash=<?php echo getNchash();?>&t=' + Math.random();
                        }
                    }
                }
            }
		...
		rules: {
			...
			captcha : {
                ...
                remote   : {
                    ...
                    complete: function(data) {
                        if(data.responseText == 'false') {
                        	document.getElementById('sms_codeimage').src='index.php?m=seccode&a=makecode&type=50,120&nchash=<?php echo getNchash();?>&t=' + Math.random();
                        }
                    }
                }
            },
