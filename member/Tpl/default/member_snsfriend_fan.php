...
<div class="wrap">
  ...
  <ul class="ncm-friend-list">
    ...
    <li id="recordone_<?php echo $v['friend_frommid']; ?>">
      <div class="avatar"><a href="<?php echo urlShop('m_snshome', 'index', array('mid' => $v['friend_frommid']));?>" target="_blank" data-param="{'id':<?php echo $v['friend_frommid'];?>}" nctype="mcard"><img src="<?php echo getMemberAvatar($v['member_avatar']);?>" alt="<?php echo $v['friend_frommname']; ?>"/></a></div>
      <dl class="info">
        <dt><a href="<?php echo urlShop('m_snshome', 'index', array('mid' => $v['friend_frommid']));?>" title="<?php echo $v['friend_tomname']; ?>" target="_blank" data-param="{'id':<?php echo $v['friend_frommid'];?>}" nctype="mcard"><?php echo $v['friend_frommname']; ?></a><i class="<?php echo $v['sex_class'];?>"></i></dt>
        <dd class="area"><?php echo $v['member_areainfo'];?></dd>
        <dd><a href="<?php echo urlMember('m_message', 'index', array('member_id' => $v['friend_frommid']));?>" target="_blank" title="<?php echo $lang['nc_message'] ;?>"><i class="icon-envelope"></i><?php echo $lang['nc_message'] ;?></a></dd>
      </dl>
