...
<div class="wrap">
  <div class="tabmenu">
    ...
    <a class="ncbtn ncbtn-mint" href="index.php?m=m_security&a=auth&type=pd_cash"><i class="icon-money"></i>申请提现</a>
  </div>
  ...
  <table class="ncm-default-table">
    ...
    <tbody>
      ...
      <tr class="bd-line">
        ...
        <td><p><a href="index.php?m=predeposit&a=pd_cash_info&id=<?php echo $val['pdc_id']; ?>"><?php echo $lang['nc_view']; ?></a></p></td>
      </tr>
      <?php } ?>
      <?php } else {?>
      <tr>
