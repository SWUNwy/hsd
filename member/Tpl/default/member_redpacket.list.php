...
<div class="wrap">
  ...
  <form id="rp_list_form" method="get">
    <table class="ncm-search-table">
      <input type="hidden" id='m' name='m' value='member_redpacket' />
      ...
      <tr class="bd-line">
        ...
        <td class="<?php echo $val['rpacket_state_key'] == 'unused' ? 'ncm-table-handle' : null?>">
            ...
            <?php } elseif ($val['rpacket_state_key'] == 'used'){?>
                <span><a target="_blank" href="<?php echo urlShop('m_order','index',array('pay_sn'=>$val['rpacket_order_id']));?>"><p>查看订单</p></a></span>
            <?php } ?>
        </td>
      </tr>
      <?php }?>
