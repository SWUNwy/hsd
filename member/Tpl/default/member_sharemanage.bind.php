...
$(function(){
	...
	$("[nc_type='unbindbtn']").bind('click',function(){
	    ...
	    ajax_get_confirm(confirm_tip,'<?php echo MEMBER_SITE_URL;?>/index.php?m=m_sharemanage&a=unbind&type='+data_str.apikey);
	});
