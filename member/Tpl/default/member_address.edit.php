...
<div class="eject_con">
  <div class="adds">
    <div id="warning"></div>
    <form method="post" action="<?php echo MEMBER_SITE_URL;?>/index.php?m=m_address&a=address" id="address_form" target="_parent">
...
$(document).ready(function(){
    ...
    $('#zt').on('click',function(){
    	...
    	ajax_form('daisou','使用代收货（自提）', '<?php echo MEMBER_SITE_URL;?>/index.php?m=m_address&a=delivery_add', '900',0);
    });
});
