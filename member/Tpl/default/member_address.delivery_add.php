...
<div class="eject_con">
  <div class="adds">
    ...
    <div id="warning"></div>
    <form method="post" action="<?php echo MEMBER_SITE_URL;?>/index.php?m=m_address&a=delivery_add" id="address_form" target="_parent">
...
$(document).ready(function(){
	var _fuc_area = function(area_id){
		$('#zt_address').load("index.php?m=m_address&a=delivery_list&dlyp_id=<?php echo $output['address_info']['dlyp_id'];?>&area_id="+area_id);
	}
    ...
    $('#zt_address').load("index.php?m=m_address&a=delivery_list&dlyp_id=<?php echo $output['address_info']['dlyp_id'];?>&area_id=<?php echo $output['address_info']['area_id']?>");
    <?php } ?>
});
