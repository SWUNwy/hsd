            ...
            <dl>
              ...
              <dd>
                ...
                <label></label>
                        ...
                        <dl>
              <dt><strong>验证码</strong><a href="javascript:void(0)" class="ml5" onclick="javascript:document.getElementById('codeimage').src='index.php?m=seccode&amp;a=makecode&amp;nchash=<?php echo getNchash('login','index');?>&amp;t=' + Math.random();">更换验证码</a></dt>
              <dd>
      ...
      <h4><?php echo $lang['nc_otherlogintip'];?></h4>
               <?php if (C('weixin_isuse') == 1){?>
							...
							<?php if (C('sina_isuse') == 1){?>
                                          <a href="<?php echo MEMBER_SITE_URL;?>/api.php?m=tosina" title="新浪微博账号登录" class="mr20">新浪微博</a><?php } ?>
                                          <?php if (C('qq_isuse') == 1){?><a href="<?php echo MEMBER_SITE_URL;?>/api.php?m=toqq" title="QQ账号登录" class="mr20">QQ账号</a><?php } ?><?php } ?>
                          </div>
          </form>
        </div>
        <?php }?>
...
backTop=function (btnId){
	...
	btn.onclick=function (){
		...
		this.timer=setInterval(function(){
			...
			if(scrollTa==0) clearInterval(btn.timer,window.onscroll=set);
			if (document.documentElement.scrollTop > 0) document.documentElement.scrollTa=scrollTop;
			if (document.body.scrollTop > 0) document.body.scrollTa=scrollTop;
		},10);
	};
	function set(){
	    scrollTop = document.documentElement.scrollTop || document.body.scrollTop;
...
$(function() {
    ...
    $('div[nctype="a-barLoginBox"]').click(function(){
        ...
        document.getElementById('codeimage').src='index.php?m=seccode&a=makecode&nchash=<?php echo getNchash('login','index');?>&t=' + Math.random();
    });
...
<div class="public-top-layout w">
  <div class="topbar wrapper">
    <div class="user-entry">
      ...
      <?php } ?> <span>[<a href="<?php echo urlLogin('login');?>"><?php echo $lang['nc_login'];?></a>]</span> <span>[<a href="<?php echo urlLogin('login','register');?>"><?php echo $lang['nc_register'];?></a>]</span>
      <?php }?>
    </div>
