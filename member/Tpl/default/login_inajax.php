  ...
  <form id="login_form" action="<?php echo urlLogin('login');?>" method="post" class="bg" >
    ...
    <dl>
      ...
      <dd>
        ...
        <img class="fl ml10" src="index.php?m=seccode&a=makecode&nchash=<?php echo getNchash();?>" title="<?php echo $lang['login_index_change_checkcode'];?>" name="codeimage" border="0" id="codeimage" onclick="this.src='index.php?m=seccode&a=makecode&nchash=<?php echo getNchash();?>&t=' + Math.random()"><span></span></dd>
    </dl>
    <?php } ?>
    <ul>
    ...
    <div class="enter">
      ...
      <a href="<?php echo MEMBER_SITE_URL;?>/api.php?m=tosina" title="<?php echo $lang['nc_otherlogintip_sina']; ?>" class="sina"><i></i>Weibo</a>
      <?php } ?>
      </span>
      <?php } ?>
    </div>
