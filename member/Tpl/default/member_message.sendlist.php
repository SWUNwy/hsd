...
<div class="wrap">
  <div class="tabmenu">
    ...
    <a href="index.php?m=m_message&a=sendmsg" title="<?php echo $lang['home_message_send_message'];?>" class="ncbtn ncbtn-bittersweet"><i class="icon-envelope-alt"></i><?php echo $lang['home_message_send_message'];?></a>
    <?php }?>
  </div>
    ...
    <thead>
      ...
      <tr>
        <td colspan="20"><input type="checkbox" id="all" class="checkall"/>
          ...
          <a href="javascript:void(0)" class="ncbtn-mini" uri="index.php?m=m_message&a=dropcommonmsg&drop_type=<?php echo $output['drop_type']; ?>" name="message_id" confirm="<?php echo $lang['home_message_delete_confirm'];?>?" nc_type="batchbutton"><i class="icon-trash"></i><?php echo $lang['home_message_delete'];?></a></td>
      </tr>
      <?php } ?>
    </thead>
    <tbody>
      ...
      <tr class="bd-line">
        ...
        <td class="ncm-table-handle"><span><a href="javascript:void(0)" onclick="ajax_get_confirm('<?php echo $lang['home_message_delete_confirm'];?>?', '<?php echo MEMBER_SITE_URL;?>/index.php?m=m_message&a=dropcommonmsg&drop_type=<?php echo $output['drop_type']; ?>&message_id=<?php echo $v['message_id']; ?>');" class="btn-grapefruit"><i class="icon-trash"></i>
