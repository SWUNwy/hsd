...
<div class="wrap">
  <div class="tabmenu">
    ...
    <div class="ncm-default-form">
      <form method="post" id="profile_form" action="<?php echo MEMBER_SITE_URL;?>/index.php?m=m_information&a=member">
        ...
        <dl>
          ...
          <dd><span class="w400"><?php echo $output['member_info']['member_email']; ?>&nbsp;&nbsp;
            <a href="index.php?m=m_security&a=auth&type=modify_email">
