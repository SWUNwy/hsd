...
<div class="wrap">
  ...
  <div class="ncm-default-form">
    <form method="post" id="mobile_form" action="<?php echo MEMBER_SITE_URL;?>/index.php?m=m_security&a=modify_mobile">
...
$(function(){
	...
	$('#send_auth_code').on('click',function(){
		...
		ALLOW_SEND = !ALLOW_SEND;
		$('#sending').show();
		$.getJSON('index.php?m=m_security&a=send_modify_mobile',{mobile:$('#mobile').val()},function(data){
			if (data.state == 'true') {
				$('#sending').hide();
