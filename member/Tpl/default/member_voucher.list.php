...
<div class="wrap">
  ...
  <form id="voucher_list_form" method="get">
    <table class="ncm-search-table">
      <input type="hidden" id='m' name='m' value='member_voucher' />
  ...
  <table class="ncm-default-table">
    ...
    <tbody>
      ...
      <tr class="bd-line">
        ...
        <td class=""><span><a href="<?php echo urlShop('m_order', 'show_order', array('order_id' => $val['voucher_order_id']))?>"><p><?php echo $lang['voucher_voucher_vieworder'];?></p></a><span></td>
        <?php }?>
      </tr>
      <?php }?>
      <?php } else { ?>
