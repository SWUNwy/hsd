...
class m_informationControl extends BaseMemberControl {
    /**
     * 用户中心
     *
     * @param
    ...
    public function memberOp() {
        ...
        Tpl::output('menu_sign_url','index.php?m=m_information&a=member');
...
public function uploadOp() {
		if (!chksubmit()){
			redirect('index.php?m=m_information&a=avatar');
		}
    ...
    private function profile_menu($menu_type,$menu_key='') {
        ...
        switch ($menu_type) {
            case 'member':
                $menu_array = array(
                1=>array('menu_key'=>'member',  'menu_name'=>Language::get('home_member_base_infomation'),'menu_url'=>'index.php?m=m_information&a=member'),
                2=>array('menu_key'=>'more',    'menu_name'=>Language::get('home_member_more'),'menu_url'=>'index.php?m=m_information&a=more'),
                5=>array('menu_key'=>'avatar',  'menu_name'=>Language::get('home_member_modify_avatar'),'menu_url'=>'index.php?m=m_information&a=avatar'));
                break;
        }
