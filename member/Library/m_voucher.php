...
class m_voucherControl extends BaseMemberControl
{
    ...
    public function voucher_bindingOp()
    {
        if (chksubmit(false, true)) {
            ...
            if ($result) {
                ...
                showDialog('代金券领取成功', 'index.php?m=m_voucher&a=voucher_list', 'succ');
            } else {
                showDialog('代金券领取失败');
            }
        }
    ...
    private function profile_menu($menu_key = '')
    {
        $menu_array = array(
            1 => array(
                ...
                'menu_url' => 'index.php?m=m_voucher&a=voucher_list'
            ),
            2 => array(
                'menu_key' => 'voucher_binding',
                'menu_name' => '领取代金券',
                'menu_url' => 'index.php?m=m_voucher&a=voucher_binding'
            )
        );
