...
$(function(){
	...
	function ajaxFileUpload()
	{
		...
		(
			{
				url:'<?php echo ADMIN_SITE_URL?>/index.php?m=common&a=pic_upload&type=admin_avatar&form_submit=ok&uploadpath=<?php echo ATTACH_ADMIN_AVATAR;?>',
				secureuri:false,
				fileElementId:'_pic',
				dataType: 'json',
				...
				{
					if (data.status == 1){
						ajax_form('cutpic','<?php echo $lang['nc_cut'];?>','<?php echo ADMIN_SITE_URL?>/index.php?m=common&a=pic_cut&type=admin_avatar&x=100&y=100&resize=1&ratio=1&url='+data.url,690);
					}else{
						alert(data.msg);
					}
...
function call_back(picname){
    $.getJSON('index.php?m=index&a=save_avatar&avatar=' + picname, function(data){
        if (data) {
...
<div class="admincp-header">
  ...
  <div class="admincp-header-r">
    ...
    <ul class="operate nc-row">
      ...
      <li><a class="login-out show-option" href="index.php?m=index&a=logout" title="安全退出管理中心">&nbsp;</a></li>
    </ul>
  </div>
  <div class="clear"></div>
</div>
<div class="admincp-container unfold">
  <div class="admincp-container-left">
    ...
    <div class="about" title="关于系统" onClick="javascript', 640);"><i class="fa fa-copyright"></i><span>55higou.com</span></div>
  </div>
