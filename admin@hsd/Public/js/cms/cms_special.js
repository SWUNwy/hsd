$(document).ready(function(){
    ...
    $("#picture_image_upload").fileupload({
        dataType: 'json',
            url: "index.php?m=cms_special&a=special_image_upload",
            add: function(e,data) {
    ...
    $("[nctype='btn_drop_special_image']").live("click",function(){
        ...
        $.getJSON("index.php?m=cms_special&a=special_image_drop", { image_name: image_name }, function(result){
                if(result.status == "success") {
                    image_object.remove();
                } else {
    ...
    $("[nctype='btn_special_goods']").live('click', function(){
        ...
        $.getJSON("index.php?m=cms_special&a=goods_info_by_url", { url: url}, function(data){
            if(data.result == "true") {
