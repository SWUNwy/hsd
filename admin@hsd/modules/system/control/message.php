 ...
 *
 *
 * 本系统由网店运维 XS版 www. shop wwi .com提供
 */
...
class messageControl extends SystemControl{
    private $links = array(
        array('url'=>'m=message&a=email','lang'=>'email_set'),
        array('url'=>'m=message&a=email_tpl','lang'=>'email_tpl')
    );
        ...
        if (chksubmit()){
            ...
            if ($error != ''){
                ...
                if ($result === true){
                    ...
                    showMessage(L('mailtemplates_edit_succ'),'index.php?m=message&a=email_tpl');
                }else {
