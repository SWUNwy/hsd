...
class storeControl extends SystemControl{
    ...
    private $_links = array(
        array('url'=>'m=store&a=store','text'=>'店铺管理'),
        array('url'=>'m=store&a=distribution_list','text'=>'分销申请')
    );
    ...
    public function get_xmlOp() {
        ...
        foreach ($store_list as $value) {
            ...
            $operation = "<a class='btn green' href='index.php?m=store&a=store_joinin_detail&member_id=".$value['member_id']."'><i class='fa fa-list-alt'></i>查看</a><span class='btn'><em><i class='fa fa-cog'></i>" . L('nc_set') . " <i class='arrow'></i></em><ul><li><a href='index.php?m=store&a=store_edit&store_id=" . $value['store_id'] . "'>编辑店铺信息</a></li><li><a href='index.php?m=store&a=del&store_id=" . $value['store_id'] . "'>删除该店铺</a></li><li><a href='index.php?m=store&a=store_bind_class&store_id=" . $value['store_id'] . "'>修改经营类目</a></li>";
