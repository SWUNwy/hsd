...
function copyToClipBoard(id){
    ...
    {
        ajax_form('copy_rec', '<?php echo $lang['rec_ps_code'];?>', 'index.php?m=rec_position&a=rec_code&rec_id='+id);
    }
}
$(function(){
    $("#flexigrid").flexigrid({
        url: 'index.php?m=rec_position&a=get_xml',
        colModel : [
...
function fg_operation(name, bDiv) {
    if (name == 'add') {
        window.location.href = 'index.php?m=rec_position&a=rec_add';
    }else if (name == 'delete') { 
...
function fg_delete(id) {
	...
	$.ajax({
        type: "GET",
        dataType: "json",
        url: 'index.php?m=rec_position&a=rec_del',
        data: "rec_id="+id,
