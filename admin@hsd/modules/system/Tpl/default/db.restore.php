...
<div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base nc-row"><li><a href="index.php?m=db&a=db"><span><?php echo $lang['db_index_backup'];?></span></a></li><li><a href="JavaScript:void(0);" class="current"><span><?php echo $lang['db_index_restore'];?></span></a></li></ul> </div>
  </div>
     ...
     <table class="flex-table">
      <thead>
        ...
        <span class="btn"><em><i class="fa fa-cog"></i>设置<i class="arrow"></i></em>
            <ul><li><a href="javascript:if(confirm('<?php echo $lang['nc_ensure_del'];?>')){location.href='index.php?m=db&a=db_del&dir_name=<?php echo $v['name'];?>'};"><?php echo $lang['nc_del'];?></a></li>
              <li><a href="javascript:if(confirm('<?php echo $lang['db_index_backup_tip'];?>?')){location.href='index.php?m=db&a=db_import&dir_name=<?php echo $v['name'];?>&step=1'};"><?php echo $lang['db_restore_import'];?></a></li>
...
function fg_operation(name, bDiv) {
    if (name == 'add') {
        window.location.href = 'index.php?m=db&a=db';
    }
