    ...
    <table class="flex-table">
      ...
      <tbody>
        ...
        <tr class="hover">
          ...
          <td class="handle">
          <a class="btn red" href="index.php?m=shopwwi&a=rc_del&id=<?php echo $k;?>" onclick="if(confirm('删除后将不能恢复，确认删除这  1 项吗？')){return true;} else {return false;}"><i class="fa fa-trash-o"></i>删除</a>
          <a class="btn blue" mff="sqde" href="index.php?m=shopwwi&a=rc_edit&id=<?php echo $k; ?>"><i class="fa fa-pencil-square-o"></i>编辑</a>
          </td>
...
function fg_operation(name, grid) {
    if (name == 'add') {
        window.location.href = 'index.php?m=shopwwi&a=rc_add';
    }
}
</script>