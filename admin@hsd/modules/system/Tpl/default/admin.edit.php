...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?m=admin&a=admin" title="返回列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
  ...
  <form id="admin_form" method="post" action='index.php?m=admin&a=admin_edit&admin_id=<?php echo $output['admininfo']['admin_id'];?>'>
