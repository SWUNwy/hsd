    ...
    <table class="flex-table">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="handle-s"><a class="btn blue" href="index.php?m=message&a=email_tpl_edit&code=<?php echo $v['code']; ?>"><i class="fa fa-pencil-square-o"></i><?php echo $lang['nc_edit'];?></a></td>
...
function go(){
	var url="index.php?m=message&a=email_tpl_ajax";
