...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?m=adv" title="返回列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
...
$(function(){
    $("#flexigrid").flexigrid({
        url: 'index.php?m=adv&a=get_adv_xml&ap_id=<?php echo $_GET['ap_id'];?>',
        colModel : [
...
function fg_delete(id){
	...
	$.ajax({
        type: "GET",
        dataType: "json",
        url: "index.php?m=adv&a=adv_delete",
...
function fg_operation(name, bDiv) {
    if (name == 'add') {
        window.location.href = 'index.php?m=adv&a=adv_add&ap_id=<?php echo $_GET['ap_id'];?>';
    }else if (name == 'delete') { 
