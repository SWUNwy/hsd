    ...
    <div class="ncap-form-default">
      <dl class="row">
        ...
        <dd class="opt">
          ...
          <p class="notic"><a href="JavaScript:void(0);" onclick="javascript:if(confirm('<?php echo $lang['user_info_clear'];?>'))window.location ='index.php?m=account&a=member_clear';" class="btns tooltip" title="<?php echo $lang['click_clear'];?>"><span><?php echo $lang['click_clear'];?></span></a> &nbsp;<?php echo $lang['first_integration'];?>&nbsp; <a href="JavaScript:void(0);" onclick="javascript:window.location ='index.php?m=db&a=db';" class="btns tooltip" title="<?php echo $lang['click_bak'];?>"><span><?php echo $lang['click_bak'];?></span></a><br/><a href="http://www.kjyp360.com/thread-677-1-1.html" target="_blank"><?php echo $lang['ucenter_help_url']; ?></a></p>
        </dd>
      </dl>
      <dl class="row">
        <dt class="tit">
