...
Tpl::showpage('mb_category.list');
    ...
    public function mb_category_delOp(){
        ...
        if (intval($_GET['gc_id']) > 0){
            ...
            showMessage($lang['link_index_del_succ'],'index.php?m=mb_category&a=mb_category_list');
        }else {
            showMessage($lang['link_index_choose_del'],'index.php?m=mb_category&a=mb_category_list');
        }
    }
    ...
    public function mb_category_addOp(){
        ...
        if ($_POST['form_submit'] == 'ok'){
            ...
            if ($result){
                $url = array(
                    array(
                        'url'=>'index.php?m=mb_category&a=mb_category_add',
                        'msg'=>$lang['link_add_again'],
                    ),
                    array(
                        'url'=>'index.php?m=mb_category&a=mb_category_list',
    ...
    public function mb_category_editOp(){
        ...
        if ($_POST['form_submit'] == 'ok'){
            ...
            if ($result){
                ...
                $url = array(
                    array(
                        'url'=>'index.php?m=mb_category&a=mb_category_edit&gc_id='.intval($_POST['gc_id']),
