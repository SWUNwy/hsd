    ...
    <table class="flex-table">
      ...
      <tbody>
        ...
        <tr class="edit">
          ...
          <td class="handle"><a href="javascript:if(confirm('<?php echo $lang['nc_ensure_del'];?>'))window.location = 'index.php?m=mb_category&a=mb_category_del&gc_id=<?php echo $v['gc_id'];?>';" class="btn red"><i class="fa fa-trash-o"></i><?php echo $lang['nc_del'];?></a><a href="index.php?m=mb_category&a=mb_category_edit&gc_id=<?php echo $v['gc_id'];?>" class="btn blue"><i class="fa fa-pencil-square-o"></i><?php echo $lang['nc_edit'];?></a></td>
...
$(function(){
    ...
    if (name == 'add') {
        window.location.href = 'index.php?m=mb_category&a=mb_category_add';
    }
}
</script>