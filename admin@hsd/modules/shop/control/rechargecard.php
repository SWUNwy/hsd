...
<a class="btn green confirm-del-on-click" href="javascript:;" data-href="index.php?m=rechargecard&a=del_card&id={$val['id']}"><i class="fa fa-trash"></i>删除</a>
EOB;
    ...
    public function export_step1Op()
    {
        ...
        if (!is_numeric($_GET['curpage'])) {
            ...
            if ($count > self::EXPORT_SIZE) {
                ...
                Tpl::output('murl', 'index.php?m=rechargecard&a=index');
				Tpl::setDirquna('shop');
    ...
    public function log_export_step1Op()
    {
        ...
        if (!is_numeric($_GET['curpage'])){
            ...
            if ($count > self::EXPORT_SIZE ){
                ...
                Tpl::output('list',$array);
                Tpl::output('murl','index.php?m=rechargecard&a=log_list');
				Tpl::setDirquna('shop');
                Tpl::showpage('export.excel');
                return;
