...
class help_storeControl extends SystemControl{
    ...
    public function get_xmlOp() {
        ...
        foreach ($help_list as $value) {
            $param = array();
            $param['operation'] = "<a class='btn red' href=\"javascript:void(0);\" onclick=\"fg_del('".$value['help_id']."')\"><i class='fa fa-trash-o'></i>删除</a><a class='btn blue' href='index.php?m=help_store&a=edit_help&help_id=".$value['help_id']."' class='url'><i class='fa fa-pencil-square-o'></i>编辑</a>";
    ...
    public function get_type_xmlOp() {
        ...
        foreach ($type_list as $value) {
            ...
            $operation .= "<a class='btn blue' href='index.php?m=help_store&a=edit_type&type_id=".$value['type_id']."' class='url'><i class='fa fa-pencil-square-o'></i>编辑</a>";
    ...
    public function add_helpOp() {
        ...
        if (chksubmit()) {
            ...
            if ($state) {
                ...
                showMessage(Language::get('nc_common_save_succ'),'index.php?m=help_store&a=help_store');
            } else {
    ...
    public function add_typeOp() {
        ...
        if (chksubmit()) {
            ...
            if ($state) {
                ...
                showMessage(Language::get('nc_common_save_succ'),'index.php?m=help_store&a=help_type');
            } else {
                showMessage(Language::get('nc_common_save_fail'));
            }
        }
