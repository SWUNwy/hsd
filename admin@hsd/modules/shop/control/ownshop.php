...
Tpl::setDirquna('shop');
    ...
    public function get_xmlOp() {
        ...
        foreach ($store_list as $value) {
            $param = array();
            $operation = "<a class='btn blue' href='index.php?m=ownshop&a=edit&id=".$value['store_id']."'><i class='fa fa-pencil-square-o'></i>编辑</a>";
            if ($value['bind_all_gc'] != 1 || empty($stores_with_goods[$value['store_id']])) {
                ...
                if ($value['bind_all_gc'] != 1) {
                    $operation .= "<li><a href='index.php?m=ownshop&a=bind_class&id=" . $value['store_id'] . "'>编辑经营类目</a></li>";
                }
