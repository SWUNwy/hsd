...
class complainControl extends SystemControl {
    ...
    private $links = array(
            array('url'=>'m=complain&a=complain_new_list','text'=>'新投诉'),
            array('url'=>'m=complain&a=complain_appeal_list','text'=>'待申诉'),
            array('url'=>'m=complain&a=complain_talk_list','text'=>'对话中'),
            array('url'=>'m=complain&a=complain_handle_list','text'=>'待仲裁'),
            array('url'=>'m=complain&a=complain_finish_list','text'=>'已关闭'),
            array('url'=>'m=complain&a=complain_subject_list','text'=>'主题设置'),
            array('url'=>'m=complain&a=complain_setting','text'=>'时效设置')
    );
    ...
    */
    public function get_new_xmlOp() {
        ...
        foreach ($complain_list as $k => $complain_info) {
            $list = array();
            if ($_GET['state'] == 99) {
                $list['operation'] = "<a class=\"btn orange\" href=\"index.php?m=complain&a=complain_progress&complain_id={$complain_info['complain_id']}\"><i class=\"fa fa-list-alt\"></i>查看</a>";
            } else {
                $list['operation'] = "<a class=\"btn orange\" href=\"index.php?m=complain&a=complain_progress&complain_id={$complain_info['complain_id']}\"><i class=\"fa fa-gavel\"></i>处理</a>";
            }
    ...
    public function complain_verifyOp() {
        ...
        if(intval($complain_info['complain_state']) === self::STATE_NEW) {
            ...
            if($model_complain->updateComplain($update_array,$where_array)) {
                ...
                showMessage(Language::get('complain_verify_success'),'index.php?m=complain&a=complain_new_list');
            } else {
                showMessage(Language::get('complain_verify_fail'),'index.php?m=complain&a=complain_new_list');
            }
        } else {
    ...
    public function complain_subject_saveOp() {
        ...
        if ($error != '') {
            ...
            showMessage(Language::get('complain_subject_add_success'),'index.php?m=complain&a=complain_subject_list');
        }
    }
    ...
    public function complain_subject_dropOp() {
        ...
        if(empty($complain_subject_id)) {
            showMessage(Language::get('param_error'),'index.php?m=complain');
        }
        $model_complain_subject= Model('complain_subject');
        $update_array = array();
        ...
        if($model_complain_subject->updateComplainSubject($update_array,$where_array)) {
            ...
            showMessage(Language::get('complain_subject_delete_success'),'index.php?m=complain&a=complain_subject_list');
        } else {
            showMessage(Language::get('complain_subject_delete_fail'),'index.php?m=complain&a=complain_subject_list');
        }
    }
    ...
    private function get_complain_state_link($complain_state) {
        switch(intval($complain_state)) {
            case self::STATE_NEW:
                return 'index.php?m=complain&a=complain_new_list';
                break;
            case self::STATE_APPEAL:
                return 'index.php?m=complain&a=complain_appeal_list';
                break;
            case self::STATE_TALK:
                return 'index.php?m=complain&a=complain_talk_list';
                break;
            case self::STATE_HANDLE:
                return 'index.php?m=complain&a=complain_handle_list';
                break;
            case self::STATE_FINISH:
                return 'index.php?m=complain&a=complain_finish_list';
                break;
            default:
                showMessage(Language::get('param_error'));
        }
    ...
    private function show_menu($menu_key) {
        $menu_array = array(
            'complain_new_list'=>array('menu_type'=>'link','menu_name'=>Language::get('complain_new_list'),'menu_url'=>'index.php?m=complain&a=complain_new_list'),
            'complain_appeal_list'=>array('menu_type'=>'link','menu_name'=>Language::get('complain_appeal_list'),'menu_url'=>'index.php?m=complain&a=complain_appeal_list'),
            'complain_talk_list'=>array('menu_type'=>'link','menu_name'=>Language::get('complain_talk_list'),'menu_url'=>'index.php?m=complain&a=complain_talk_list'),
            'complain_handle_list'=>array('menu_type'=>'link','menu_name'=>Language::get('complain_handle_list'),'menu_url'=>'index.php?m=complain&a=complain_handle_list'),
            'complain_finish_list'=>array('menu_type'=>'link','menu_name'=>Language::get('complain_finish_list'),'menu_url'=>'index.php?m=complain&a=complain_finish_list'),
            'complain_subject_list'=>array('menu_type'=>'link','menu_name'=>Language::get('complain_subject_list'),'menu_url'=>'index.php?m=complain&a=complain_subject_list'),
            'complain_subject_add'=>array('menu_type'=>'link','menu_name'=>Language::get('complain_subject_add'),'menu_url'=>'index.php?m=complain&a=complain_subject_add'),
            'complain_setting'=>array('menu_type'=>'link','menu_name'=>Language::get('complain_setting'),'menu_url'=>'index.php?m=complain&a=complain_setting'),
