...
class stat_storeControl extends SystemControl{
    private $links = array(
        array('url'=>'m=stat_store&a=newstore','lang'=>'stat_newstore'),
        array('url'=>'m=stat_store&a=hotrank','lang'=>'stat_storehotrank'),
        array('url'=>'m=stat_store&a=storesales','lang'=>'stat_storesales'),
        array('url'=>'m=stat_store&a=degree','lang'=>'stat_storedegree'),
        array('url'=>'m=stat_store&a=storearea','lang'=>'stat_storearea'),
    );
    ...
    public function newstoreOp(){
        //导出excel连接地址
        $actionurl = 'index.php?m=stat_store&a=newstore';
        $where = array();
        //所属店铺分类
    ...
    public function showstoreOp(){
        ...
        $this->links[] = array('url'=>'m=stat_store&a=showstore','lang'=>'stat_storelist');
    ...
    public function storeareaOp(){
        ...
        Tpl::output('stat_json',$stat_json);
        Tpl::output('statlist',$statlist);
        $actionurl = 'index.php?m=stat_store&a=showstore&type=storearea';
        if (trim($_GET['search_time'])){
