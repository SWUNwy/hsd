...
class domainControl extends SystemControl{
    ...
    public function get_xmlOp() {
        ...
        foreach ($store_list as $value) {
            $param = array();
            $param['operation'] = "<a class='btn blue' href='index.php?m=domain&a=store_domain_edit&store_id=" . $value['store_id'] . "'><i class='fa fa-pencil-square-o'></i>编辑</a>";
    ...
    public function store_domain_editOp(){
        ...
        if (chksubmit()){
            ...
            showMessage(Language::get('nc_common_save_succ'),'index.php?m=domain&a=store_domain_list');//保存成功
        }
