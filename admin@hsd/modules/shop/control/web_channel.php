...
class web_channelControl extends SystemControl{
    private $links = array(
        array('url'=>'m=web_channel&a=web_channel','text'=>'频道列表'),
        array('url'=>'m=web_channel&a=floor_list','text'=>'模块列表')
    );
    ...
    public function get_channel_xmlOp() {
        ...
        if (!empty($list) && is_array($list)){
            ...
            foreach ($list as $k => $v){
                ...
                $operation .= '<li><a href="index.php?m=web_channel&a=edit_channel&channel_id='.$v['channel_id'].'">基本设置</a></li>';
                $operation .= '<li><a href="index.php?m=web_channel&a=set_channel&channel_id='.$v['channel_id'].'">编辑模块</a></li>';
                $operation .= '</ul></span>';
    ...
    public function get_floor_xmlOp() {
        ...
        if (!empty($list) && is_array($list)){
            ...
            foreach ($list as $k => $v){
                ...
                $operation = '';
                $operation .= '<a class="btn purple" href="index.php?m=web_channel&a=edit_floor&web_id='.$v['web_id'].'"><i class="fa fa-cog"></i>设置</a>';
                $operation .= '<a class="btn orange" href="index.php?m=web_channel&a=edit_'.$v['web_page'].'&web_id='.$v['web_id'].'"><i class="fa fa-steam"></i>模块设计</a>';
                $out_array['operation'] = $operation;
    ...
    public function add_channelOp() {
        ...
        if (chksubmit()) {
            ...
            if ($state) {
                ...
                showMessage(Language::get('nc_common_save_succ'),'index.php?m=web_channel&a=web_channel');
            } else {
    ...
    public function add_floorOp() {
        ...
        if (chksubmit()) {
            ...
            if ($state) {
                ...
                showMessage(Language::get('nc_common_save_succ'),'index.php?m=web_channel&a=floor_list');
            } else {
                showMessage(Language::get('nc_common_save_fail'));
            }
        }
