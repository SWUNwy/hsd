...
class stat_memberControl extends SystemControl{
    private $links = array(
        array('url'=>'m=stat_member&a=newmember','lang'=>'stat_newmember'),
        array('url'=>'m=stat_member&a=analyze','lang'=>'stat_memberanalyze'),
        array('url'=>'m=stat_member&a=scale','lang'=>'stat_scaleanalyze'),
        array('url'=>'m=stat_member&a=area','lang'=>'stat_areaanalyze'),
        array('url'=>'m=stat_member&a=buying','lang'=>'stat_buying'),
    );
    ...
    public function newmemberOp(){
        ...
        if($this->search_arr['search_type'] == 'day'){
            ...
            Tpl::output('actionurl','index.php?m=stat_member&a=newmember&search_type=day&search_time='.date('Y-m-d',$this->search_arr['day']['search_time']));
        }
        ...
        if($this->search_arr['search_type'] == 'week'){
            ...
            Tpl::output('actionurl','index.php?m=stat_member&a=newmember&search_type=week&searchweek_year='.$this->search_arr['week']['current_year'].'&searchweek_month='.$this->search_arr['week']['current_month'].'&searchweek_week='.$this->search_arr['week']['current_week']);
        }
        ...
        if($this->search_arr['search_type'] == 'month'){
            ...
            Tpl::output('actionurl','index.php?m=stat_member&a=newmember&search_type=month&searchmonth_year='.$this->search_arr['month']['current_year'].'&searchmonth_month='.$this->search_arr['month']['current_month']);
        }
    ...
    public function showmemberOp(){
        ...
        $this->links[] = array('url'=>'m=stat_member&a=showmember','lang'=>'stat_memberlist');
