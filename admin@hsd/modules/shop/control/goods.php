...
class goodsControl extends SystemControl{
    private $links = array(
        array('url'=>'m=goods&a=goods','text'=>'所有商品'),
        array('url'=>'m=goods&a=lockup_list','text'=>'违规下架'),
        array('url'=>'m=goods&a=waitverify_list','text'=>'等待审核'),
        array('url'=>'m=goods&a=goods_set','text'=>'商品设置'),
    );
    ...
    public function export_csvOp() {
        ...
        if (!is_numeric($_GET['curpage'])){
            ...
            if ($count > self::EXPORT_SIZE ){   //显示下载链接
                ...
                Tpl::output('murl','index.php?m=goods&a=index');
								//网 店 运 维shop wwi.com
		Tpl::setDirquna('shop');
