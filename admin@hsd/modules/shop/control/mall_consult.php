    ...
    public function get_xmlOp(){
        ...
        foreach ($consult_list as $consult_info) {
            ...
            if ($consult_info['is_reply']) {
                $list['operation'] .= "<a class=\"btn green\" href=\"index.php?m=mall_consult&a=consult_reply&id={$consult_info['mc_id']}\"><i class=\"fa fa-list-alt\"></i>编辑</a>";
            } else {
                $list['operation'] .= "<a class=\"btn green\" href=\"index.php?m=mall_consult&a=consult_reply&id={$consult_info['mc_id']}\"><i class=\"fa fa-list-alt\"></i>回复</a>";
            }
    ...
    public function consult_replyOp() {
        ...
        if (chksubmit()) {
            ...
            if ($result) {
                ...
                $param['param'] = array(
                    'consult_url' => urlShop('m_mallconsult', 'mallconsult_info', array('id' => $mc_id))
                );
