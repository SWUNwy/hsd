...
class goods_transportControl extends SystemControl{
    ...
    public function listOp(){
        ...
        $list = $model_transport->getTransportList($condition,10);
        ...
        Tpl::showpage('goods_transport.list');
    }
    ...
    public function addOp(){
        ...
        Tpl::showpage('goods_transport.add');
    }
    ...
    public function saveOp(){
        ...
        if ($result){
            header('location: index.php?m=goods_transport&type='.$_POST['type']);exit;
        }else{
            showMessage(Language::get('transport_op_fail'),$_SERVER['HTTP_REFERER'],'html','error');
        }
    }
