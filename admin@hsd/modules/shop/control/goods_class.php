...
class goods_classControl extends SystemControl{
    private $links = array(
        array('url'=>'m=goods_class&a=goods_class','lang'=>'nc_manage'),
        array('url'=>'m=goods_class&a=goods_class_import','lang'=>'goods_class_index_import'),
        array('url'=>'m=goods_class&a=tag','lang'=>'goods_class_index_tag')
    );
        ...
        if (chksubmit()){
            ...
            if ($error != ''){
                ...
                if ($result){                    
                    $url = array(
                        array(
                            'url'=>'index.php?m=goods_class&a=goods_class_add&gc_parent_id='.$_POST['gc_parent_id'],
                            'msg'=>$lang['goods_class_add_again'],
                        ),
                        array(
                            'url'=>'index.php?m=goods_class&a=goods_class',
    ...
    public function goods_class_editOp(){
        ...
        if (chksubmit()){
            ...
            $url = array(
                array(
                    'url'=>'index.php?m=goods_class&a=goods_class_edit&gc_id='.intval($_POST['gc_id']),
        ...
        $this->links[] = array('url'=>'m=goods_class&a=goods_class_edit','lang'=>'nc_edit');
    ...
    public function goods_class_importOp(){
        ...
        if (chksubmit()){
            ...
            if (!empty($_FILES['csv']) && !empty($_FILES['csv']['name']) && $file_type == 'csv'){
                ...
                showMessage($lang['nc_common_op_succ'],'index.php?m=goods_class&a=goods_class');
            }else {
    ...
    public function tag_resetOp(){
        ...
        if(!$return){
            showMessage($lang['goods_class_reset_tag_fail'], 'index.php?m=goods_class&a=tag');
        }
        ...
        if(is_array($goods_class) and !empty($goods_class)) {
            ...
            if($return){
                ...
                showMessage($lang['nc_common_op_succ'], 'index.php?m=goods_class&a=tag');
            }else{
                $this->log(L('nc_reset').'tag',0);
                showMessage($lang['nc_common_op_fail'], 'index.php?m=goods_class&a=tag');
            }
        }else{
            $this->log(L('nc_reset').'tag',0);
            showMessage($lang['goods_class_reset_tag_fail_no_class'], 'index.php?m=goods_class&a=tag');
        }
    }
    ...
    public function tag_updateOp(){
        ...
        if(is_array($tag_list) && !empty($tag_list)){
            ...
            $this->log(L('nc_update').'tag',0);
            showMessage($lang['goods_class_update_tag_fail_no_class'], 'index.php?m=goods_class&a=tag');
        }
