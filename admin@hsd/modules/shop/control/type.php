...
class typeControl extends SystemControl {
    ...
    public function get_xmlOp() {
        ...
        foreach ((array)$type_list as $value) {
            $param = array();
            $operation = "<a class='btn red' href='javascript:void(0);' onclick='fg_del(". $value['type_id'] .")'><i class='fa fa-trash-o'></i>删除</a><a class='btn blue' href='index.php?m=type&a=type_edit&t_id=".$value['type_id']."'><i class='fa fa-pencil-square-o'></i>编辑</a>";
    ...
    public function type_addOp(){
        ...
        if (chksubmit()){
            ...
            $url = array(
                array(
                    'url'=>'index.php?m=type&a=type_add',
                    'msg'=>$lang['type_index_continue_to_dd']
                ),
                array(
                    'url'=>'index.php?m=type&a=type',
