...
class stat_goodsControl extends SystemControl{
    private $links = array(
        array('url'=>'m=stat_goods&a=pricerange','lang'=>'stat_goods_pricerange'),
        array('url'=>'m=stat_goods&a=hotgoods','lang'=>'stat_hotgoods'),
        array('url'=>'m=stat_goods&a=goods_sale','lang'=>'stat_goods_sale'),
    );
