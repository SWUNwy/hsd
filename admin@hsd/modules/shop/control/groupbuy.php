...
class groupbuyControl extends SystemControl{
    ...
    public function __construct(){
        ...
        if (C('groupbuy_allow') != 1){
            $url = array(
                array(
                    'url'=>'index.php?m=setting',
                    'msg'=>Language::get('close'),
                ),
                array(
                    'url'=>'index.php?m=groupbuy&a=groupbuy_template_list&groupbuy_open=1',
    ...
    public function groupbuy_list_xmlOp()
    {
        ...
        foreach ($groupbuy_list as $val) {
            $u = SHOP_SITE_URL . "/index.php?m=show_groupbuy&a=groupbuy_detail&group_id=" . $val['groupbuy_id'];
            ...
            $i['goods_name'] = '<a target="_blank" href="'
                . SHOP_SITE_URL . "/index.php?m=goods&goods_id=" . $val['goods_id']
                . '">' . $val['goods_name'] . '</a>';
...
EOB;
    ...
    public function class_saveOp() {
        ...
        if(empty($class_id)) {
            ...
            if ($class_id = $model_groupbuy_class->save($param)) {
                ...
                showMessage(Language::get('groupbuy_class_add_success'),'index.php?m=groupbuy&a=class_list');
            }
            else {
                showMessage(Language::get('groupbuy_class_add_fail'),'index.php?m=groupbuy&a=class_list');
            }
        }
        else {
            //编辑
            if($model_groupbuy_class->updates($param,array('class_id'=>$class_id))) {
                ...
                showMessage(Language::get('groupbuy_class_edit_success'),'index.php?m=groupbuy&a=class_list');
            }
            else {
                showMessage(Language::get('groupbuy_class_edit_fail'),'index.php?m=groupbuy&a=class_list');
            }
        }
    ...
    public function price_list_xmlOp()
    {
        ...
        foreach ($groupbuy_price_list as $val) {
            $o = '<a class="confirm-del-on-click btn red" href="index.php?m=groupbuy&a=price_drop&range_id='
                . $val['range_id']
                . '"><i class="fa fa-trash-o"></i>删除</a>';
            $o .= '<a class="btn blue" href="index.php?m=groupbuy&a=price_edit&range_id='
                . $val['range_id']
    ...
    public function price_saveOp() {
        ...
        if(empty($range_id)) {
            ...
            if($model->save($param)) {
                ...
                showMessage(Language::get('groupbuy_price_range_add_success'),'index.php?m=groupbuy&a=price_list');
            }
            else {
                showMessage(Language::get('groupbuy_price_range_add_fail'),'index.php?m=groupbuy&a=price_list');
            }
        }
        else {
            //编辑
            if($model->updates($param,array('range_id'=>$range_id))) {
                ...
                showMessage(Language::get('groupbuy_price_range_edit_success'),'index.php?m=groupbuy&a=price_list');
            }
            else {
                showMessage(Language::get('groupbuy_price_range_edit_fail'),'index.php?m=groupbuy&a=price_list');
            }
        }
    ...
    private function show_menu($menu_key) {
        $menu_array = array(
            'groupbuy_list'=>array('menu_type'=>'link','menu_name'=>'特卖活动','menu_url'=>'index.php?m=groupbuy&a=groupbuy_list'),
            'groupbuy_quota'=>array('menu_type'=>'link','menu_name'=>'套餐管理','menu_url'=>'index.php?m=groupbuy&a=groupbuy_quota'),
            'class_list'=>array('menu_type'=>'link','menu_name'=>Language::get('groupbuy_class_list'),'menu_url'=>'index.php?m=groupbuy&a=class_list'),
            'class_add'=>array('menu_type'=>'link','menu_name'=>Language::get('groupbuy_class_add'),'menu_url'=>'index.php?m=groupbuy&a=class_add'),
            'price_list'=>array('menu_type'=>'link','menu_name'=>Language::get('groupbuy_price_list'),'menu_url'=>'index.php?m=groupbuy&a=price_list'),
            'price_add'=>array('menu_type'=>'link','menu_name'=>Language::get('groupbuy_price_add'),'menu_url'=>'index.php?m=groupbuy&a=price_add'),
            'price_edit'=>array('menu_type'=>'link','menu_name'=>Language::get('groupbuy_price_edit'),'menu_url'=>'index.php?m=groupbuy&a=price_edit'),
