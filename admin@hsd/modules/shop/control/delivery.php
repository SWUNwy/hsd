...
class deliveryControl extends SystemControl{
    ...
    public function index_xmlOp()
    {
        ...
        foreach ($list as $val) {
            ...
            $i['operation'] = <<<EOB
<a class="btn green" href="index.php?m=delivery&a=order_list&dlyp_id={$val['dlyp_id']}"><i class="fa fa-list-alt"></i>查看订单</a>
<a class="btn blue" href="index.php?m=delivery&a=edit_delivery&d_id={$val['dlyp_id']}"><i class="fa fa-pencil-square-o"></i>编辑</a>
EOB;
