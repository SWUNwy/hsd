...
class specControl extends SystemControl {
    ...
    public function get_xmlOp() {
        ...
        foreach ((array)$spec_list as $value) {
            ...
            $operation .= "<a class='btn blue' href='index.php?m=spec&a=spec_edit&sp_id=".$value['sp_id']."'><i class='fa fa-pencil-square-o'></i>编辑</a>";
        ...
        if (chksubmit()){
            ...
            if ($error != ''){
                ...
                if($return) {
                    $url = array(
                        array(
                            'url'=>'index.php?m=spec&a=spec_add',
                            'msg'=>$lang['spec_index_continue_to_dd']
                        ),
                        array(
                            'url'=>'index.php?m=spec&a=spec',
