...
<div class="page">
  <!-- 页面导航 -->
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?m=contract&a=contractlist" title="返回列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
        <h3>消费者保障服务</h3>
        <h5>消费者保障服务查看与管理</h5>
      </div>
...
<script>
$(function(){
    var flexUrl = 'index.php?m=contract&a=contractlog_xml&item_id=<?php echo $output['c_info']['ct_itemid'];?>&store_id=<?php echo $output['c_info']['ct_storeid'];?>';
    $("#flexigrid").flexigrid({
        url: flexUrl,
        colModel: [
