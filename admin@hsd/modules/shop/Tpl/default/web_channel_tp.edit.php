...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?m=web_channel&a=floor_list" title="返回模块列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
  ...
  <div class="homepage-focus" id="homepageFocusTab">
    ...
    <form id="upload_category_form" class="tab-content" name="upload_category_form">
      ...
      <div class="ncap-form-default">
        <div class="bot"><a href="JavaScript:void(0);" onclick="update_channel_category();" class="ncap-btn-big ncap-btn-green"><span>保存</span></a> <a href="index.php?m=web_channel&a=html_update&web_id=<?php echo $output['code_channel_slide']['web_id'];?>" class="ncap-btn-big ncap-btn-green"><span>更新模块内容</span></a> <span class="web-save-succ" style="display:none;"><?php echo $lang['nc_common_save_succ'];?></span> </div>
      </div>
    </form>
    <form id="upload_category" enctype="multipart/form-data" method="post" style="display:none;" action="index.php?m=web_channel&a=upload_gc_pic" target="upload_">
    ...
    <form id="upload_slide_form" class="tab-content" name="upload_slide_form" enctype="multipart/form-data" method="post" action="index.php?m=web_channel&a=channel_slide" target="upload_pic" style="display:none;">
      ...
      <div class="ncap-form-default">
        <div class="bot"><a href="JavaScript:void(0);" onclick="$('#upload_slide_form').submit();" class="ncap-btn-big ncap-btn-green"><span>保存</span></a> <a href="index.php?m=web_channel&a=html_update&web_id=<?php echo $output['code_channel_slide']['web_id'];?>" class="ncap-btn-big ncap-btn-green"><span>更新模块内容</span></a> <span class="web-save-succ" style="display:none;"><?php echo $lang['nc_common_save_succ'];?></span> </div>
      </div>
    </form>
    <form id="upload_adv_form" class="tab-content" name="upload_adv_form" enctype="multipart/form-data" method="post" action="index.php?m=web_channel&a=channel_adv" target="upload_pic" style="display:none;">
      <input type="hidden" name="form_submit" value="ok" />
      ...
      <div class="ncap-form-default">
        <div class="bot"> <a href="JavaScript:void(0);" onclick="$('#upload_adv_form').submit();" class="ncap-btn-big ncap-btn-green"><span>保存</span></a> <a href="index.php?m=web_channel&a=html_update&web_id=<?php echo $output['code_channel_slide']['web_id'];?>" class="ncap-btn-big ncap-btn-green"><span>更新模块内容</span></a> <span class="web-save-succ" style="display:none;"><?php echo $lang['nc_common_save_succ'];?></span> </div>
      </div>
    </form>
  </div>
</div>
