  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base nc-row">
        <li><a href="index.php?m=store_joinin&a=edit_info"><?php echo '入驻首页';?></a></li>
  ...
  <table class="flex-table">
    ...
    <tbody>
      ...
      <tr data-id="<?php echo $val['help_id'];?>">
        ...
        <td class="handle-s"><a class="btn blue" href="index.php?m=store_joinin&a=edit_help&help_id=<?php echo $val['help_id'];?>"><i class="fa fa-pencil-square-o"></i><?php echo $lang['nc_edit'];?></a></td>
