  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base nc-row">
        <li><a href="index.php?m=promotion_bundling&a=bundling_list"><?php echo $lang['bundling_list'];?></a></li>
        <li><a href="index.php?m=promotion_bundling&a=bundling_quota"><?php echo $lang['bundling_quota'];?></a></li>
        <li><a href="JavaScript:void(0);" class="current"><?php echo $lang['bundling_setting'];?></a></li>
      </ul>
    </div>
  </div>
  <form id="add_form" method="post" action="index.php?m=promotion_bundling&a=bundling_setting">
