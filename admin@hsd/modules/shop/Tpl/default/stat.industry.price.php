...
<div class="page">
  ...
  <div class="ncap-stat-chart">
    ...
    <?php } else {?>
    <div class="no-date"><i class="fa fa-exclamation-triangle"></i>查看行业价格分布情况前，请先设置价格区间。<a href="index.php?m=stat_general&a=setting" class="ncap-btn ncap-btn-orange">马上设置</a></div>
    <?php } ?>
  </div>
  ...
  <div class="ncap-search-bar">
    ...
    <form method="get" action="index.php" name="formSearch" id="formSearch">
      <input type="hidden" name="m" value="stat_industry" />
