  ...
  <table class="flex-table">
    ...
    <tbody>
      ...
      <tr>
        ...
        <a class="btn red" href="index.php?m=refund&a=del_reason&reason_id=<?php echo $val['reason_id'];?>" onclick="if(confirm('删除后将不能恢复，确认删除这  1 项吗？')){return true;} else {return false;}"><i class="fa fa-trash-o"></i>删除</a>
        <?php } ?>
        <a class="btn blue" href="index.php?m=refund&a=edit_reason&reason_id=<?php echo $val['reason_id'];?>"><i class="fa fa-pencil-square-o"></i><?php echo $lang['nc_edit'];?></a>
        </td>
...
function fg_operation(name, bDiv) {
    if (name == 'add') {
        window.location.href = 'index.php?m=refund&a=add_reason';
    }
}
</script>
