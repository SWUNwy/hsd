...
<div class="page">
  ...
  <table class="flex-table">
    ...
    <tbody id="datatable">
      ...
      <tr>
        ...
        <td class="handle-s"><a href="index.php?m=stat_store&a=showstore&type=newbyday&t=<?php echo $v['seartime'];?>&scid=<?php echo $_REQUEST['search_sclass'];?>" class="btn green"><i class="fa fa-list-alt"></i>查看</a></td>
  ...
  <div class="ncap-search-bar">
    ...
    <input type="hidden" name="m" value="stat_store" />
    <input type="hidden" name="a" value="newstore" />
