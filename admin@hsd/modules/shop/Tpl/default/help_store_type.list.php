  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base nc-row">
        <li><a href="index.php?m=help_store&a=help_store"><?php echo '帮助内容';?></a></li>
...
$(function(){
    $("#flexigrid").flexigrid({
        url: 'index.php?m=help_store&a=get_type_xml',
        colModel : [
...
function fg_operation(name, bDiv) {
    if (name == 'add') {
        window.location.href = 'index.php?m=help_store&a=add_type';
    }
}

function fg_del(id) {
    if(confirm('删除后将不能恢复，确认删除这项吗？')){
        $.getJSON('index.php?m=help_store&a=del_type', {id:id}, function(data){
            if (data.state) {
