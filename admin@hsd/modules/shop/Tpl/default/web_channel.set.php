...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?m=web_channel&a=web_channel" title="返回频道列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
...
function check_goods_class() {
    ...
    if (gc_id>0 && gc_id!="<?php echo $output['gc_id'];?>") {
    	var get_text = $.ajax({
    		url: 'index.php?m=web_channel&a=check_goods_class&gc_id='+gc_id,
    		async: false
    		}).responseText;
    	if(get_text!='') {
...
function get_floor() {
	...
	$("#show_floor_list").load('index.php?m=web_channel&a=get_channel_fl&'+$.param({'name':f_name }));
}
