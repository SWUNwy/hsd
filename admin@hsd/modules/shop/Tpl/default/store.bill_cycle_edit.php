...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?m=store&a=bill_cycle" title="返回<?php echo $lang['manage'];?>列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
  ...
  <h3>设置结算周期</h3>
    ...
    <input type="hidden" name="a" value="bill_cycle_edit" />
