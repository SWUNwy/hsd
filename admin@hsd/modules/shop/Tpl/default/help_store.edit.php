...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?m=help_store&a=help_store" title="返回列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
...
$(function(){
    ...
    $('#fileupload').each(function(){
        $(this).fileupload({
            dataType: 'json',
            url: 'index.php?m=help_store&a=upload_pic&item_id=<?php echo $output['help']['help_id']?>',
...
function del_file_upload(file_id){
    ...
    $.getJSON('index.php?m=help_store&a=del_pic&file_id=' + file_id, function(result){
        if(result){
            $('#pic_' + file_id).remove();
        }
    });
