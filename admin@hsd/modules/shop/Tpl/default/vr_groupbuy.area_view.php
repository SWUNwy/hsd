    ...
    <table class="flex-table">
      ...
      <tbody>
        ...
        <tr data-id="<?php echo $val['area_id'] ;?>">
          ...
          <td class="handle"><a href="index.php?m=vr_groupbuy&a=area_street&parent_area_id=<?php echo $val['area_id']; ?>" class="btn green"><i class="fa fa-list-alt"></i>查看</a> <span class="btn"> <em><i class="fa fa-cog"></i>设置<i class="arrow"></i></em>
            <ul>
              <li><a href="index.php?m=vr_groupbuy&a=area_edit&area_id=<?php echo $val['area_id']; ?>">编辑商区</a></li>
        ...
        buttons: [
            {
                ...
                title: '新增商区',
                onpress: function() {
                    location.href = 'index.php?m=vr_groupbuy&a=area_add&area_id=<?php echo $_GET['parent_area_id']; ?>';
                }
            },
            {
...
function submit_delete(id){
    if (confirm('<?php echo $lang['nc_ensure_del'];?>')) {
        ...
        $('#list_form').attr('action','index.php?m=vr_groupbuy&a=area_drop');
        $('#area_id').val(id);
        $('#list_form').submit();
    }
}
