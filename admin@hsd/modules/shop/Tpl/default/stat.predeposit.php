...
function update_flex(){
	$('.ncap-stat-general-single').load('index.php?m=stat_trade&a=get_plat_predeposit&'+$("#formSearch").serialize(),
		function(){
			$('.timer').each(count);
     	});
	$('#container').load('index.php?m=stat_trade&a=get_predeposit_highcharts&'+$("#formSearch").serialize());
    $("#flexigrid").flexigrid({
        url: 'index.php?m=stat_trade&a=get_predeposit_xml&'+$("#formSearch").serialize(),
        colModel : [
...
function fg_operation(name, bDiv){
    var stat_url = 'index.php?m=stat_trade&a=predeposit';
