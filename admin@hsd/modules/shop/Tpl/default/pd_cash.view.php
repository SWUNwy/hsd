<?php defined('ByShopKJYP') or exit('Access Invalid!');?>
  <div class="ncap-form-default">
    ...
    <div class="bot" id="submit-holder"> <a class="ncap-btn-big ncap-btn-green" href="javascript:if (confirm('<?php echo $lang['admin_predeposit_cash_confirm'];?>')){window.location.href='index.php?m=predeposit&a=pd_cash_pay&id=<?php echo $output['info']['pdc_id']; ?>';}else{}"><?php echo $lang['admin_predeposit_payed'];?></a></div>
  <?php } ?>
  </div>