<div class="goods-gallery add-step2"><a class='sample_demo' id="select_submit" href="index.php?m=store_album&a=pic_list_1&item=des" style="display:none;"><?php echo $lang['nc_submit'];?></a>
  ...
  <ul class="list">
    <?php foreach ($output['pic_list'] as $v){?>
         <li onclick="insert_editor('/picture/uploadfile/<?php echo $v['pic_atalog']!=""?$v['pic_atalog']."/":"" ?><?php echo $v['pic_path']?>')"><a href="JavaScript:void(0);"><img src="/picture/uploadfile/<?php echo $v['pic_path_240']?>" title='<?php echo $v['pic_name']?>'/></a></li>
