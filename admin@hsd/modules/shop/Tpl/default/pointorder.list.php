  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base nc-row">
        <li><a href="index.php?m=pointprod&a=pointprod" ><span><?php echo $lang['admin_pointprod_list_title'];?></span></a></li>
...
<script>
$(function() {
    var flexUrl = 'index.php?m=pointprod&a=pointorder_list_xml';
