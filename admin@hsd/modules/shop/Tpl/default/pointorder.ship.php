...
<div class="page">
  ...
  <form id="ship_form" method="post" name="ship_form" action="index.php?m=pointprod&a=order_ship&id=<?php echo $_GET['id']; ?>">
  ...
  <div class='msgdiv'> <?php echo $output['errormsg']; ?> <br>
    <br>
    <a class="forward" href="index.php?m=pointprod&amp;a=pointorder_list"><?php echo $lang['admin_pointorder_gobacklist']; ?></a> </div>
  <?php } ?>
</div>
