...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <a class="back" href="index.php?m=activity&a=activity" title="返回活动列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
...
<script>
$(function(){
    var flexUrl = 'index.php?m=activity&a=detail_xml&id=<?php echo $output['activity_detail']['activity_id']; ?>';
        ...
        buttons: [
            {
                ...
                onpress: function() {
                    ...
                    var href = 'index.php?m=activity&a=deal&state=1&activity_detail_id=__IDS__'.replace('__IDS__', ids.join(','));
                    performReq(href);
                }
            },
            {
                ...
                onpress: function() {
                    ...
                    var href = 'index.php?m=activity&a=deal&state=2&activity_detail_id=__IDS__'.replace('__IDS__', ids.join(','));
                    performReq(href);
                }
            },
            {
                ...
                onpress: function() {
                    ...
                    var href = 'index.php?m=activity&a=del_detail&activity_detail_id=__IDS__'.replace('__IDS__', ids.join(','));
                    performReq(href);
                }
            }
        ],
...
$("span[data-live-inline-edit='activity_detail_sort']").live('click', function() {
    ...
    $input.change(function() {
        ...
        $.get('index.php?m=activity&a=ajax&branch=activity_detail_sort', {
