  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base nc-row">
        <li><a href="index.php?m=points&a=pointslog"><?php echo $lang['admin_points_log_title']?></a></li>
        <li><a href="index.php?m=points&a=setting">规则设置</a></li>
...
function checkmember(){
	...
	$.getJSON("index.php?m=points&a=checkmember", {'name':membername}, function(data){
	        if (data)
	        {
		        $("#tr_memberinfo").show();
