...
function getTrends(storeid){
	var s_type = $("#search_type").val();
	$('#stattrends').load('index.php?m=stat_store&a=storesales_trends&storeid='+storeid+'&search_type='+s_type+'&'+$("#formSearch").serialize());
}
function update_flex(){
    $('#stattrends').html('');
    $("#flexigrid").flexigrid({
        url: 'index.php?m=stat_store&a=get_storesales_xml&'+$("#formSearch").serialize(),
        colModel : [
...
function fg_operation(name, bDiv){
    var stat_url = 'index.php?m=stat_store&a=storesales_list';
