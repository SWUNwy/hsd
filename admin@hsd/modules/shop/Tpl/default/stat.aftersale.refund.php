...
function update_flex(){
	$('#container').load('index.php?m=stat_aftersale&a=get_refund_highcharts&'+$("#formSearch").serialize());
    $("#flexigrid").flexigrid({
        url: 'index.php?m=stat_aftersale&a=get_refundlist_xml&'+$("#formSearch").serialize(),
        colModel : [
...
function fg_operation(name, bDiv){
    var stat_url = 'index.php?m=stat_aftersale&a=refundlist';
