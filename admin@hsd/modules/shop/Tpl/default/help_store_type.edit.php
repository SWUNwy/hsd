...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?m=help_store&a=help_type" title="返回列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
  ...
  <form id="post_form" method="post" name="form1" action="index.php?m=help_store&a=edit_type&type_id=<?php echo $output['type']['type_id']; ?>">
