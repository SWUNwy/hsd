...
$(function(){
    $("#flexigrid").flexigrid({
        url: 'index.php?m=goods_class&a=get_xml',
        colModel : [
...
function fg_operation(name, bDiv) {
    if (name == 'update') {
        window.location.href = 'index.php?m=goods_class&a=tag_update';
    }
    if (name == 'reset') {
        window.location.href = 'index.php?m=goods_class&a=tag_reset';
    }
}
function fg_edit(id) {
    CUR_DIALOG = ajax_form('tag_edit', '编辑TAG', 'index.php?m=goods_class&a=tag_edit&id='+id, 640);
}
</script>