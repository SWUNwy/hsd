...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?m=store_class" title="返回列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
	...
	$('#store_class_form').validate({
        ...
        rules : {
            sc_name : {
                required : true,
                remote   : {
                url :'index.php?m=store_class&a=ajax_check_name',
                type:'get',
                data:{
                    sc_name : function(){
                        return $('#sc_name').val();
