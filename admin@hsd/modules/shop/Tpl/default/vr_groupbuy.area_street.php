    ...
    <table class="flex-table">
      ...
      <tbody>
        ...
        <tr data-id="<?php echo $val['area_id'] ;?>">
          ...
          <td><a href="index.php?m=vr_groupbuy&a=area_edit&area_id=<?php echo $val['area_id']; ?>" class="btn blue"><i class="fa fa-pencil-square-o"></i>编辑</a> <a href="javascript:;" onclick="submit_delete(<?php echo $val['area_id']; ?>)" class="btn green"><i class="fa fa-trash"></i>删除</a></td>
