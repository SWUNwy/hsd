...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <a class="back" href="index.php?m=vr_groupbuy&a=class_list" title="返回列表">
        <i class="fa fa-arrow-circle-o-left"></i>
      </a>
      <div class="subject">
        <h3>虚拟团购 - 编辑虚拟团购分类“<?php echo $output['class']['class_name']; ?>”</h3>
        <h5>商家可设置其虚拟团购活动的分类以便于会员检索</h5>
      </div>
    </div>
  </div>
  <form id="add_form" method="post" enctype="multipart/form-data" action="index.php?m=vr_groupbuy&a=class_edit">
