...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?m=store_grade&a=store_grade" title="返回列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
	...
	$('#grade_form').validate({
        ...
        rules : {
            sg_name : {
                required : true,
                remote   : {
                url :'index.php?m=store_grade&a=ajax&branch=check_grade_name',
                type:'get',
                data:{
                        sg_name : function(){
                        	return $('#sg_name').val();
            ...
            sg_sort : {
                ...
                digits  : true,
                remote   : {
	                url :'index.php?m=store_grade&a=ajax&branch=check_grade_sort',
	                type:'get',
	                data:{
	                        sg_sort : function(){
	                        	return $('#sg_sort').val();
