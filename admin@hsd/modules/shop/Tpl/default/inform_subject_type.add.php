...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?m=inform&a=inform_subject_type_list" title="返回举报类型列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
  ...
  <form id="add_form" method="post" action="index.php?m=inform&a=inform_subject_type_save" name="form1">
