...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?m=goods_album&a=list" title="返回<?php echo $lang['g_album_list'];?>"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
  ...
  <form method='post' action="index.php" name="picForm" id="picForm">
    <input type="hidden" name="m" value="goods_album" />
