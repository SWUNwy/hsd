...
<div class="page">
  ...
  <div class="bot"><a href="index.php?m=web_channel&a=html_update&web_id=<?php echo $_GET['web_id'];?>" class="ncap-btn-big ncap-btn-green" id="submitBtn">更新模块内容</a> </div>
</div>
...
<div id="upload_channel_act_dialog" class="upload_channel_act_dialog" style="display:none;">
  <form id="upload_channel_act_form" name="upload_channel_act_form" enctype="multipart/form-data" method="post" action="index.php?m=web_channel&a=upload_pic" target="upload_pic">
    <input type="hidden" name="form_submit" value="ok" />
...
<div id="upload_adv_a_dialog" class="upload_adv_a_dialog" style="display:none;">
  <form id="upload_adv_a_form" name="upload_adv_a_form" enctype="multipart/form-data" method="post" action="index.php?m=web_channel&a=upload_pic" target="upload_pic">
...
<div id="upload_adv_b_dialog" class="upload_adv_b_dialog" style="display:none;">
  <form id="upload_adv_b_form" name="upload_adv_b_form" enctype="multipart/form-data" method="post" action="index.php?m=web_channel&a=upload_pic" target="upload_pic">
...
<div id="upload_adv_c_dialog" class="upload_adv_c_dialog" style="display:none;">
  <form id="upload_adv_c_form" name="upload_adv_c_form" enctype="multipart/form-data" method="post" action="index.php?m=web_channel&a=upload_pic" target="upload_pic">
