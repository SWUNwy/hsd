        ...
        <tr data-id="<?php echo $v['gc_id'];?>">
          ...
          <td class="handle">
            ...
            <ul>
              ...
              <?php }?>
              <li><a href="index.php?m=goods_class&a=nav_edit&gc_id=<?php echo $v['gc_id'];?>">编辑分类导航</a></li>
            </ul>
            </span></td>
...
function fg_operation(name, bDiv) {
    if (name == 'add') {
        window.location.href = 'index.php?m=goods_class&a=goods_class_add';
    } else if (name == 'del') {
        ...
        window.location.href = 'index.php?m=goods_class&a=goods_class_export';
    }
}
function fg_del(ids) {
