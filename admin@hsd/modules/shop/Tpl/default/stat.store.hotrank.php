...
<div class="page">
  ...
  <div class="ncap-search-bar">
    ...
    <input type="hidden" name="a" value="hotrank" />
...
function getStatdata(type){
	...
	$('#'+type+'_div').load('index.php?m=stat_store&a=hotrank_list&type='+type+'&search_sclass='+search_sclass+'&t=<?php echo $output['searchtime'];?>');
}
</script>