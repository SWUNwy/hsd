...
$(function(){
    ...
    $('#ncsubmit').click(function(){
        $("#flexigrid").flexOptions({url: 'index.php?m=consulting&a=get_consulting_xml&'+$("#formSearch").serialize(),query:'',qtype:''}).flexReload();
    });
    // 高级搜索重置
    $('#ncreset').click(function(){
        $("#flexigrid").flexOptions({url: 'index.php?m=consulting&a=get_consulting_xml'}).flexReload();
        $("#formSearch")[0].reset();
    });
    $("#flexigrid").flexigrid({
        url: 'index.php?m=consulting&a=get_consulting_xml',
        colModel : [
...
function fg_delete(id) {
	...
	$.ajax({
        type: "GET",
        dataType: "json",
        url: "index.php?m=consulting&a=delete",
        data: "consult_id="+id,
