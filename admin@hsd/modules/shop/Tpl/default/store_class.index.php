    ...
    <table class="flex-table">
      ...
      <tbody>
        ...
        <tr class="edit">
          ...
          <td class="handle">
          <a class="btn red" href="javascript:if(confirm('<?php echo $lang['del_store_class'];?>'))window.location = 'index.php?m=store_class&a=store_class_del&sc_id=<?php echo $v['sc_id'];?>';"><i class="fa fa-trash-o"></i><?php echo $lang['nc_del'];?></a>
          <a class="btn blue" href="index.php?m=store_class&a=store_class_edit&sc_id=<?php echo $v['sc_id'];?>"><i class="fa fa-pencil-square-o"></i><?php echo $lang['nc_edit'];?></a>
          </td>
...
function fg_operation(name, bDiv) {
    if (name == 'add') {
        window.location.href = 'index.php?m=store_class&a=store_class_add';
    }
}
</script>