...
function update_flex(){
	//加载统计列表
    $("#glist").flexigrid({
        url: 'index.php?m=stat_marketing&a=get_grouplist_xml&'+$("#formSearch").serialize(),
        colModel : [
    ...
    $("#flexigrid").flexigrid({
        url: 'index.php?m=stat_marketing&a=get_groupgoods_xml&'+$("#formSearch").serialize(),
        colModel : [
            {display: '操作', name : 'operation', width : 60, sortable : false, align: 'center', className: 'handle-s'},
...
$(function () {
	...
	$('#ncsubmit').click(function(){
	    $("#glist").flexOptions({url: 'index.php?m=stat_marketing&a=get_grouplist_xml&'+$("#formSearch").serialize(),query:'',qtype:''}).flexReload();
	    $("#flexigrid").flexOptions({url: 'index.php?m=stat_marketing&a=get_groupgoods_xml&'+$("#formSearch").serialize(),query:'',qtype:''}).flexReload();
	    update_flex();
    });
});
function fg_operation(name, bDiv){
    var stat_url = 'index.php?m=stat_marketing&a=groupgoods';
