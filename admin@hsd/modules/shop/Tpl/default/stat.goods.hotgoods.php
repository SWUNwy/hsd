...
<div class="page">
  ...
  <div class="ncap-search-bar">
    ...
    <form method="get" action="index.php" name="formSearch" id="formSearch">
      ...
      <input type="hidden" name="a" value="hotgoods" />
...
function getStatdata(type){
	...
	$('#'+type+'_div').load('index.php?m=stat_goods&a=hotgoods_list&type='+type+'&choose_gcid='+choose_gcid+'&t=<?php echo $output['searchtime'];?>');
}
