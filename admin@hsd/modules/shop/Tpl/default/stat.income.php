...
function update_flex(){
	$('.ncap-stat-general-single').load('index.php?m=stat_trade&a=get_plat_income&'+$("#formSearch").serialize(),
		function(){
			$('.timer').each(count);
     	});

    $("#flexigrid").flexigrid({
        url: 'index.php?m=stat_trade&a=get_income_xml&'+$("#formSearch").serialize(),
        colModel : [
...
function fg_operation(name, bDiv){
    var stat_url = 'index.php?m=stat_trade&a=income';
