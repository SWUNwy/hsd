  ...
  <table class="flex-table">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="handle"><a class="btn purple" href="index.php?m=web_config&a=web_edit&web_id=<?php echo $v['web_id'];?>"><i class="fa fa-cog"></i><?php echo $lang['web_config_web_edit'];?></a><a class="btn orange" href="index.php?m=web_config&a=code_edit&web_id=<?php echo $v['web_id'];?>"><i class="fa fa-steam"></i><?php echo $lang['web_config_code_edit'];?></a></td>
