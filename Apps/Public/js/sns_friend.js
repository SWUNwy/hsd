$(function(){
	...
	$("[nc_type='followbtn']").live('click',function(){
        ...
        $.getJSON(MEMBER_SITE_URL + '/index.php?m=m_snsfriend&a=addfollow&mid='+data_str.mid, function(data){
        	if(data){
	...
	$("[nc_type='cancelbtn']").live('click',function(){
		var data_str = $(this).attr('data-param');
        eval( "data_str = "+data_str);
        $.getJSON(MEMBER_SITE_URL + '/index.php?m=m_snsfriend&a=delfollow&mid='+data_str.mid, function(data){
        	if(data){
	...
	$('*[nctype="batchFollow"]').live('click', function(){
		...
		ajax_get_confirm('',MEMBER_SITE_URL + '/index.php?m=m_snsfriend&a=batch_addfollow&ids='+data_str.ids);
	});
});