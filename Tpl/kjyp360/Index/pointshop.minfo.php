...
<div class="ncp-member-point">
  <dl style="border-left: none 0;">
    <a href="<?php echo MEMBER_SITE_URL;?>/index.php?m=m_points" target="_blank">
  ...
  <dl>
    <a href="<?php echo MEMBER_SITE_URL;?>/index.php?m=m_voucher&a=index" target="_blank">
  ...
  <dl>
    <a href="<?php echo MEMBER_SITE_URL;?>/index.php?m=m_pointorder&a=orderlist" target="_blank">
...
<?php if (C('pointprod_isuse')==1){?>
<div class="ncp-memeber-pointcart"> <a href="index.php?m=pointcart" class="btn">礼品兑换购物车<?php if ($output['pointcart_count'] > 0){?><em><?php echo $output['pointcart_count']; ?></em><?php } ?></a></div>
<?php }?>
