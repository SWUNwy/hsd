...
<div class="wrapper pr">
  ...
  <div class="ncc-main">
    ...
    <div class="ncc-receipt-info mb30">
      ...
      <div class="ncc-finish-b">可通过用户中心<a href="<?php echo MEMBER_SITE_URL;?>/index.php?m=m_pointorder&a=orderlist">积分兑换记录</a>查看兑换单状态。 </div>
      <div class="ncc-finish-c mb30"> <a class="ncbtn-mini ncbtn-mint mr15" href="<?php echo SHOP_SITE_URL?>"><i class="icon-shopping-cart"></i>继续购物</a> <a class="ncbtn-mini ncbtn-aqua" href="<?php echo MEMBER_SITE_URL;?>/index.php?m=m_pointorder&a=order_info&order_id=<?php echo $output['order_info']['point_orderid'];?>"><i class="icon-file-text-alt"></i><?php echo $lang['pointcart_step2_view_order'];?></a></div>
    </div>
  </div>
</div>
