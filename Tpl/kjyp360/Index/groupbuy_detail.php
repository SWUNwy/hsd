      ...
      <div class="ncg-evaluate">
        <div class="top">
          ...
          <div class="btns"><span>您可对已购商品进行评价</span>
            <p><a href="<?php if ($output['groupbuy_info']['is_vr']) { echo urlShop('m_vr_order', 'index');} else { echo urlShop('m_order', 'index');}?>" class="ncbtn ncbtn-grapefruit" target="_blank"><i class="icon-comment-alt"></i>评价商品</a></p>
          </div>
        </div>
        <!-- 商品评价内容部分 -->
...
$(function(){
    ...
    <?php if ($output['groupbuy_info']['is_vr']) { ?>
    $("#nc-store-map").load('index.php?m=show_map&a=index&w=420&h=400&store_id=<?php echo $output['groupbuy_info']['store_id'];?>', function(){
        if($(this).html() != '') {
            $(this).show();
        }
    });
