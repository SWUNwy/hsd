...
<div class="wrapper pr">
  ...
  <div class="ncc-main">
    ...
    <table class="ncc-table-style">
      ...
      <tfoot>
        <tr>
          <td colspan="20"><div class="ncc-all-account"><?php echo $lang['pointcart_cart_allpoints']; ?><em id="pcart_amount"><?php echo $output['pgoods_pointall']; ?></em><?php echo $lang['points_unit']; ?></div><a href="index.php?m=pointcart&a=step1" class="ncc-next-submit ok"><?php echo $lang['pointcart_cart_submit']; ?></a></td>
        </tr>
      </tfoot>
    </table>
  </div>
  ...
  <div class="ncc-null-shopping"><i class="ico-gift"></i>
    ...
    <p><a href="index.php?m=pointprod" class="ncbtn-mini mr10"><i class="icon-reply-all"></i><?php echo $lang['pointcart_cart_exchangenow'];?></a> <a href="<?php echo MEMBER_SITE_URL;?>/index.php?m=m_pointorder" class="ncbtn-mini"><i class="icon-file-text"></i><?php echo $lang['pointcart_cart_exchanged_list'];?></a></p>
  </div>
  <?php } ?>
</div>
