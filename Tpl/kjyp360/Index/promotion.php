...
<style type="text/css">
.public-nav-layout, .classtab a.curr, .head-search-bar .search-form, .public-nav-layout .category .hover .class {
	background: #4ba237;
}
.public-head-layout .logo-test, .ncp-category li a.selected {
	color:#4ba237 !important
}
.public-nav-layout .category .sub-class, .ncp-category, #promotionGoods .scope:hover {
	border-color: #4ba237 !important;
}
#box {
	background: #FFF;
	width: 238px;
...
<div class="nch-container wrapper">
  ...
  <div id="promotionGoods">
    <?php require(BASE_TPL_PATH.'/Index/promotion.item.php');?>
  </div>
  <div class="tc mt20 mb20">
    <div class="pagination" id="page-nav"></div>
  </div>
</div>
<div id="page-more"><a href="index.php?m=promotion&gc_id=<?php echo $_GET['gc_id'];?>&curpage=2"></a></div>
