    ...
    <ul class="ncp-voucher-list">
      ...
      <li>
        <div class="ncp-voucher">
          ...
          <div class="button"><a target="_blank" href="###" nc_type="rptexchangebtn" data-param='{"tid":"<?php echo $v['rpacket_t_id'];?>"}' class="ncbtn ncbtn-grapefruit">立即兑换</a></div>
        </div>
      </li>
      <?php }?>
    </ul>
...
function searchrpt(){
	var url = 'index.php?m=pointredpacket&a=index';
