...
<div class="ncp-container">
  ...
  <div class="ncp-member-top">
    <?php include_once BASE_TPL_PATH.'/Index/pointshop.minfo.php'; ?>
  </div>
  <?php } ?>
    ...
    <ul class="ncp-voucher-list">
      ...
      <li>
        <div class="ncp-voucher">
          ...
          <div class="button"><a target="_blank" href="###" nc_type="exchangebtn" data-param='{"vid":"<?php echo $v['voucher_t_id'];?>"}' class="ncbtn ncbtn-grapefruit">立即兑换</a></div>
        </div>
      </li>
      <?php }?>
    </ul>
...
function searchvoucher(){
	var url = 'index.php?m=pointvoucher&a=index';
	var sc_id = $("#sc_id").val();
	if(sc_id){
		url += ('&sc_id='+sc_id);
	}
