...
<link href="<?php echo SHOP_TEMPLATES_URL;?>/css/index_1.css" rel="stylesheet" type="text/css">
...
<script type="text/javascript" src="<?php echo RESOURCE_SITE_URL;?>/js/js/lazyload.js"></script>
<script type="text/javascript" src="<?php echo RESOURCE_SITE_URL;?>/js/js/index.js"></script>
...
$(function(){
	...
	$('#keyword').focus(function(){
        ...
        source: function (request, response) {
            $.getJSON('<?php echo SHOP_SITE_URL;?>/index.php?m=search&a=auto_complete', request, function (data, status, xhr) {
	...
	$('#button').click(function(){
      if ($('#keyword').val() == '') {
        ...
        window.location.href="<?php echo SHOP_SITE_URL?>/index.php?m=search&a=index&keyword="+$('#keyword').attr('data-value');
          return false;
      }
      }
  });
  ...
  <header class="public-head-layout wrapper">
    ...
    <div class="head-search-layout">
     ...
     <div class="hd_serach_tab" id="hdSearchTab">
      <ul><li m="search" class="current"><span>商品</span><i class="arrow"></i></li><li m="store_list"><span>店铺</span></li></ul>
<i></i>
</div>
    ...
    <div class="mod_minicart" style="">
		<a id="nofollow" target="_self" href="<?php echo SHOP_SITE_URL;?>/index.php?m=cart" class="mini_cart_btn">
                        <i class="cart_icon"></i> 
		...
		<div id="minicart_list" class="minicart_list">
			...
			<div class="list_detail">
				...
				<div class="checkout_box">
					...
					<a rel="nofollow" class="checkout_btn" href="<?php echo SHOP_SITE_URL;?>/index.php?m=cart" target="_self"> 去结算 </a>
				</div>
...
<!--    <div class="head-user-menu">
      <dl class="my-cart">
        ...
        <dd>
          ...
          <div class="checkout"> <span class="total-price">共<i><?php echo $output['cart_goods_num'];?></i><?php echo $lang['nc_kindof_goods'];?></span><a href="<?php echo SHOP_SITE_URL;?>/index.php?m=cart" class="btn-cart">结算购物车中的商品</a> </div>
        </dd>
      </dl>
    </div>-->
  </header>
...
<nav class="public-nav-layout <?php if($output['channel']) {echo 'channel-'.$output['channel']['channel_style'].' channel-'.$output['channel']['channel_id'];} ?>">
  ...
  <div class="title_menu">
	<div class="title_menu1">
      ...
      <li class="navitems-on"><a href="<?php echo urlShop('show_groupbuy', 'index');?>" <?php if($output['index_sign'] == 'groupbuy' && $output['index_sign'] != '0') {echo 'class="current"';} ?>><?php echo $lang['nc_groupbuy'];?></a></li>
      <?php } ?>
