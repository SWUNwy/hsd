...
<div class="title"><i></i>
  <h3><a href="<?php echo urlShop('category', 'index');?>">全部商品分类</a></h3>
</div>
<div class="category">
  <ul class="menu">
    ...
    <li cat_id="<?php echo $val['gc_id'];?>" class="<?php echo $i%2==1 ? 'odd':'even';?>" <?php if($i>14){?>style="display:none;"<?php }?>>
      <div class="class">
        ...
        <?php } ?>
        <h4><a href=" <?php if (!empty($val['channel_id']))echo urlShop('channel','index',array('id'=> $val['channel_id']));else echo urlShop('search','index',array('cate_id'=> $val['gc_id']));?>"><?php echo $val['gc_name'];?></a></h4>
      ...
      <div class="sub-class" cat_menu_id="<?php echo $val['gc_id'];?>">
        <div class="sub-class-content">
          ...
          <dl>
            <dt>
              <h3><a href="<?php if (!empty($v['channel_id']))echo urlShop('channel','index',array('id'=> $v['channel_id']));else echo urlShop('search','index',array('cate_id'=> $v['gc_id']));?>"><?php echo $v['gc_name'];?></a></h3>
            </dt>
        ...
        <div class="sub-class-right">
          ...
          <div class="brands-list">
            <ul>
              ...
              <li> <a href="<?php echo urlShop('brand', 'list', array('brand'=>$brand['brand_id']));?>" title="<?php echo $brand['brand_name'];?>">
                <?php if ($brand['brand_pic'] != '') {?>
                <img src="<?php echo brandImage($brand['brand_pic']);?>"/>
                <?php }?>
                <span><?php echo $brand['brand_name'];?></span></a></li>
              <?php }?>
            </ul>
          </div>
          <?php }?>
