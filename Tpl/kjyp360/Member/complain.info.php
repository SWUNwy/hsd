          ...
          <dd>
            ...
            <?php echo $lang['complain_pic_none'];?>
                <?php if((intval($output['complain_info']['complain_state']) < 99)) { ?>
                    ...
                    <form style="display: none;" id="post_add_pic_form" method="post" action="index.php?m=m_complain&a=complain_add_pic&complain_id=<?php echo $output['complain_info']['complain_id']; ?>" enctype="multipart/form-data">
