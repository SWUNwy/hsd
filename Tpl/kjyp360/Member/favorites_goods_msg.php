<div class="eject_con">
  <form id="post_form" method="post" action="index.php?m=m_favorite_goods&a=log_msg&log_id=<?php echo $output['favorites']['log_id']; ?>" onsubmit="ajaxpost('post_form','','','onerror')">
