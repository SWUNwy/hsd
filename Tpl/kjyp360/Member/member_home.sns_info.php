      ...
      <?php if (!empty($output['follow_list']) && is_array($output['follow_list'])) { ?>
       <div class="ncm-friends-share">
            ...
            <?php foreach($output['follow_list'] as $k => $v){ ?>
              <li>
                <div class="ncm-friend-avatar"><a href="index.php?m=m_snshome&a=trace&mid=<?php echo $v['member_id'];?>" target="_blank"><img  src="<?php if ($v['member_avatar']!='') { echo UPLOAD_SITE_URL.'/'.ATTACH_AVATAR.DS.$v['member_avatar']; } else { echo UPLOAD_SITE_URL.'/'.ATTACH_COMMON.DS.C('default_user_portrait'); } ?>"></a></div>
                <dl>
                  <dt class="ncm-friend-name"><a href="index.php?m=m_snshome&a=trace&mid=<?php echo $v['member_id'];?>" target="_blank"><?php echo $v['friend_tomname']; ?></a></dt>
                  <dd>动态<?php echo $output['tracelist'][$v['member_id']];?>条</dd>
                </dl>
              </li>
            <?php } ?>
            </ul>
            <div class="more"><a target="_blank" href="<?php echo MEMBER_SITE_URL;?>/index.php?m=m_snsfriend&a=follow">查看我的全部好友</a></div>
          </div>
     <?php } else { ?>
      <dl class="null-tip">
        <dt></dt>
        <dd>
          ...
          <p><a target="_blank" href="<?php echo MEMBER_SITE_URL;?>/index.php?m=m_snsfriend&a=follow" class="ncbtn-mini" >查看我的全部好友</a></p>
        </dd>
      </dl>
    <?php } ?>  
    </div>
    ...
    <?php if(!empty($output['circle_list'])){?>
      <div class="ncm-circle">
            <ul id="circleList" class="jcarousel-skin-tango">
              ...
              <li>
                <div class="ncm-circle-pic"><a href="<?php echo CIRCLE_SITE_URL;?>/index.php?m=group&c_id=<?php echo $val['circle_id'];?>" target="_blank"><img alt="" src="<?php echo circleLogo($val['circle_id']);?>"></a></div>
                <dl>
                  <dt><a href="<?php echo CIRCLE_SITE_URL;?>/index.php?m=group&c_id=<?php echo $val['circle_id'];?>" target="_blank"><?php echo $val['circle_name']?></a></dt>
                  <dd><?php echo $val['circle_mcount'];?>个成员</dd>
                </dl>
              </li>
            <?php } ?>
            </ul>
            <div class="more"><a target="_blank" href="<?php echo CIRCLE_SITE_URL;?>/index.php?m=p_center&a=my_group">查看我的所有圈子</a></div>
          </div>
      <?php } else {?>
      <dl class="null-tip">
        <dt></dt>
        <dd>
          ...
          <p><a target="_blank" href="<?php echo CIRCLE_SITE_URL;?>/index.php?m=index&a=add_group" class="ncbtn-mini">创建圈子</a></p>
        </dd>
      </dl>
      <?php } ?>
    </div>
  ...
  <div id="browseMark" class="normal">
    <div class="outline">
      ...
      <div class="ncm-browse-mark">
            ...
            <div class="more"><a href="<?php echo SHOP_SITE_URL;?>/index.php?m=m_goodsbrowse&a=list" target="_blank">查看所有商品</a></div>
          </div>
       <?php } else { ?>
          <dl class="null-tip">
            <dt></dt>
