<div class="eject_con">
  ...
  <form method="post" action="index.php?m=m_vr_order&a=change_state&state_type=order_cancel&order_id=<?php echo $output['order_info']['order_id']; ?>" id="order_cancel_form" onsubmit="ajaxpost('order_cancel_form','','','onerror')">
