...
<div class="wrap">
  ...
  <form method="get" action="index.php" target="_self">
    <table class="ncm-search-table">
      <input type="hidden" name="m" value="member_vr_order" />
      <tr>
        <td>&nbsp;</td>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td> <?php if($order_info['if_refund']){ ?>
          <a href="index.php?m=m_vr_refund&a=add_refund&order_id=<?php echo $order_info['order_id']; ?>">退款</a>
          <?php } ?></td>
        ...
        <td class="bdl"><p><?php echo $order_info['state_desc'];?></p>
          <p><a href="index.php?m=m_vr_order&a=show_order&order_id=<?php echo $order_info['order_id'];?>">订单详情</a></p></td>
        <td class="bdl bdr">

		  <?php if($order_info['if_pay']){ ?>
          <p><a class="ncbtn ncbtn-bittersweet" href="index.php?m=buy_virtual&a=pay&order_id=<?php echo $order_info['order_id']; ?>"><i class="icon-shield"></i>订单支付</a></p>
          <?php } ?>
          ...
          <p><a class="ncbtn ncbtn-aqua" href="index.php?m=m_evaluate&a=add_vr&order_id=<?php echo $order_info['order_id']; ?>"><i class="icon-thumbs-up-alt"></i><?php echo $lang['member_order_want_evaluate'];?></a></p>
          <?php } ?>
