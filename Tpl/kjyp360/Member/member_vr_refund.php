...
<div class="wrap">
  ...
  <form method="get" action="index.php">
    <input type="hidden" name="m" value="member_vr_refund" />
    ...
    <tbody>
      ...
      <tr class="bd-line" >
        ...
        <td class="tl"><dl class="goods-name">
            ...
            <dd><?php echo $lang['refund_order_ordersn'].$lang['nc_colon'];?><a href="index.php?m=m_vr_order&a=show_order&order_id=<?php echo $val['order_id']; ?>" target="_blank"><?php echo $val['order_sn'];?></a></dd>
          </dl></td>
        <td><?php echo $val['refund_amount'];?></td>
        <td><?php echo $output['admin_array'][$val['admin_state']]; ?></td>
        <td class="bdr"><a href="index.php?m=m_vr_refund&a=view&refund_id=<?php echo $val['refund_id']; ?>" class="ncbtn"><?php echo $lang['nc_view'];?> </a></td>
      </tr>
      <?php } ?>
    </tbody>
    <tfoot>
