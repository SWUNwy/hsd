<?php defined('ByShopKJYP') or exit('Access Invalid!');?>
  ...
  <div class="ncm-flow-item">
    ...
    <div class="item-order">
      ...
      <dl class="line">
        <dt>订单编号：</dt>
        <dd><a target="_blank" href="index.php?m=m_vr_order&a=show_order&order_id=<?php echo $output['order']['order_id']; ?>"><?php echo $output['order']['order_sn'];?></a>
      ...
      <dl class="line">
        <dt>商&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;家：</dt>
        <dd><?php echo $output['order']['store_name'];?><a href="javascript:void(0)" class="ncbtn a" nc_type="dialog" dialog_width="800" dialog_title="查看地图" dialog_id="show_map" uri="index.php?m=show_map&a=index&w=440&h=400&store_id=<?php echo $output['order']['store_id'];?>">商家所在信息
          </a>
        </dd>
      </dl>
    </div>
