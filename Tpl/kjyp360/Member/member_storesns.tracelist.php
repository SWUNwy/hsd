...
<div id="lazymodule">
  ...
  <ul class="fd-list">
    ...
    <div class="fd-aside"> <span class="thumb size60"><i></i> <a href="index.php?m=store_snshome&sid=<?php echo $val['strace_storeid'];?>" target="_blank"> <img onload="javascript:DrawImage(this,60,60);" src="<?php echo getStoreLogo($val['strace_storelogo']);?>"> </a> </span> </div>
      <dl class="fd-wrap">
        <dt>
          <h3><a href="index.php?m=store_snshome&sid=<?php echo $val['strace_storeid'];?>" target="_blank"><?php echo $val['strace_storename'];?></a><?php echo $lang['nc_colon'];?></h3>
          ...
          <div id="forward_<?php echo $val['strace_id'];?>" style="display:none;">
            <div class="forward-widget">
              <div class="forward-edit">
                <form id="forwardform_<?php echo $val['strace_id'];?>" method="post" action="index.php?m=store_snshome&a=addforward">
