...
<div class="wrap">
  ...
  <form id="list_form" method="get">
    <table class="ncm-search-table">
      <input type="hidden" id='m' name='m' value='member_inform' />
      <input type="hidden" id='a' name='a' value='inform_list' />
      <tr>
        <td></td>
  ...
  <table class="ncm-default-table">
    ...
    <tbody>
      ...
      <tr class="bd-line">
        ...
        <td class="ncm-table-handle"><span><a href="index.php?m=m_inform&a=inform_info&inform_id=<?php echo $val['inform_id']; ?>" class="btn-bluejeans"><i class="icon-eye-open"></i>
          <p><?php echo $lang['nc_view'];?></p>
          </a></span>
          <?php if($val['inform_state']==='1') { ?>
          <span><a class="btn-bittersweet" href="javascript:void(0)" onclick="ajax_get_confirm('<?php echo $lang['inform_cancel_confirm'];?>', 'index.php?m=m_inform&a=inform_cancel&inform_id=<?php echo $val['inform_id']; ?>');"><i class="icon-ban-circle"></i>
