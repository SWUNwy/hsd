...
<h3><?php echo $lang['talk_detail'];?></h3>
  ...
  <form action="index.php?m=m_complain&a=apply_handle" method="post" id="handle_form">
...
function get_complain_talk() {
    ...
    $.ajax({
        type:'POST',
        url:'index.php?m=m_complain&a=get_complain_talk',
        cache:false,
...
function publish_complain_talk() {
        $.ajax({
            type:'POST',
                url:'index.php?m=m_complain&a=publish_complain_talk',
                cache:false,
