...
<div class="left-content">
  ...
  <div id="pictureFolder" class="album">
    <div class="intro mb20">
      <div class="covers"><span class="thumb size60"><i></i><a href="index.php?m=sns_album&a=album_pic_list&id=<?php echo $output['class_info']['ac_id']?>">
...
<script type="text/javascript">
  $(function() {
	...
	$('.ad-back').live('click',function(){
		...
		$('.ad-thumb-list').load('index.php?m=sns_album&a=album_pic_scroll_ajax&id=<?php echo $_GET['id'];?>&class_id=<?php echo $_GET['class_id'];?>&mid=<?php echo $_GET['mid'];?>&curpage='+curpage);
	});
...
function ajax_change_imgmessage(url){
	...
	$.getJSON("<?php echo SHOP_SITE_URL; ?>/index.php?m=sns_album&a=ajax_change_imgmessage&mid=<?php echo $output['master_id'];?>", {'url':url}, function(data){
