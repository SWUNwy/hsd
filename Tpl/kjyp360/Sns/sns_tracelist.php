...
<div id="lazymodule">
  ...
  <div class="sns-norecord ml200"><i class="trace-ico pngFix"></i><span><?php echo $lang['sns_trace_nohave_self_1'];?><a href="<?php echo MEMBER_SITE_URL;?>/index.php?m=m_snsfriend&a=find"><?php echo $lang['sns_trace_nohave_self_2'];?></a><?php echo $lang['sns_trace_nohave_self_3'];?></span></div>
  <?php } else { ?>
