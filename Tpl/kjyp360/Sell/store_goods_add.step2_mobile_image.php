...
<div class="goods-gallery add-step2"><a class='sample_demo' id="select_submit" href="index.php?m=store_album&a=pic_list&item=goods" style="display:none;"><?php echo $lang['nc_submit'];?></a>
...
$(function(){
    ...
    $('#jumpMenu').change(function(){
        $('[nctype="mea_img"]').load('index.php?m=store_album&a=pic_list&item=mobile<?php if ($output['type'] == 'replace') {?>&type=replace<?php }?>&id=' + $(this).val());
    });
});
</script>