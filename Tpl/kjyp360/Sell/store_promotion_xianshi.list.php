...
<form method="get">
  <table class="search-form">
    <input type="hidden" name="m" value="store_promotion_xianshi" />
    <input type="hidden" name="a" value="xianshi_list" />
    <tr>
      <td>&nbsp;</td>
      <th>状态</th>
  ...
  <tbody id="xianshi_list">
    <tr class="bd-line">
      ...
      <td class="nscs-table-handle tr"><?php if($val['editable']) { ?>
        <span> <a href="index.php?m=store_promotion_xianshi&a=xianshi_edit&xianshi_id=<?php echo $val['xianshi_id'];?>" class="btn-bluejeans"> <i class="icon-edit"></i>
        <p><?php echo $lang['nc_edit'];?></p>
        </a> </span>
        <?php } ?>
        <span> <a href="index.php?m=store_promotion_xianshi&a=xianshi_manage&xianshi_id=<?php echo $val['xianshi_id'];?>" class="btn-mint"> <i class="icon-cog"></i>
