...
<?php if ($output['isOwnShop']) { ?>
  <a class="ncbtn ncbtn-mint"  href="index.php?m=store_promotion_bundling&a=bundling_add" ><i class="icon-plus-sign"></i><?php echo $lang['bundling_add'];?></a>

<?php } else { ?>

  <?php if (empty($output['bundling_quota'])) { ?>
  <a href="javascript:void(0)" class="ncbtn ncbtn-aqua" onclick="go('index.php?m=store_promotion_bundling&a=bundling_quota_add');" title="<?php echo $lang['bundling_quota_add'];?>"><i class="icon-money"></i><?php echo $lang['bundling_quota_add'];?></a>
  ...
  <a class="ncbtn ncbtn-mint"  href="index.php?m=store_promotion_bundling&a=bundling_add" style="right:100px"><i class="icon-plus-sign"></i><?php echo $lang['bundling_add'];?></a>
  <?php }?>
  <a class="ncbtn ncbtn ncbtn-aqua" href="index.php?m=store_promotion_bundling&a=bundling_renew"><i class="icon-money"></i>套餐续费</a>
  <?php } ?>
<?php } ?>
...
<?php } ?>
<form method="get">
  <input type="hidden" name="m" value="store_promotion_bundling" />
  <input type="hidden" name="a" value="bundling_list" />
...
<table class="ncsc-default-table">
  <thead>
    ...
    <tr>
      ...
      <td colspan="20"><label for="all" ><?php echo $lang['nc_select_all'];?></label>
        <a href="javascript:void(0);" class="ncbtn-mini" nc_type="batchbutton" uri="index.php?m=store_promotion_bundling&a=drop_bundling" name="bundling_id" confirm="<?php echo $lang['nc_ensure_del'];?>"><i class="icon-trash"></i><?php echo $lang['nc_del'];?></a></td>
    </tr>
  </thead>
  ...
  <tbody>
    <tr class="bd-line">
      ...
      <td class="nscs-table-handle"><span><a href="index.php?m=store_promotion_bundling&a=bundling_add&bundling_id=<?php echo $val['bl_id'];?>" class="btn-bluejeans"><i class="icon-cog"></i>
  ...
  <tfoot>
    <tr>
      ...
      <th colspan="20"><label for="all" ><?php echo $lang['nc_select_all'];?></label>
        <a href="javascript:void(0);" class="ncbtn-mini" nc_type="batchbutton" uri="index.php?m=store_promotion_bundling&a=drop_bundling" name="bundling_id" confirm="<?php echo $lang['nc_ensure_del'];?>"><i class="icon-trash"></i><?php echo $lang['nc_del'];?></a></th>
    </tr>
    <tr>
