...
<form method="get" action="index.php">
  <table class="search-form">
    <input type="hidden" name='m' value='store_complain' />
    <tr>
      <td>&nbsp;</td>
  ...
  <tbody>
    ...
    <tr class="bd-line">
      ...
      <td><?php
				...
				?></td>
      <td class="nscs-table-handle"><span><a href="index.php?m=store_complain&a=complain_show&complain_id=<?php echo $val['complain_id'];?>" class="btn-bittersweet"><i class="icon-eye-open"></i>
