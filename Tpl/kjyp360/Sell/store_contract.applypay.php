...
<form id="pay_form" method="post" enctype="multipart/form-data" action="index.php?m=store_contract&a=applypay">
	<input type="hidden" id="m" name="m" value="store_contract"/>
	<input type="hidden" id="a" name="a" value="applypay"/>
