...
<div class="ncsc-form-default">
  <form id="add_form" action="index.php?m=store_groupbuy&a=groupbuy_save&vr=1" method="post" enctype="multipart/form-data">
    <dl>
    ...
    <dl>
      <dt>团购副标题<?php echo $lang['nc_colon'];?></dt>
      <dd>
...
<?php } ?>
    ...
    <dl>
      <dt><i class="required">*</i>团购活动图片<?php echo $lang['nc_colon'];?></dt>
      <dd>
    ...
    <dl>
      <dt>团购推荐位图片<?php echo $lang['nc_colon'];?></dt>
      <dd>
    ...
    <dl>
      <dt>团购分类<?php echo $lang['nc_colon'];?></dt>
      <dd>
    ...
    <dl>
      <dt>团购区域<?php echo $lang['nc_colon'];?></dt>
      <dd>
    ...
    <dl>
      ...
      <dd>
        ...
        <p class="hr8"><a class="des_demo ncbtn" href="index.php?m=store_album&a=pic_list&item=groupbuy"><i class="icon-picture"></i><?php echo $lang['store_goods_album_insert_users_photo'];?></a></p>
...
$("select[name=class]").change(function(){
    ...
    $.ajax({
        type:'GET',
        url:'index.php?m=store_groupbuy&a=ajax_vr_class&class_id='+class_id,
...
$("select[name=city]").change(function(){
    ...
    $.ajax({
        type:'GET',
        url:'index.php?m=store_groupbuy&a=ajax_vr_area&area_id='+area_id,
        success:function(json){
            var html = '<option value="">'+'请选择...'+'</option>';
