...
<form method="get" action="index.php" target="_self">
  <table class="search-form">
    <input type="hidden" name="m" value="statistics_industry" />
...
<div class="alert alert-block alert-info"><strong>客单价分布</strong>（<a href="index.php?m=statistics_general&a=pricesetting" target="_blank">设置价格区间</a>）</div>
  ...
  <tbody>
	<tr id="row_0">
		<td class="tl">
    		...
    		<?php } else { ?>
    		<div class="tc h50 mt10">查看分布情况前，请先设置价格区间。<a href="index.php?m=statistics_general&a=pricesetting" target="_blank">马上设置</a></div>
    		<?php }?>
		</td>
	</tr>
  </tbody>
