...
<div class="tabmenu"><?php include template('Layouts/submenu');?><a href="javascript:void(0)" class="ncbtn ncbtn-mint addreply" title="添加账号"><i class="icon-group"></i>添加回复</a></div> 
