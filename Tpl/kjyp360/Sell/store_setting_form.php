...
<div class="ncsc-form-default">
  <form method="post"  action="index.php?m=store_setting&a=store_setting" enctype="multipart/form-data" id="my_store_form">
...
$(function(){
	...
	function ajaxFileUpload()
	{
		...
		(
			{
				url:'index.php?m=cut&a=pic_upload&form_submit=ok&uploadpath=<?php echo ATTACH_STORE;?>',
				secureuri:false,
				fileElementId:'_pic',
				dataType: 'json',
				...
				{
					if (data.status == 1){
						ajax_form('cutpic','<?php echo $lang['nc_cut'];?>','index.php?m=cut&a=pic_cut&x=100&y=100&resize=1&url='+data.url,680);
					}else{
