...
<div class="ncsc-form-default">
  ...
  <form id="add_form" action="index.php?m=store_promotion_bundling&a=bundling_quota_add" method="post">
  <?php } else {?>
  <form id="add_form" action="index.php?m=store_promotion_bundling&a=bundling_renew" method="post">
  <?php }?>
