...
<div class="tabmenu"><?php include template('Layouts/submenu');?><a class="ncbtn ncbtn-mint" ectype="dialog" dialog_title="新增分类" dialog_id="my_category_add" dialog_width="480" uri="index.php?m=seller_wechat_menu&a=add"><i class="icon-plus-sign"></i>添加分类</a></div> 
...
<form method="post" enctype="multipart/form-data" id="profile_form" action="index.php?m=seller_wechat_menu">
                ...
                <tr class="line<?php if($key == $count){ ?> last_line<?php } ?>" ectype="table_item" idvalue="<?php echo $gcate['cate_id'];?>">
                    ...
                    <td class="padding5">
					    <?php if($gcate['layer'] < 2){ ?>
                         <a href="javascript:void(0);" ectype="dialog" dialog_width="500" dialog_title="新增下级" dialog_id="my_category_add" uri="index.php?m=seller_wechat_menu&a=add&pid=<?php echo $gcate['cate_id'];?>" class="add1_ico">新增下级</a>
						<?php } ?>
                        <a href="javascript:void(0);" ectype="dialog" dialog_width="480" dialog_title="编辑" dialog_id="my_category_edit" uri="index.php?m=seller_wechat_menu&amp;a=edit&amp;id=<?php echo $gcate['cate_id'];?>" class="edit1">编辑</a>  <a href="javascript:drop_confirm('删除该分类将会同时删除该分类的所有下级分类，您确定要删除吗', 'index.php?m=seller_wechat_menu&amp;a=drop&id=<?php echo $gcate['cate_id'];?>');" class="delete">删除</a>
                ...
                <div class="information">
                        <div class="info individual">
                            <table>
                                 ...
                                 <tr>
                                    <td >
                                    <a href="index.php?m=seller_wechat_menu&amp;a=creat_menu"  onclick="return confirm('是否生成自定义菜单？');" ><input type="button" class="biz_pub_btn" value="生成菜单" /></a>
                                    <a href="index.php?m=seller_wechat_menu&amp;a=delete_menu"  onclick="return confirm('是否删除已有的自定义菜单？');" ><input type="button" class="biz_pub_btn" value="删除自定义菜单" /></a>
                                    </td>
                                </tr>
                        </table>	
                        </div>
