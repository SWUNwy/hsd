...
<form method="get">
  <table class="search-form">
    <input type="hidden" name="m" value="store_promotion_cou" />
    <input type="hidden" name="a" value="cou_list" />
    <tr>
      <td>&nbsp;</td>
      <th>状态</th>
  ...
  <tbody id="cou_list">
    <tr class="bd-line">
      ...
      <td class="nscs-table-handle tr">
          ...
          <span>
              <a href="index.php?m=store_promotion_cou&a=cou_edit&cou_id=<?php echo $val['id'];?>" class="btn-bluejeans">
                  <i class="icon-edit"></i>
