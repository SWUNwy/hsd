...
<div class="eject_con">
 <div class="adds">
        <div id="warning"></div>
        <form id="category_form" method="post" target="pop_warning" action="index.php?m=seller_wechat_menu&amp;a=<?php echo $output['op'];?><?php if($output['id']){ ?>&amp;id=<?php echo $output['id'];?><?php } ?>">
        <ul>
            <li>
                <h3>分类名称:</h3>
            ...
            <li>
                ...
                <p>
                 ...
                 <b style="color:red;">选择URL类型：关键词不用填,key值直接填链接<br>微商城 首页 先选择URL类型  URL链接地址：例如http://www.513nc.com/index.php?m=show_store&a=index&store_id=1<br>
