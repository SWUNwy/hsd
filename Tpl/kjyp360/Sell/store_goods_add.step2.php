...
<div class="item-publish">
  <form method="post" id="goods_form" action="<?php if ($output['edit_goods_sign']) { echo urlShop('store_goods_online', 'edit_save_goods');} else { echo urlShop('store_goods_add', 'save_goods');}?>">
    ...
    <div class="ncsc-form-goods">
      ...
      <dl>
        <dt nc_type="no_spec"><i class="required">*</i><?php echo "可抵金币".$lang['nc_colon'];?></dt>
        <dd nc_type="no_spec">
          <input name="g_points" value="<?php echo $output['goods']['goods_points']; ?>" type="text"  class="text w60" /><em class="add-on"><i class="icon-renminbi"></i></em> <span></span>
          <p class="hint">可抵用金币</p>
        </dd>
      </dl>
      <dl>
      ...
      <dl>
        <dt nc_type="no_spec"><i class="required">*</i><?php echo "VIP价".$lang['nc_colon'];?></dt>
        <dd nc_type="no_spec">
          <input name="g_vipprice" value="<?php echo ncPriceFormat($output['goods']['goods_vipprice']); ?>" type="text"  class="text w60" /><em class="add-on"><i class="icon-renminbi"></i></em> <span></span>
          <p class="hint">VIP价</p>
        </dd>
      </dl>        
      <dl>
          ...
          <div class="tabs">
            ...
            <div id="panel-1" class="ui-tabs-panel">
              ...
              <div class="hr8">
                ...
                <a class="ncbtn mt5" nctype="show_desc" href="index.php?m=store_album&a=pic_list&item=des"><i class="icon-picture"></i><?php echo $lang['store_goods_album_insert_users_photo'];?></a> <a href="javascript:void(0);" nctype="del_desc" class="ncbtn mt5" style="display: none;"><i class=" icon-circle-arrow-up"></i>关闭相册</a> </div>
              <p id="des_demo"></p>
            </div>
