...
<form method="get" action="index.php" target="_self">
  <table class="search-form">
    <input type="hidden" name="m" value="statistics_goods" />
    <input type="hidden" name="a" value="price" />
    <tr>
    	<td class="tr">
    		<div class="fl"><a class="ncbtn-mini tip" title="点击进入设置价格区间页面，下方统计图将根据您设置的价格区间进行统计" href="index.php?m=statistics_general&a=pricesetting" target="_blank">设置价格区间</a></div>
    		<div class="fr">
  ...
  <tbody>
	<tr id="row_0">
		<td class="tl">
    		...
    		<?php } else { ?>
    		<div class="tc h50 mt10">查看分布情况前，请先设置价格区间。<a href="index.php?m=statistics_general&a=pricesetting">马上设置</a></div>
    		<?php }?>
		</td>
	</tr>
  </tbody>
