...
<script type="text/javascript" src="<?php echo SHOP_RESOURCE_SITE_URL;?>/js/store_cart.js"></script>
...
<div style="" class="pos-f about-wrap" id="aboutWrap">
  <div class="item por-r">
    <div class="pos-a item-box"> <a target="_blank" href="tencent://message/?uin=903387721"> <i class="iconfont mr-5"></i> 企业QQ咨询 </a></div>
...
<div class="header clearfix bg-red pos-r">
  ...
  <div class="pl-20 pr-10 height-30 pt-15 fs-16 first-menu">
    ...
    <?php if(!empty($output['menu']) && is_array($output['menu'])) {?>
      ...
      <span class="mr-40 pos-r d-ib"> <a href="index.php?m=<?php echo $menu_value['child'][key($menu_value['child'])]['m'];?>&a=<?php echo $menu_value['child'][key($menu_value['child'])]['a'];?>" class="cor-w cur-p <?php echo $menu_value['name'] == "商品"?'active':'';?>"><?php echo $menu_value['name'];?><span>■</span></a> </span>       
      <?php } ?>
      <?php } ?>  
...
<div class="ncc-wrapper" id="con-container">
...
<div class="main" style="margin-left: 0;max-width: 1200px">
