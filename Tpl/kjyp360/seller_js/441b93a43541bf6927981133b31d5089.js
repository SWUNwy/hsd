...
function() {
	...
	var util = {
		...
		mergeUrl: function(e, t) {
			...
			for (var c in t) a[c] = t[c];
			for (var c in a) n.push(c + "=" + (a[c] || ""));
			return i + "?" + n.join("&")
		},
		query2Object: function(e, t) {
			...
			for (var a = 0; a < n.length; a++) {
				var c = n[a],
					o = (c || "").split("="),
					r = o.shift();
				if (r) i[decodeURIComponent(r)] = decodeURIComponent(o.join("="));
				else;
			}
			return i
		},
			...
			each({
				...
				try {
					...
					if (!t(a, n)) {
						...
						e["profile"] = JSON.stringify(a)
					}
				} catch (o) {
					console.error("parse profile error: [crm]" + n, o)
				}
			});
...
//			}
	...
	ysf.openInline = function(e, t) {
		...
		if (n) {
			...
			util.addEvent(chatProxy, "load", function() {
				...
				else if (0 == t && 1 == cache["pushswitch"]) sendChatMsg("dopushmsg", {
					pushMsgSwitch: 1,
	...
	ysf.invite = function() {
		...
		var c = function() {
				if (!e || !t) {
					...
					var n = t.childNodes[0],
						a = n.childNodes,
						c = a[0];
					if ("innerText" in c) c.innerText = i.text;
					else c.textContent = i.text;
					n.onclick = s;
					a[1].onclick = l;
					a[2].onload = function() {
		...
		var f = function() {
				a.appendChild(t);
				o(ysf.RESROOT + "res/nej_blank.gif")
			};
		var d = function() {
	...
	ysf.NotifyMsgAndBubble = function(e) {
		var t = {
			...
			notifyCircle: function(e) {
				...
				var c = document.getElementById("YSF-PANEL-CORPINFO") || document.getElementById("YSF-PANEL-INFO");
				var o = {
					image: function(e) {
						return "[图片]"
					},
				...
				if (0 == c.getAttribute("data-switch") && o[e.data.type] && 0 == cache["sdkCustom"]) {
					a.style.display = "block";
					n.style.display = "block";
					a.innerHTML = e.data.circleNum > 99 ? "99+" : e.data.circleNum;
					i.innerHTML = o[e.data.type](e.data.notifyCnt)
				}
			}
		};
		var n = t[e.category];
...
var __YSFOPTION__ = {
	...
	sdkCustom: 1,
	hidden: 0,
	appKey: '441b93a43541bf6927981133b31d5089'
};
