...
<div class="ncc-main">
  <div class="ncc-title">
    ...
    <?php include template('Newsell/buy_address');?>
    
    <?php if ($output['current_goods_info']['is_book']) { ?>
        <?php include template('Newsell/buy_book_goods');?>
    <?php } else { ?>
        <?php include template('Newsell/buy_goods_list');?>
    <?php } ?>

    <input value="store_buy" type="hidden" name="m">
