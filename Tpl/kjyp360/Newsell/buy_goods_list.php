...
>
		...
		<?php }?>"><?php if ($cart_info['state'] && $cart_info['storage_state']) {?>
          ...
          <?php } ?></td>
        <?php if ($cart_info['bl_id'] == '0') {?>
        <td class="w100"><a href="javascript:void(0)" target="_blank" class="ncc-goods-thumb"><img src="<?php echo thumb($cart_info);?>" alt="<?php echo $cart_info['goods_name']; ?>" /></a></td>
        <?php } ?>
        <td class="tl" <?php if ($cart_info['bl_id'] != '0') {?>colspan="2"<?php }?>><dl class="ncc-goods-info">
            <dt>
              ...
              【套装】
              <?php }?>
            <a href="javascript:void(0)" target="_blank"><?php echo $cart_info['goods_name']; ?></a>
      ...
      <tr class="shop-list <?php echo $cart_info['state'] && $cart_info['storage_state'] ? '' : 'item_disabled';?>  bundling-list">
        ...
        <td><a href="javascript:void(0)" target="_blank" class="ncc-goods-thumb"><img src="<?php echo cthumb($goods_info['goods_image'],$store_id);?>" alt="<?php echo $goods_info['goods_name']; ?>" /></a></td>
        <td class="tl"><dl class="ncc-goods-info">
      ...
      <?php } ?>
      <tr>
        <td colspan="20"><div class="ncc-msg" style="display: none;">买家留言：
    ...
    <tfoot>
      ...
      <tr>
        <td colspan="20"><?php if(!empty($output['ifcart'])){?>
          <a href="index.php?m=store_cart" class="ncc-prev-btn"><i class="icon-angle-left"></i><?php echo $lang['cart_step1_back_to_cart'];?></a>
          <?php }?>
...
function calcOrder() {
    ...
    $('em[nc_type="eachStoreTotal"]').each(function(){
      ...
      if($('#eachStorePoints_'+store_id).length > 0) {   	
       	eachTotal += parseFloat($('#eachStorePoints_'+store_id).html());       	
	    }
