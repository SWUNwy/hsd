...
<div class="content cf" id="con-container">
  ...
  <div class="pageMain bg-e">
    ...
    <div class="inner-header pt-30 bg-w clearfix bb-1" id="navBox">
      <div class="fixed-container">
        <div class="clearfix" id="searchInputHeader">
          ...
          <div class="f-r clearfix searchBox">
            <div class="clearfix">
              ...
              <a class="cart-head-btn f-l ml-10" target="_blank" href="index.php?m=cart" data-rpno="20.2"><i class="iconfont mr-10" style="font-size: 16px">&#xe643;</i>购物车
            ...
            <div class="w-100 mt-10 cor-9">
              ...
              <p class="d-ib pr-10 cor-red"><a href="<?php echo urlShop('search', 'index', array('keyword' => $v['value']));?>"  data-rpno="20.11"><?php echo $v['value']?></a></p>
              <?php } ?>
              <?php } ?>
            </div>
          </div>
        ...
        <ul class="w-100 mt-35 clearfix navBox pos-r" id="channelWrap">
          ...
          <li class="navItem pos-r" id="firstItem"><a href="/index.php" data-rpno="20.3">首页</a></li>
    ...
    <ul class="about-us-wrap" id="aboutUsWrap">
      <li class="cur-p w-100 contact-item pos-r" id="cartIcon"> <a href="index.php?m=cart" data-rpno="20.8">
    ...
    {{~it.data:item:index}}
        <li>
            <a href="/index.php?m=search&a=index&gc_id={{=item.categoryId}}" target="_blank" data-rpno="20.9">
    ...
    <div class="fixed-container clearfix pb-55">
        ...
        <div class="wrap mt-10 bg-w w-1188px b-1">
          <ul>
            <li class="clearfix">
              ...
              <div class="new-item f-l pt-10 cor-3 cur-p  br-1 "> <a href="<?php echo urlShop('goods','index',array('goods_id'=>$v['goods_id']));?>" target="_blank" data-rpno="2.2">
      ...
      <div id="goodsModuleBox1">
        <?php echo str_replace("goods_itemIndex","goods",$output['web_html']['index']);?>
      </div>
      <!--分类结束-->
