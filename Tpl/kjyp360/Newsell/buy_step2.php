...
<div class="ncc-main">
  ...
  <form action="index.php?m=store_payment&a=real_order" method="POST" id="buy_form">
    ...
    <div class="ncc-receipt-info">
      ...
      <table class="ncc-table-style">
        ...
        <tbody>
          ...
          <tr>
            <th colspan="20" style='display:none'>由于您的商品由不同商家发出，此单将分为<?php echo count($output['order_list']);?>个不同子订单配送！</th>
          </tr>
          <?php } ?>
      ...
      <?php if ($output['pay']['pay_amount_online'] > 0) {?>
          ...
          <ul class="ncc-payment-list" style='display:'>
