...
<div class="ncc-main">
  ...
  <form action="<?php echo urlShop('store_buy','buy_step1');?>" method="POST" id="form_buy" name="form_buy">
...
<?php } ?> /></td>
          ...
          <td class="tl" <?php if ($cart_info['bl_id'] != '0') {?>colspan="2"<?php }?>><dl class="ncc-goods-info">
              <dt>
                ...
                <strong>【优惠套装】</strong>
                <?php }?>
                <a href="javascript:void(0)" target="_blank"><?php echo $cart_info['goods_name']; ?></a></dt>
        ...
        <tr class="shop-list <?php echo $cart_info['state'] ? '' : 'item_disabled';?> bundling-list" nc_group="<?php echo $cart_info['cart_id'];?>">
          ...
          <td class="w100"><a href="javascript:void(0)" target="_blank" class="ncc-goods-thumb"><img src="<?php echo cthumb($goods_info['goods_image'],60,$store_id);?>" alt="<?php echo $goods_info['goods_name']; ?>" /></a></td>        
          <td class="tl"><dl class="ncc-goods-info">
              <dt><a href="javascript:void(0)" target="_blank"><?php echo $goods_info['goods_name']; ?></a> </dt>
