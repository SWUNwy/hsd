						...
						<td class="pb-10 pl-10 ta-l pos-r"><label
							...
							<div class="d-ib  w-80 bc-wrap" id="cateBox">
								<div id="cateWrap" class="clearfix J-cb-inner">
									...
									<a href="index.php?m=store_article&a=index&c_id=<?php echo $gc['ac_id']; ?>"	data-id="406b45d8fa4b42989e6be72ed6c9b664" class="cate-link <?php echo $_GET['c_id']== $gc['ac_id']?"active":"" ?>"><?php echo $gc['ac_name']; ?></a>	
									<?php }?>
								</div>
