...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="mt10">
  ...
  <tbody>
    ...
    <tr>
      <td><a href="index.php?m=m_snshome&mid=<?php echo $sale['buyer_id'];?>" target="_blank" data-param="{'id':<?php echo $sale['buyer_id'];?>}" nctype="mcard"><?php echo $sale['buyer_name'];?></a></td>
