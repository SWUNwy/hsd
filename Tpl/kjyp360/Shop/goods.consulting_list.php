...
<div class="wrapper">
  <div class="ncs-goods-layout expanded" >
    <div class="ncs-goods-main">
          ...
          <div class="ncs-cosult-list">
            <dl class="asker">
              ...
              <dd>
                ...
                <?php }else{?>
                <a href="index.php?m=m_snshome&mid=<?php echo $v['member_id'];?>" target="_blank" data-param="{'id':<?php echo $v['member_id'];?>}" nctype="mcard"><?php echo str_cut($v['member_name'],8);?></a>
                <?php }?>
      ...
      <form method="post" id="message" action="index.php?m=goods&a=save_consult">
        ...
        <div class="ncs-consult-form">
          ...
          <dl>
            ...
            <dd>
              ...
              <div class="code">
                <div class="arrow"></div>
                <div class="code-img"><a href="javascript:void(0)" onclick="javascript:document.getElementById('codeimage').src='index.php?m=seccode&a=makecode&nchash=<?php echo getNchash();?>&t=' + Math.random();"><img src="index.php?m=seccode&a=makecode&nchash=<?php echo getNchash();?>" name="codeimage" border="0" id="codeimage" onclick="this.src='index.php?m=seccode&a=makecode&nchash=<?php echo getNchash();?>&t=' + Math.random()"/></a></div>
                <a href="JavaScript:void(0);" id="hide" class="close" title="关闭"><i></i></a> <a href="JavaScript:void(0);" onclick="javascript:document.getElementById('codeimage').src='index.php?m=seccode&a=makecode&nchash=<?php echo getNchash();?>&t=' + Math.random();" class="change" title="<?php echo $lang['goods_index_change_checkcode'];?>"><i></i></a> </div>
              <?php } ?>
    ...
    <div class="ncs-sidebar">
      <div class="ncs-sidebar-container">
        ...
        <!--S 店铺信息-->
        <?php include template('Shop/info');?>
        <!--E 店铺信息 --> 
      </div>
    </div>
  </div>
            		...
            		remote   : {
                        ...
                        complete: function(data) {
                            if(data.responseText == 'false') {
                            	document.getElementById('codeimage').src='index.php?m=seccode&a=makecode&nchash=<?php echo getNchash();?>&t=' + Math.random();
                            }
                        }
                    }
            	}
