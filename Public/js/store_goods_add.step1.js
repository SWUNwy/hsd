...
function selClass($this){
    ...
    $.getJSON('index.php?m=store_goods_add&a=ajax_goods_class', {gc_id : data_str.gcid, deep: deep}, function(data) {
        if (data != null) {
...
$(function(){
    ...
    $('#commListArea').find('span[nctype="staple_name"]').die().live('click',function() {
        ...
        $.getJSON('index.php?m=store_goods_add&a=ajax_show_comm&stapleid=' + data_str.stapleid, function(data) {
            if (data.done) {
    ...
    $('#commListArea').find('a[nctype="del-comm-cate"]').die().live('click',function() {
        $this = $(this);
        eval('var data_str = ' + $this.parents('li').attr('data-param'));
        $.getJSON('index.php?m=store_goods_add&a=ajax_stapledel&staple_id='+ data_str.stapleid, function(data) {
            if (data.done) {
