...
$(function(){
    ...
    /* 商品图片ajax上传 */
    var url = SITEURL + '/index.php?m=store_setting&a=silde_image_upload';
    ...
    $('a[nctype="del"]').unbind().click(
        function() {
            ...
            $.getJSON('index.php?m=store_setting&a=dorp_img', {file_id : file_id, img_src : img_src}, function(data) {
